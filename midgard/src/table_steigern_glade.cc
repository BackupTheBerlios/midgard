// generated 2002/5/24 16:02:50 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   Gtk::Table *table157 = manage(new class Gtk::Table(1, 2, false));
   ...
   Gtk::VPaned *vpaned14 = manage(new class Gtk::VPaned());
   ...
   Gtk::HPaned *hpaned7 = manage(new class Gtk::HPaned());
   ...
   vpaned14->set_handle_size(10);
   vpaned14->set_gutter_size(6);
   vpaned14->set_position(-1);
   vpaned14->pack1(*table156, false, true);
   vpaned14->pack2(*scrolledwindow83, true, true);
   frame108->set_label_align(0, 0);
   frame108->set_shadow_type(GTK_SHADOW_ETCHED_IN);
   frame108->add(*vpaned14);
   ...
   hpaned7->set_handle_size(10);
   hpaned7->set_gutter_size(6);
   hpaned7->set_position(-1);
   hpaned7->pack1(*frame108, true, true);
   hpaned7->pack2(*frame107, true, false);
   ...
   notebook_lernen->pages().push_back(Gtk::Notebook_Helpers::TabElem(*hpaned7, *vbox58));
   ...
   table99->attach(*scrolledwindow_landauswahl, 6, 7, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   handlebox6->add(*table99);
   table_steigern->attach(*hseparator21, 0, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table_steigern->attach(*table157, 0, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table_steigern->attach(*notebook_lernen, 0, 2, 3, 4, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table_steigern->attach(*handlebox6, 0, 2, 2, 3, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   hseparator21->show();
   label_s_grad->show();
   frame73->show();
