...
{   
   ...
   Gtk::Pixmap *pixmap2 = manage(new class Gtk::Pixmap(EditChar_trans_xpm));
   ...
   Gtk::Pixmap *pixmap5 = manage(new class Gtk::Pixmap(LoadChar_trans_xpm));
   ...
   Gtk::Label *label339 = manage(new class Gtk::Label("Midgard ist eingetragenes Warenzeichen\n"
		"von Pegasus Spiele GmbH und Elsa Franke,\n"
		"Verlag für F&SF-Spiele, Friedberg"));
   ...
   Gtk::Label *label341 = manage(new class Gtk::Label("Version: 0.3beta0"));
   Gtk::Label *label342 = manage(new class Gtk::Label("Hier soll das offizielle Midgard Logo hin, ich\n"
		"warte aber noch auf Elsas Erlaubnis ..."));
   Gtk::Table *table49 = manage(new class Gtk::Table(14, 3, false));
   ...
   table49->attach(*hseparator17, 0, 3, 8, 9, GTK_FILL, 0, 0, 5);
   table49->attach(*label336, 2, 3, 9, 10, GTK_FILL, 0, 0, 0);
   table49->attach(*label338, 2, 3, 10, 11, GTK_FILL, 0, 0, 0);
   table49->attach(*pixmap5, 0, 1, 9, 10, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*pixmap6, 0, 1, 10, 11, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*button_close, 2, 3, 13, 14, 0, 0, 0, 5);
   ...
   table49->attach(*label335, 1, 2, 9, 10, GTK_FILL, 0, 5, 0);
   table49->attach(*label337, 1, 2, 10, 11, GTK_FILL, 0, 5, 0);
   table49->attach(*hseparator18, 0, 3, 11, 12, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table49->attach(*label339, 1, 3, 12, 13, GTK_FILL, 0, 5, 5);
   table49->attach(*pixmap7, 0, 1, 12, 13, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*hseparator19, 0, 3, 3, 4, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table49->attach(*label340, 0, 3, 1, 2, 0, 0, 5, 5);
   table49->attach(*label341, 0, 3, 2, 3, 0, 0, 0, 0);
   table49->attach(*label342, 0, 3, 0, 1, GTK_FILL, 0, 0, 0);
