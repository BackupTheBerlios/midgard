// generated 2002/9/13 8:04:46 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   button_alter->set_relief(GTK_RELIEF_NONE);
   ...
   table104->attach(*frame86, 0, 1, 0, 1, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table104->attach(*frame_pp_zaubern, 1, 2, 0, 1, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_FILL, 0, 0);
   table104->attach(*frame88, 3, 4, 0, 1, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_FILL, 0, 0);
   table104->attach(*frame_pp_spezial, 2, 3, 0, 1, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table76->attach(*frame77, 3, 4, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_FILL, 0, 0);
   table76->attach(*frame76, 2, 3, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_FILL, 0, 0);
   table76->attach(*frame75, 1, 2, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table76->attach(*frame89, 4, 5, 2, 3, GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table73->attach(*vscale_EP_Gold, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table72->attach(*hbox31, 1, 4, 2, 3, GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table72->attach(*eventbox1, 0, 1, 0, 3, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_FILL, 0, 0);
   ...
   vbox43->pack_start(*pixmap129, false, false, 0);
   ...
   table_gradsteigern_lang->attach(*button_grad_resistenz, 0, 1, 3, 4, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   table_gradsteigern_lang->attach(*button_grad_basiswerte, 1, 2, 3, 4, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   table75->set_row_spacings(0);
   table75->set_col_spacings(0);
   table75->attach(*table_gradsteigern_lang, 0, 1, 0, 1, GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table50->attach(*radio_spruchrolle_wuerfeln, 0, 1, 0, 1, GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table50->attach(*radio_spruchrolle_auto, 0, 1, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table102->attach(*table50, 1, 2, 0, 1, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table15->attach(*alignment2, 0, 1, 0, 1, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table162->attach(*label601, 1, 2, 1, 2, GTK_FILL, GTK_EXPAND|GTK_SHRINK, 0, 0);
   table162->attach(*scrolledwindow23, 0, 1, 0, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table_magbonus->attach(*spinbutton_av_bonus, 1, 2, 0, 1, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0, 0);
   table_magbonus->attach(*spinbutton_sl_bonus, 1, 2, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0, 0);
   table_magbonus->attach(*entry_magisch, 1, 2, 2, 3, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0, 0);
   ...
   table156->attach(*scrolledwindow84, 0, 1, 0, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table159->attach(*table156, 0, 1, 0, 1, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table159->attach(*scrolledwindow83, 0, 1, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table158->attach(*frame107, 1, 2, 0, 1, GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table158->attach(*frame108, 0, 1, 0, 1, GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table_steigern->attach(*scrolledwindow_landauswahl, 2, 3, 0, 1, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_FILL, 0, 0);
   table_steigern->attach(*notebook_lernen, 0, 3, 2, 3, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   label_s_grad->show();
   frame73->show();
