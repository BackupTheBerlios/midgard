// generated 2003/9/1 18:48:52 CEST by christof@puck.petig-baender.de
...
{  
   ...
   frame121 = Gtk::manage(new class Gtk::Frame());
   
   Gtk::Table *table181 = Gtk::manage(new class Gtk::Table(2, 2, false));
   custom2 = new class logwin();
   scrolledwindow87 = Gtk::manage(new class Gtk::ScrolledWindow());
   text = Gtk::manage(new class Gtk::Label("label699"));
   
   Gtk::Table *table180 = Gtk::manage(new class Gtk::Table(2, 2, false));
   ...
   table181->attach(*frame121, 0, 1, 0, 1, Gtk::FILL, Gtk::EXPAND|Gtk::SHRINK|Gtk::FILL, 0, 0);
   scrolledwindow87->set_shadow_type(Gtk::SHADOW_NONE);
   scrolledwindow87->set_policy(Gtk::POLICY_AUTOMATIC, Gtk::POLICY_AUTOMATIC);
   scrolledwindow87->property_window_placement().set_value(Gtk::CORNER_TOP_LEFT);
   scrolledwindow87->add(*custom2);
   ...
   table180->set_row_spacings(0);
   table180->set_col_spacings(0);
   table180->attach(*table181, 0, 1, 9, 10, Gtk::AttachOptions(), Gtk::AttachOptions(), 0, 0);
   table180->attach(*scrolledwindow87, 0, 1, 10, 11, Gtk::FILL, Gtk::EXPAND|Gtk::FILL, 0, 0);
   table180->attach(*text, 0, 1, 0, 9, Gtk::EXPAND|Gtk::SHRINK|Gtk::FILL, Gtk::EXPAND|Gtk::SHRINK|Gtk::FILL, 0, 0);
   MagusDialog->get_vbox()->set_homogeneous(false);
   MagusDialog->get_vbox()->set_spacing(0);
   MagusDialog->get_vbox()->pack_start(*table180);
