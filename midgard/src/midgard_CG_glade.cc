// $Id: midgard_CG_glade.cc,v 1.14 2001/04/19 11:45:35 christof Exp $
...
// generated 2001/4/19 8:46:42 CEST by thoma@ig23.
...
{   
   ...
   Gtk::Button *WidgetHpJYGHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Select_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   _tooltips.set_tip(*button10, "LaTeX Charakterblatt", "");
   ...
   {   
      ...
      Gtk::Menu *_m(manage(new Gtk::Menu()));
      Gtk::MenuItem *_mi;
      _mi = manage(new Gtk::MenuItem("Rassen"));
      _m->append(*_mi);
      _mi->show();
      _mi->set_user_data((gpointer)0);
      _m->set_active(0);
   ...
   table1->attach(*optionmenu_spezies, 3, 4, 2, 3, GTK_FILL, 0, 0, 0);
   ...
   _tooltips.set_tip(*option_magier_spezialgebiet, "Magier wählen ein Spezialgebiet", "");
   {   
   ...
   frame60->add(*hbox28);
   table44->attach(*toolbar10, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   table44->attach(*frame60, 1, 2, 0, 1, 0, 0, 23, 0);
   ...
   button10->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_latex_clicked));
   ...
   WidgetHpJYGHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
