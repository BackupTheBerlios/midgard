// generated 2002/4/15 13:06:30 CEST by christof@puck.petig-baender.de
...
{  
   ...
   table65->attach(*handlebox2, 0, 2, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   table126->attach(*handlebox3, 0, 3, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
