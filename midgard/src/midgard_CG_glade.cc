// generated 2002/5/12 9:52:16 CEST by thoma@Tiger.(none)
...
{  
   ...
   entry_nameC->focus_out_event.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_entry_nameC_focus_out_event));
