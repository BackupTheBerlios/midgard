...
{  table_ausruestung = this;
   ...
   Gtk::Label *label630 = manage(new class Gtk::Label("Tragkraft:"));
   Gtk::Label *label = manage(new class Gtk::Label("Hubkraft:"));
   Gtk::Label *label632 = manage(new class Gtk::Label("Schubkraft:"));
   label_tragkraft = manage(new class Gtk::Label("kg"));
   label_hubkraft = manage(new class Gtk::Label("kg"));
   label_schubkraft = manage(new class Gtk::Label("kg"));
   ...
   label_tragkraft->set_alignment(0,0.5);
   label_tragkraft->set_padding(0,0);
   label_tragkraft->set_justify(GTK_JUSTIFY_CENTER);
   label_tragkraft->set_line_wrap(false);
   label_hubkraft->set_alignment(0,0.5);
   label_hubkraft->set_padding(0,0);
   label_hubkraft->set_justify(GTK_JUSTIFY_CENTER);
   label_hubkraft->set_line_wrap(false);
   label_schubkraft->set_alignment(0,0.5);
   label_schubkraft->set_padding(0,0);
   label_schubkraft->set_justify(GTK_JUSTIFY_CENTER);
   label_schubkraft->set_line_wrap(false);
   ...
   table178->attach(*label_tragkraft, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table178->attach(*label_hubkraft, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table178->attach(*label_schubkraft, 1, 2, 2, 3, GTK_FILL, 0, 0, 0);
   ...
   label->show();
   label632->show();
   label_tragkraft->show();
   label_hubkraft->show();
   label_schubkraft->show();
   hseparator22->show();
   table178->show();
   frame117->show();
   table93->show();
