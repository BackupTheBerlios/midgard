...
{   
   ...
   table_beruf->attach(*scrolledwindow43, 0, 3, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table_beruf->attach(*button29, 0, 1, 0, 1, 0, 0, 0, 0);
   table_beruf->attach(*toolbar8, 1, 2, 0, 1, 0, 0, 5, 5);
