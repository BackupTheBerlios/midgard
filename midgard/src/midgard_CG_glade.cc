// generated 2001/12/29 15:28:05 CET by thoma@Tiger.
...
#include "../pixmaps/Pfeil_L.xpm"
#include "../pixmaps/Pfeil_R.xpm"
...
{   
   ...
   Gtk::Pixmap *pixmap70 = manage(new class Gtk::Pixmap(Pfeil_L_xpm));
   Gtk::Button *button_waffe_trans = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap71 = manage(new class Gtk::Pixmap(Pfeil_R_xpm));
   ...
   checkbutton_EP_Geld = manage(new class Gtk::CheckButton("mit EP/PP\n"
		"steigern"));
   ...
   table74->attach(*checkbutton_EP_Geld, 0, 1, 0, 1, 0, 0, 0, 0);
