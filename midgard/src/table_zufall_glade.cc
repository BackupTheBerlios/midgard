// generated 2002/10/24 17:42:54 CEST by thoma@Tiger.(none)
...
{  table_zufall = this;
   ...
   radiobutton_proto_verteilen->toggled.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_radiobutton_proto_verteilen_toggled));
   radiobutton_proto_spezialisieren->toggled.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_radiobutton_proto_spezialisieren_toggled));
   spinbutton_ausnahme->activate.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_spinbutton_ausnahme_activate));
   spinbutton_standard->activate.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_spinbutton_standard_activate));
   spinbutton_grund->activate.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_spinbutton_grund_activate));
   tree_prototyp->leaf_selected.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_tree_prototyp_leaf_selected));
   ...
   scale_fert->activate.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_scale_fert_activate));
   scale_waffen->activate.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_scale_waffen_activate));
   scale_sprachen->activate.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_scale_sprachen_activate));
   scale_schriften->activate.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_scale_waffen_activate));
