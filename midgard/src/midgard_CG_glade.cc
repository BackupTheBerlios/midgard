// generated 2002/7/10 9:08:28 CEST by thoma@Tiger.(none)
...
{  midgard_CG = this;
   ...
   Gtk::Button *button9 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_top->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Öffnen", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(LoadChar_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   button_main_drucken = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_top->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Drucken", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(PrintChar_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *button11 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_top->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Hilfe", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Help_trans_new1_xpm))->gtkobj()), 0, 0));
   Gtk::Button *button_html_hilfe = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_top->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Anleitung", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Help_trans_new1_xpm))->gtkobj()), 0, 0));
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Space());
   ...
   Gtk::HBox *hbox85 = manage(new class Gtk::HBox(false, 0));
   label_notebook_info = manage(new class Gtk::Label("Info & Credits"));
   
   Gtk::VBox *table_notebook_credits = manage(new class Gtk::VBox(false, 0));
   ...
   Gtk::HBox *hbox87 = manage(new class Gtk::HBox(false, 0));
   ...
   hbox85->pack_start(*pixmap_original_tux);
   hbox85->pack_start(*pixmap_logo);
   ...
   table_notebook_credits->set_homogeneous(false);
   table_notebook_credits->set_spacing(0);
   table_notebook_credits->pack_start(*hbox85);
   table_notebook_credits->pack_start(*label_notebook_info, false, false, 0);
   ...
   table161->attach(*togglebutton_delete_abenteurer_aus_liste, 0, 1, 2, 3, 0, 0, 0, 0);
   table161->attach(*label597, 0, 1, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table161->attach(*scrolledwindow86, 0, 1, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   label579->set_alignment(0,0.02);
   label579->set_padding(2,0);
   label579->set_justify(GTK_JUSTIFY_LEFT);
   label579->set_line_wrap(false);
   table148->set_row_spacings(0);
   table148->set_col_spacings(0);
   table148->attach(*undo_tree, 0, 1, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table148->attach(*label579, 0, 1, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table139->attach(*table161, 1, 2, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   table139->attach(*scrolledwindow81, 0, 1, 0, 1, GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table139->attach(*scrolledwindow76, 0, 2, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   hbox87->pack_start(*label_status);
   hbox87->pack_start(*frame_regionen_status, false, false, 0);
   hbox87->pack_start(*eventbox_NSC_aktiv, false, true, 0);
   hbox87->pack_start(*eventbox_wizard_aktiv, false, true, 0);
   hbox87->pack_start(*eventbox_haus_aktiv, false, false, 0);
   ...
   vbox50->pack_start(*hbox87, false, false, 0);
