// generated 2002/1/15 12:38:45 CET by thoma@Tiger.
...
{   
   ...
   vpaned13->pack1(*alte_waffen_tree, true, true);
   vpaned13->pack2(*neue_waffen_tree, true, true);
   label530->set_alignment(0, 0.5);
   label530->set_padding(0, 0);
   table107->attach(*vpaned13, 0, 1, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table107->attach(*label530, 0, 1, 0, 1, 0, 0, 0, 0);
   vpaned12->set_handle_size(10);
   vpaned12->set_gutter_size(6);
   vpaned12->set_position(-1);
   vpaned12->pack1(*alte_grund_tree, true, true);
   vpaned12->pack2(*neue_grund_tree, true, true);
   label529->set_alignment(0, 0.5);
   label529->set_padding(0, 0);
   table106->attach(*vpaned12, 0, 1, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
