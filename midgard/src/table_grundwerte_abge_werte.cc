// $Id: table_grundwerte_abge_werte.cc,v 1.21 2003/09/05 08:03:44 christof Exp $
...
void table_grundwerte::on_abge_werte_setzen_clicked()
{
  ...
  hauptfenster->getChar().getWizard().done(Wizard::ABGELEITETEWERTE,*(hauptfenster->getChar()));
  if(!hauptfenster->getOptionen()->OptionenCheck(Optionen::NSC_only).active) 
