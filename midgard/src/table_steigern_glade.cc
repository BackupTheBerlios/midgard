// generated 2004/8/12 17:50:50 CEST by christof@puck.petig-baender.de
// using glademm V2.6.0_cvs
//
// DO NOT EDIT THIS FILE ! It was created using
// glade-- --image-provider=MagusImage --gtkmmversion 2.4.0 midgard.glade
// for gtk 2.4.4 and gtkmm 2.4.0
//
...
{  table_steigern = this;
   ...
   table_steigern->attach(*frame_spezielles, 0, 2, 1, 2, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK|Gtk::FILL, 0, 0);
