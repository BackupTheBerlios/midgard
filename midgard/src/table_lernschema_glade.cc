// generated 2002/5/20 8:36:36 CEST by thoma@Tiger.(none)
...
{  table_lernschema = this;
   ...
   table123->attach(*label_lernschma_titel, 0, 1, 0, 1, GTK_EXPAND, 0, 0, 0);
   table123->attach(*frame_lernschema_zusatz, 1, 2, 0, 2, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table121->attach(*eventbox_zusatz, 3, 4, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
