// generated 2002/2/8 11:50:51 CET by thoma@Tiger.
...
{   
   ...
   table_kido_lernschema->attach(*button_kido_auswahl, 0, 1, 0, 1, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   table121->attach(*table_kido_lernschema, 2, 3, 0, 1, 0, 0, 0, 0);
