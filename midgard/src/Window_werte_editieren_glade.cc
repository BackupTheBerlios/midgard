...
{   Window_werte_editieren = this;
   ...
   Gtk::Button *n_w_e_close = manage(new class Gtk::Button("Schließen"));
   ...
   stand_ein = manage(new class Gtk::Entry());
   ...
   table3->attach(*n_w_e_close, 2, 3, 18, 19, 0, 0, 0, 0);
   ...
   table3->attach(*stand_ein, 10, 11, 9, 10, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   ...
   n_w_e_close->clicked.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::on_nwe_close_clicked));
   ...
   stand_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::on_nwe_close_clicked));
