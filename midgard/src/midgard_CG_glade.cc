// generated 2003/4/14 22:41:40 CEST by christof@puck.petig-baender.de
...
{  midgard_CG = this;
   ...
   Gtk::Image *image1 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-new"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image2 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-open"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *laden1 = NULL;
   Gtk::Image *image3 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-save"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *speichern1 = NULL;
   Gtk::Image *image4 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-save-as"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *speichern_unter_ = NULL;
   Gtk::Image *image5 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-convert"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image6 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-print"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image7 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-quit"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image8 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-undo"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image9 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gnome-stock-about"), Gtk::IconSize(1)));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Neuer Abenteurer", Gtk::Menu_Helpers::AccelKey(GDK_N, Gdk::MOD1_MASK), *image1));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Öffnen", Gtk::Menu_Helpers::AccelKey(GDK_O, Gdk::CONTROL_MASK), *image2));
   laden1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Speichern", Gtk::Menu_Helpers::AccelKey(GDK_S, Gdk::CONTROL_MASK), *image3));
   speichern1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Speichern unter ...", *image4));
   speichern_unter_ = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Exportieren", *image5, *exportieren_main_menu));
   exportieren_main = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie1 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Drucken", *image6, *drucken1_menu));
   drucken1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie2 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Beenden", Gtk::Menu_Helpers::AccelKey(GDK_Q, Gdk::CONTROL_MASK), *image7));
   beenden1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie5 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   bearbeiten1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Rückgängig", Gtk::Menu_Helpers::AccelKey(GDK_Z, Gdk::CONTROL_MASK), *image8));
   ...
   hilfe1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Info & Credits", *image9));
   ...
   button_neuer_charakter->set_name("button_neuer_charakter");
   ...
   button_speichern->set_name("button_speichern");
   button_speichern->set_flags(Gtk::CAN_FOCUS);
   _tooltips.set_tip(*button_speichern, "Linke Maustaste: Speichern           Rechte Maustaste: Speichern unter ...", "");
   button_main_drucken->set_name("button_main_drucken");
   ...
   exportieren_main_menu->set_name("exportieren_main_menu");
   image6->set_name("image6");
   image6->set_alignment(0.5,0.5);
   image6->set_padding(0,0);
   ausr__stungsdokument_menu->set_name("ausrüstungsdokument_menu");
   drucken1_menu->set_name("drucken1_menu");
   image7->set_name("image7");
   image7->set_alignment(0.5,0.5);
   image7->set_padding(0,0);
   magus1_menu->set_name("magus1_menu");
   image8->set_name("image8");
   image8->set_alignment(0.5,0.5);
   image8->set_padding(0,0);
   bearbeiten1_menu->set_name("bearbeiten1_menu");
   image9->set_name("image9");
   image9->set_alignment(0.5,0.5);
   image9->set_padding(0,0);
   hilfe1_menu->set_name("hilfe1_menu");
   main_menubar->set_name("main_menubar");
   handlebox_menu->set_name("handlebox_menu");
   ...
   pixmap_original_tux->set_name("pixmap_original_tux");
   pixmap_original_tux->set_alignment(0.5,0.5);
   pixmap_original_tux->set_padding(0,0);
   label_notebook_info->set_name("label_notebook_info");
   ...
   pixmap_notebook_grundwerte->set_name("pixmap_notebook_grundwerte");
   pixmap_notebook_grundwerte->set_alignment(0.5,0.5);
   pixmap_notebook_grundwerte->set_padding(0,0);
   label_notebook_grundwerte->set_name("label_notebook_grundwerte");
   ...
   pixmap_notebook_lernen->set_name("pixmap_notebook_lernen");
   pixmap_notebook_lernen->set_alignment(0.5,0.5);
   pixmap_notebook_lernen->set_padding(0,0);
   label_notebook_lernen->set_name("label_notebook_lernen");
   ...
   pixmap_notebook_ausruestung->set_name("pixmap_notebook_ausruestung");
   pixmap_notebook_ausruestung->set_alignment(0.5,0.5);
   pixmap_notebook_ausruestung->set_padding(0,0);
   label_notebook_ausruestung->set_name("label_notebook_ausruestung");
   ...
   viewport38->set_name("viewport38");
   viewport38->set_shadow_type(Gtk::SHADOW_IN);
   viewport38->add(*list_news);
   scrolledwindow76->set_name("scrolledwindow76");
   ...
   hbox84->set_name("hbox84");
   hbox84->pack_start(*pixmap162);
   hbox84->pack_start(*label598, Gtk::PACK_SHRINK, 0);
   togglebutton_delete_abenteurer_aus_liste->set_name("togglebutton_delete_abenteurer_aus_liste");
   ...
   AbenteurerListe->set_name("AbenteurerListe");
   viewport47->set_name("viewport47");
   viewport47->set_shadow_type(Gtk::SHADOW_NONE);
   viewport47->add(*AbenteurerListe);
   scrolledwindow86->set_name("scrolledwindow86");
   ...
   undo_tree->set_name("undo_tree");
   viewport44->set_name("viewport44");
   viewport44->set_shadow_type(Gtk::SHADOW_NONE);
   viewport44->add(*undo_tree);
   scrolledwindow81->set_name("scrolledwindow81");
   ...
   pixmap175->set_name("pixmap175");
   pixmap175->set_alignment(0.5,0.5);
   pixmap175->set_padding(0,0);
   label_notebook_news->set_name("label_notebook_news");
   ...
   notebook_main->pages().back().set_tab_label_packing(false, true, Gtk::PACK_START);
   label_status->set_name("label_status");
   ...
   label_wizard->set_name("label_wizard");
   ...
   pixmap164->set_name("pixmap164");
   pixmap164->set_alignment(0.5,0.5);
   pixmap164->set_padding(0,0);
   eventbox_NSC_aktiv->set_name("eventbox_NSC_aktiv");
   ...
   handlebox_status->set_name("handlebox_status");
   ...
   main_table->set_name("main_table");
   ...
   midgard_CG->set_name("midgard_CG");
