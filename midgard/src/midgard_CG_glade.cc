// generated 2002/3/1 8:46:15 CET by thoma@Tiger.
...
{   
   ...
   pixmapLogo = manage(new class Gtk::Pixmap(midgard_logo_small_xpm));
   ...
   Gtk::Table *table123 = manage(new class Gtk::Table(3, 2, false));
   ...
   pixmapLogo->set_alignment(0.5, 0.5);
   pixmapLogo->set_padding(0, 0);
   ...
   table123->attach(*frame_lernschema_zusatz, 1, 2, 0, 3, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   _tooltips.set_tip(*button_angeborene_fert, "Zum würfeln: linke Maustaste, zum wählen: rechte Maustaste", "");
