// generated 2002/9/11 16:30:53 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   table_gradsteigern_lang->attach(*button_grad_basiswerte, 1, 2, 3, 4, GTK_SHRINK, GTK_SHRINK, 0, 0);
   table_gradsteigern_lang->attach(*button_grad_resistenz, 0, 1, 3, 4, GTK_SHRINK, GTK_SHRINK|GTK_FILL, 0, 0);
