...
{   
   ...
   button_close = manage(new class Gtk::Button());
   ...
   hbox56->pack_start(*pixmap57);
   hbox56->pack_start(*pixmap104);
   ...
   table109->attach(*hbox56, 0, 1, 9, 10, GTK_FILL, GTK_FILL, 0, 0);
   ...
   _tooltips.set_tip(*button_close, "Schließen", "");
   button_close->add(*pixmap106);
   ...
   table49->attach(*frame_datenbank, 0, 2, 4, 5, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table49->attach(*pixmap90, 1, 2, 0, 4, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*button_close, 0, 1, 3, 4, 0, 0, 0, 0);
