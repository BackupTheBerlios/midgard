// generated 2001/11/6 15:50:27 CET by thoma@Tiger.
...
#include "../pixmaps/logo-work-3-v1.0pre.xpm"
#include <gtk--/table.h>
...
{   
   ...
   Gtk::Pixmap *pixmap61 = manage(new class Gtk::Pixmap(logo_work_3_v1_0pre_xpm));
   ...
   Gtk::Table *table77 = manage(new class Gtk::Table(13, 3, false));
   ...
   table49->attach(*pixmap61, 4, 5, 0, 11, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table49->attach(*frame_datenbank, 4, 5, 11, 18, GTK_FILL, GTK_FILL, 0, 0);
