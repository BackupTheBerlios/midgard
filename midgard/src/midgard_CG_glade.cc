// generated 2002/2/21 9:57:44 CET by thoma@Tiger.
...
{   
   ...
   Gtk::ScrolledWindow *scrolledwindow72 = manage(new class Gtk::ScrolledWindow());
   ...
   scrolledwindow72->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   scrolledwindow72->add(*viewport34);
   ...
   table123->attach(*scrolledwindow72, 0, 1, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
