// generated 2002/7/3 16:29:46 CEST by thoma@Tiger.(none)
...
{  table_lernschema = this;
   ...
   table163->attach(*scrolledwindow77, 0, 1, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table163->attach(*checkbutton_einschraenkungen_zusatz, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, 0, 0, 0);
