// generated 2005/6/21 9:36:58 CEST by christof@vesta.petig-baender.de
...
{  midgard_CG = this;
   ...
   Gtk::Image *image77 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-about"), Gtk::IconSize(4)));
