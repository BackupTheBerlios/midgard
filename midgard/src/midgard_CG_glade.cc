// generated 2002/4/15 20:01:51 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::VBox *vbox46 = manage(new class Gtk::VBox(false, 0));
   ...
   Gtk::VBox *vbox48 = manage(new class Gtk::VBox(false, 0));
   ...
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::WidgetElem(*optionmenu_spezies));
   ...
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::WidgetElem(*vbox47));
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::WidgetElem(*vbox46));
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::WidgetElem(*vbox48));
   ...
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::WidgetElem(*fixed5));
   ...
   vbox47->pack_start(*radiobutton_mann, false, false, 0);
   vbox47->pack_start(*radiobutton_frau, false, false, 0);
   ...
   vbox46->pack_start(*typauswahl, false, false, 0);
   vbox46->pack_start(*typauswahl_2, false, false, 0);
   ...
   vbox48->pack_start(*radiobutton_stadt, false, false, 0);
   vbox48->pack_start(*radiobutton_land, false, false, 0);
   ...
   notebook_main->pages().push_back(Gtk::Notebook_Helpers::TabElem(*table140, *eventbox_optionen));
