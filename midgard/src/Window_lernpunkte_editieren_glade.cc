...
{   
   ...
   close = manage(new class Gtk::Button("Schließen"));
   ...
   table5->attach(*close, 2, 3, 4, 5, 0, 0, 0, 0);
   ...
   close->clicked.connect(SigC::slot(static_cast<class Window_lernpunkte_editieren*>(this), &Window_lernpunkte_editieren::on_close_clicked));
}
