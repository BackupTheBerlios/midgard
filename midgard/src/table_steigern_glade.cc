// generated 2002/5/27 12:46:24 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   Gtk::Table *table157 = manage(new class Gtk::Table(1, 3, false));
   ...
   clist_zusatz = manage(new class Gtk::CList(1));
   ...
   Gtk::Pixmap *pixmap161 = manage(new class Gtk::Pixmap(Angeb_Richtung_32_xpm));
   ...
   table157->attach(*handlebox4, 0, 1, 0, 1, 0, 0, 0, 0);
   table157->attach(*handlebox5, 1, 2, 0, 1, 0, 0, 0, 0);
   ...
   clist_zusatz->set_column_width(0, 80);
   clist_zusatz->column_titles_show();
   viewport24->set_shadow_type(GTK_SHADOW_NONE);
   viewport24->add(*clist_zusatz);
   ...
   table_steigern->attach(*table157, 0, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table_steigern->attach(*notebook_lernen, 0, 3, 2, 3, GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table_steigern->attach(*scrolledwindow_landauswahl, 2, 3, 0, 2, GTK_FILL, GTK_FILL, 0, 0);
   table_steigern->attach(*handlebox6, 0, 2, 1, 2, GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   label_s_grad->show();
   frame73->show();
   ...
   clist_zusatz->select_row.connect(SigC::slot(static_cast<class table_steigern*>(this), &table_steigern::on_clist_zusatz_select_row));
   ...
   radiobutton_pp_spezial->toggled.connect(SigC::slot(static_cast<class table_steigern*>(this), &table_steigern::on_radiobutton_pp_zauber_toggled));
