...
{   
   ...
   Gtk::Button *button39 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar12->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Übernehmen und Drucken", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(PrintChar_trans_xpm))->gtkobj()), 0, 0));
   toolbar12->tools().push_back(Gtk::Toolbar_Helpers::Space());
   
   Gtk::Button *button40 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar12->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Abbrechen", 0, 0, 0, 0, 0));
