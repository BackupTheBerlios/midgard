...
protected:
	   ...
	   {   STIL, hart, sanft, gemischt, 
        ...
        class Gtk::Button *button_fachkenntnisse;
        class Gtk::SpinButton *spinbutton_allgemein;
        class Gtk::Button *button_allgemeinwissen;
        class Gtk::SpinButton *spinbutton_waffen;
        class Gtk::Button *button_waffen;
	   ...
	   {   SPEZIAL, 
        ...
        class Gtk::Button *button_zauber;
        class Gtk::SpinButton *spinbutton_unge;
        class Gtk::Button *button_untyp_fertigkeiten;
