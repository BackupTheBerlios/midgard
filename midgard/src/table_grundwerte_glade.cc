// generated 2004/5/14 12:26:34 CEST by christof@puck.petig-baender.de
...
{  table_grundwerte = this;
   ...
   Gtk::ToolItem *toolitem11 = Gtk::manage(new class Gtk::ToolItem());
#endif //
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbar2->append(*toolitem7);
#else //
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::Element(*vbox_gw_wuerfeln));
   
   Gtk::Widget *toolitem7 = toolbar2->tools().back().get_widget();
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolbar2->append(*button_grundwerte);
#else //
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolitem7->set_visible_horizontal(true);
   toolitem7->set_visible_vertical(true);
   toolitem7->set_is_important(false);
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolitem7->add(*vbox_gw_wuerfeln);
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   button_grundwerte->set_flags(Gtk::CAN_FOCUS);
   _tooltips.set_tip(*button_grundwerte, "Eigenschaften würfeln/eingeben", "");
   button_grundwerte->set_visible_horizontal(true);
   button_grundwerte->set_visible_vertical(true);
   button_grundwerte->set_is_important(false);
#endif //
   button_grundwerte_img->show();
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   toolitem11->add(*eventbox_werte_edit);
#endif //
