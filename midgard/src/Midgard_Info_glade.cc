// generated 2002/1/23 9:28:51 CET by thoma@Tiger.
...
{   
   ...
   table49->attach(*frame_datenbank, 0, 2, 5, 6, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*toolbar_close, 2, 3, 5, 6, GTK_FILL, 0, 0, 0);
