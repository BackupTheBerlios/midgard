// generated 2002/5/6 13:55:02 CEST by thoma@Tiger.(none)
...
{  
   ...
   label585 = manage(new class Gtk::Label("Ausrüstung"));
   ...
   label585->set_alignment(0.5, 0.5);
   label585->set_padding(0, 0);
   vbox55->pack_start(*pixmap_notebook_ausruestung);
   vbox55->pack_start(*label585, false, false, 0);
