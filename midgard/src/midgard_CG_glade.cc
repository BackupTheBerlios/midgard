// generated 2002/1/24 11:10:02 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table106 = manage(new class Gtk::Table(2, 1, false));
   ...
   Gtk::Table *table61 = manage(new class Gtk::Table(2, 1, false));
   ...
   Gtk::Table *table99 = manage(new class Gtk::Table(1, 6, false));
   ...
   table100->attach(*table106, 2, 3, 2, 3, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table61->attach(*checkbutton_alle_zauber, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   hpaned4->set_position(463);
   hpaned4->pack1(*scrolledwindow65, false, true);
