// generated 2001/11/9 16:41:10 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table77 = manage(new class Gtk::Table(19, 3, false));
   ...
   table77->attach(*label414, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   table77->attach(*label415, 0, 1, 3, 4, GTK_FILL, 0, 0, 0);
   table77->attach(*label416, 0, 1, 7, 8, GTK_FILL, 0, 0, 0);
   table77->attach(*label417, 0, 1, 8, 9, GTK_FILL, 0, 0, 0);
   table77->attach(*label419, 0, 1, 11, 12, GTK_FILL, 0, 0, 0);
   table77->attach(*label418, 0, 1, 10, 11, GTK_FILL, 0, 0, 0);
   table77->attach(*label420, 0, 1, 9, 10, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_laender, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_ruestung, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_ang_Fert, 1, 2, 2, 3, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_fertigkeiten, 1, 2, 3, 4, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_zauber, 1, 2, 7, 8, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_sprache, 1, 2, 10, 11, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_zauberwerk, 1, 2, 8, 9, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_kido, 1, 2, 9, 10, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_schrift, 1, 2, 11, 12, GTK_FILL, 0, 0, 0);
   table77->attach(*label421, 0, 1, 4, 5, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_grundkenntnisse, 1, 2, 4, 5, GTK_FILL, 0, 0, 0);
   table77->attach(*label422, 0, 1, 5, 6, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_waffen, 1, 2, 5, 6, GTK_FILL, 0, 0, 0);
   table77->attach(*label423, 0, 1, 12, 13, GTK_FILL, 0, 0, 0);
   table77->attach(*label424, 0, 1, 13, 14, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_pflicht, 1, 2, 12, 13, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_ausnahmen, 1, 2, 13, 14, GTK_FILL, 0, 0, 0);
   table77->attach(*label425, 0, 1, 14, 15, GTK_FILL, 0, 0, 0);
   table77->attach(*label426, 0, 1, 15, 16, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_spezies, 1, 2, 14, 15, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_typen, 1, 2, 15, 16, GTK_FILL, 0, 0, 0);
   table77->attach(*label427, 0, 1, 16, 17, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_grad, 1, 2, 16, 17, GTK_FILL, 0, 0, 0);
   table77->attach(*label428, 0, 1, 17, 18, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_spezial, 1, 2, 17, 18, GTK_FILL, 0, 0, 0);
   table77->attach(*label429, 0, 1, 18, 19, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_praxispunkte, 1, 2, 18, 19, GTK_FILL, 0, 0, 0);
   table77->attach(*label430, 0, 1, 6, 7, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_aliaswaffen, 1, 2, 6, 7, GTK_FILL, 0, 0, 0);
