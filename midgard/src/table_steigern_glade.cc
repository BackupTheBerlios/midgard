// generated 2002/6/27 10:54:37 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   table_steigern->attach(*notebook_lernen, 0, 1, 2, 3, GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   label_s_grad->show();
   frame73->show();
