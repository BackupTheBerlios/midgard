// generated 2002/5/29 8:50:40 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::Pixmap *pixmap163 = manage(new class Gtk::Pixmap(Exit_trans_50_xpm));
   Gtk::Label *label599 = manage(new class Gtk::Label("Trotzdem\n"
		"beenden"));
   Gtk::HBox *hbox85 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button_quit_confirm = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap164 = manage(new class Gtk::Pixmap(Erase_50_xpm));
   Gtk::Label *label601 = manage(new class Gtk::Label("Abbrechen"));
   Gtk::HBox *hbox86 = manage(new class Gtk::HBox(false, 0));
   Gtk::HBox *hbox84 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button_quit_abbrechen = manage(new class Gtk::Button());
   Gtk::Label *label600 = manage(new class Gtk::Label("Es existieren noch ungesicherte Abenteurer"));
   table_confirm_quit = manage(new class Gtk::Table(2, 2, false));
   ...
   label599->set_alignment(0.5, 0.5);
   label599->set_padding(0, 0);
   hbox85->pack_start(*pixmap163);
   hbox85->pack_start(*label599, false, false, 0);
   button_quit_confirm->set_flags(GTK_CAN_FOCUS);
   button_quit_confirm->add(*hbox85);
   pixmap164->set_alignment(0.5, 0.5);
   pixmap164->set_padding(0, 0);
   label601->set_alignment(0.5, 0.5);
   label601->set_padding(0, 0);
   hbox86->pack_start(*pixmap164);
   hbox86->pack_start(*label601, false, false, 0);
   hbox84->pack_start(*hbox86, false, false, 0);
   button_quit_abbrechen->set_flags(GTK_CAN_FOCUS);
   button_quit_abbrechen->add(*hbox84);
   label600->set_alignment(0.5, 0.5);
   label600->set_padding(0, 0);
   table_confirm_quit->set_col_spacings(5);
   table_confirm_quit->attach(*button_quit_confirm, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table_confirm_quit->attach(*button_quit_abbrechen, 0, 1, 1, 2, 0, 0, 0, 0);
   table_confirm_quit->attach(*label600, 0, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table161->attach(*scrolledwindow86, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table161->attach(*label597, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table161->attach(*table_confirm_quit, 0, 1, 2, 3, 0, GTK_FILL, 0, 0);
   ...
   label599->show();
   hbox85->show();
   button_quit_confirm->show();
   pixmap164->show();
   label601->show();
   hbox86->show();
   hbox84->show();
   button_quit_abbrechen->show();
   label600->show();
   table161->show();
   table139->show();
   ...
   button_quit_confirm->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_button_quit_confirm_clicked));
   button_quit_abbrechen->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_button_quit_abbrechen_clicked));
