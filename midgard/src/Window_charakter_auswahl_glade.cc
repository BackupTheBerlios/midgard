// generated 2002/1/30 10:05:01 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Label *label251 = manage(new class Gtk::Label("In der Datenbank vorhandene Abenteurere"));
   ...
   label251->set_justify(GTK_JUSTIFY_LEFT);
   ...
   checkbutton_loeschen->set_flags(GTK_CAN_FOCUS);
