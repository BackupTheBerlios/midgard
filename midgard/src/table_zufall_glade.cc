...
{  table_zufall = this;
   ...
   label691->set_justify(Gtk::JUSTIFY_LEFT);
   label691->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label620->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label619->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label690->set_justify(Gtk::JUSTIFY_LEFT);
   label690->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label621->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label693->set_justify(Gtk::JUSTIFY_LEFT);
   label693->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label694->set_justify(Gtk::JUSTIFY_LEFT);
   label694->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label622->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label695->set_justify(Gtk::JUSTIFY_LEFT);
   label695->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label692->set_justify(Gtk::JUSTIFY_LEFT);
   label692->set_ellipsize(Pango::ELLIPSIZE_NONE);
