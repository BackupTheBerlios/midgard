// generated 2004/5/10 10:28:06 CEST by christof@puck.petig-baender.de
...
{  midgard_CG = this;
   ...
   eventbox_wizard_aktiv->signal_button_release_event().connect(SigC::slot(*this, &midgard_CG_glade::wizard_aktiv_button_release_event));
