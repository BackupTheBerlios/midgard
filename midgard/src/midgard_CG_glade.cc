// generated 2002/1/5 0:37:53 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Pixmap *pixmap85 = manage(new class Gtk::Pixmap(SaveChar_trans_50_xpm));
   Gtk::Label *label528 = manage(new class Gtk::Label("Charakter\n"
		"speichern"));
   Gtk::HBox *hbox48 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button70 = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap87 = manage(new class Gtk::Pixmap(LoadChar_trans_50_xpm));
   Gtk::Label *label530 = manage(new class Gtk::Label("Charakter\n"
		"laden"));
   Gtk::HBox *hbox50 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button71 = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap83 = manage(new class Gtk::Pixmap(NewChar_trans_50_xpm));
   Gtk::Label *label526 = manage(new class Gtk::Label("Neuer\n"
		"Charakter"));
   Gtk::HBox *hbox46 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button69 = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap88 = manage(new class Gtk::Pixmap(EditChar_trans_50_xpm));
   Gtk::Label *label531 = manage(new class Gtk::Label("Werte\n"
		"editieren"));
   Gtk::HBox *hbox51 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button77 = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap86 = manage(new class Gtk::Pixmap(Dices2_trans_50_xpm));
   Gtk::Label *label529 = manage(new class Gtk::Label("Abgeleitete\n"
		"Werte"));
   Gtk::HBox *hbox49 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button_abg_werte = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap84 = manage(new class Gtk::Pixmap(Dice_W100_trans_50_xpm));
   Gtk::Label *label527 = manage(new class Gtk::Label("Grundwerte\n"
		"würfeln"));
   Gtk::HBox *hbox47 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button75 = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap89 = manage(new class Gtk::Pixmap(Help_trans_50_xpm));
   Gtk::Label *label532 = manage(new class Gtk::Label("Hilfe"));
   Gtk::HBox *hbox52 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button72 = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap92 = manage(new class Gtk::Pixmap(Info_trans_50_xpm));
   Gtk::Label *label535 = manage(new class Gtk::Label("Info"));
   Gtk::HBox *hbox55 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button73 = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap93 = manage(new class Gtk::Pixmap(Exit_trans_50_xpm));
   Gtk::Label *label536 = manage(new class Gtk::Label("Schließen"));
   Gtk::HBox *hbox56 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button74 = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap90 = manage(new class Gtk::Pixmap(PrintChar_trans_50_xpm));
   Gtk::Label *label533 = manage(new class Gtk::Label("LaTeX\n"
		"Charakterblatt"));
   Gtk::HBox *hbox53 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button78 = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap91 = manage(new class Gtk::Pixmap(DescrChar_trans_50_xpm));
   Gtk::Label *label534 = manage(new class Gtk::Label("Charakter-\n"
		"beschreibung"));
   Gtk::HBox *hbox54 = manage(new class Gtk::HBox(false, 0));
   Gtk::Button *button79 = manage(new class Gtk::Button());
   Gtk::Table *table105 = manage(new class Gtk::Table(3, 5, true));
   ...
   Gtk::Fixed *fixed7 = manage(new class Gtk::Fixed());
   ...
   label528->set_alignment(0.5, 0.5);
   label528->set_padding(0, 0);
   hbox48->pack_start(*pixmap85);
   hbox48->pack_start(*label528, false, false, 0);
   ...
   hbox50->pack_start(*pixmap87);
   hbox50->pack_start(*label530, false, false, 0);
   button71->set_flags(GTK_CAN_FOCUS);
   button71->add(*hbox50);
   pixmap83->set_alignment(0.5, 0.5);
   pixmap83->set_padding(0, 0);
   label526->set_alignment(0.5, 0.5);
   label526->set_padding(0, 0);
   hbox46->pack_start(*pixmap83);
   hbox46->pack_start(*label526, false, false, 0);
   button69->set_flags(GTK_CAN_FOCUS);
   _tooltips.set_tip(*button69, "Neuer Charakter", "");
   button69->add(*hbox46);
   pixmap88->set_alignment(0.5, 0.5);
   pixmap88->set_padding(0, 0);
   label531->set_alignment(0.5, 0.5);
   label531->set_padding(0, 0);
   hbox51->pack_start(*pixmap88);
   hbox51->pack_start(*label531, false, false, 0);
   button77->set_flags(GTK_CAN_FOCUS);
   button77->add(*hbox51);
   pixmap86->set_alignment(0.5, 0.5);
   pixmap86->set_padding(0, 0);
   label529->set_alignment(0.5, 0.5);
   label529->set_padding(0, 0);
   hbox49->pack_start(*pixmap86);
   hbox49->pack_start(*label529, false, false, 0);
   button_abg_werte->set_flags(GTK_CAN_FOCUS);
   button_abg_werte->add(*hbox49);
   pixmap84->set_alignment(0.5, 0.5);
   pixmap84->set_padding(0, 0);
   label527->set_alignment(0.5, 0.5);
   label527->set_padding(0, 0);
   hbox47->pack_start(*pixmap84);
   hbox47->pack_start(*label527, false, false, 0);
   button75->set_flags(GTK_CAN_FOCUS);
   _tooltips.set_tip(*button75, "Linke Maustaste: 2x für jede Basiseigenschaft würfeln, höheres Ergebnis zählt. Mittlere Maustaste: 2x würfeln, besseren Wert einer Basiseigenschaft zuweisen das ganze 6x wiederholen. Rechte Maustaste: 9x würfeln und die besten sechs Ergebnisse frei verteilen. ACHTUNG: Die Sonderregeln für Nichtmenschen werden nur bei der ersten Variante berücksichtigt.", "");
   button75->add(*hbox47);
   pixmap89->set_alignment(0.5, 0.5);
   pixmap89->set_padding(0, 0);
   label532->set_alignment(0.5, 0.5);
   label532->set_padding(0, 0);
   hbox52->pack_start(*pixmap89);
   hbox52->pack_start(*label532, false, false, 0);
   button72->set_flags(GTK_CAN_FOCUS);
   button72->add(*hbox52);
   pixmap92->set_alignment(0.5, 0.5);
   pixmap92->set_padding(0, 0);
   label535->set_alignment(0.5, 0.5);
   label535->set_padding(0, 0);
   hbox55->pack_start(*pixmap92);
   hbox55->pack_start(*label535, false, false, 0);
   button73->set_flags(GTK_CAN_FOCUS);
   button73->add(*hbox55);
   pixmap93->set_alignment(0.5, 0.5);
   pixmap93->set_padding(0, 0);
   label536->set_alignment(0.5, 0.5);
   label536->set_padding(0, 0);
   hbox56->pack_start(*pixmap93);
   hbox56->pack_start(*label536, false, false, 0);
   button74->set_flags(GTK_CAN_FOCUS);
   button74->add(*hbox56);
   pixmap90->set_alignment(0.5, 0.5);
   pixmap90->set_padding(0, 0);
   label533->set_alignment(0.5, 0.5);
   label533->set_padding(0, 0);
   hbox53->pack_start(*pixmap90);
   hbox53->pack_start(*label533, false, false, 0);
   button78->set_flags(GTK_CAN_FOCUS);
   button78->add(*hbox53);
   pixmap91->set_alignment(0.5, 0.5);
   pixmap91->set_padding(0, 0);
   label534->set_alignment(0.5, 0.5);
   label534->set_padding(0, 0);
   hbox54->pack_start(*pixmap91);
   hbox54->pack_start(*label534, false, false, 0);
   button79->set_flags(GTK_CAN_FOCUS);
   button79->add(*hbox54);
   table105->set_row_spacings(5);
   table105->set_col_spacings(5);
   table105->attach(*button70, 1, 2, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   table105->attach(*button71, 2, 3, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   table105->attach(*button69, 0, 1, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   table105->attach(*button77, 2, 3, 2, 3, GTK_FILL, GTK_FILL, 0, 0);
   table105->attach(*button_abg_werte, 1, 2, 2, 3, GTK_FILL, GTK_FILL, 0, 0);
   table105->attach(*button75, 0, 1, 2, 3, GTK_FILL, GTK_FILL, 0, 0);
   table105->attach(*button72, 0, 1, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   table105->attach(*button73, 1, 2, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   table105->attach(*button74, 2, 3, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   table105->attach(*button78, 4, 5, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   table105->attach(*button79, 4, 5, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   ...
   fixed6->put(*checkbutton_Eschar, 0, 16);
   fixed6->put(*checkbutton_Gildenbrief, 96, 64);
   fixed6->put(*checkbutton_Alba, 0, 0);
   fixed6->put(*checkbutton_Nahuatlan, 0, 64);
   fixed6->put(*checkbutton_Kuestenstaaten, 0, 48);
   fixed6->put(*checkbutton_BR, 96, 48);
   fixed6->put(*checkbutton_Rawindra, 96, 0);
   fixed6->put(*checkbutton_Waeland, 96, 16);
   fixed6->put(*checkbutton_HD, 96, 32);
   fixed6->put(*checkbutton_KanThaiPan, 0, 32);
   ...
   _tooltips.set_tip(*checkbutton_original, "Durch Deaktivierung dieses Buttons werden folgende Möglichkeiten freigeschaltet, die vom 'offiziellen' Midgard abweichen: 1. Eigenschaften können Werte > 100 und <1 annehmen, 2. Die Gildenbriefquellenbücher Hexenzauber & Druidenkraft und Barbarenwut können als Erweiterung gewählt werden, 3. Es ist möglich aus allen Zaubern zu wählen, falls die ensprechende Option gewählt wird. ", "");
   checkbutton_original->set_active(true);
   fixed7->put(*checkbutton_info_fenster, 96, 0);
   fixed7->put(*checkbutton_original, 0, 0);
   table65->attach(*table105, 0, 1, 0, 2, 0, 0, 0, 0);
   table65->attach(*fixed6, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table65->attach(*fixed7, 1, 2, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   ...
   button70->button_release_event.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_speichern_release_event));
   button71->button_release_event.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_laden_release_event));
   button69->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_neuer_charakter_clicked));
   button77->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::werte_editieren));
   button_abg_werte->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_abge_werte_setzen_clicked));
   button75->button_release_event.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_button_grundwerte_button_release_event));
   button72->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_button_hilfe_clicked));
   button73->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_button_info_clicked));
   button74->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_schliessen_CG_clicked));
   button78->button_release_event.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_latex_release_event));
   button79->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_charakter_beschreibung_clicked));
