// generated 2002/7/3 11:13:05 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   Gtk::Pixmap *pixmap130 = manage(new class Gtk::Pixmap(Grad_All_32_xpm));
   Gtk::Label *label552 = manage(new class Gtk::Label("Alles an GFP \n"
		"anpassen"));
   ...
   vbox38->pack_start(*label_grad_GFP, false, false, 0);
   ...
   vbox39->pack_start(*label_ausdauer_GFP, false, false, 0);
   ...
   vbox40->pack_start(*label_abwehr_GFP, false, false, 0);
   ...
   vbox41->pack_start(*label_zauber_GFP, false, false, 0);
   ...
   spinbutton_eigenschaften_grad_anstieg->set_flags(GTK_CAN_FOCUS);
   _tooltips.set_tip(*spinbutton_eigenschaften_grad_anstieg, "Eingabe mit 'Enter' bestätigen.", "");
   spinbutton_eigenschaften_grad_anstieg->set_update_policy(GTK_UPDATE_ALWAYS);
   ...
   vbox43->pack_start(*spinbutton_eigenschaften_grad_anstieg, false, false, 0);
   ...
   vbox42->pack_start(*label_resistenz_GFP, false, false, 0);
   ...
   table_gradsteigern_lang->attach(*button_grad_abwehr, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   table_gradsteigern_lang->attach(*button_grad_zaubern, 1, 2, 2, 3, GTK_FILL, 0, 0, 0);
   table_gradsteigern_lang->attach(*button_grad_basiswerte, 1, 2, 3, 4, GTK_FILL, GTK_FILL, 0, 0);
   table_gradsteigern_lang->attach(*grad_anstieg, 0, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table_gradsteigern_lang->attach(*button_grad_resistenz, 0, 1, 3, 4, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table_handlebox1->attach(*handlebox8, 1, 2, 0, 1, 0, GTK_FILL, 0, 0);
   table_handlebox1->attach(*handlebox5, 2, 3, 0, 2, GTK_SHRINK, GTK_SHRINK, 0, 0);
   table_handlebox1->attach(*handlebox_steigern, 0, 2, 1, 2, GTK_SHRINK, GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   clist_ruestung->set_column_title(4, "Gw\n"
		"Verlust");
   ...
   table_steigern->attach(*scrolledwindow_landauswahl, 2, 3, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   label_s_grad->show();
   frame73->show();
   ...
   spinbutton_eigenschaften_grad_anstieg->activate.connect(SigC::slot(static_cast<class table_steigern*>(this), &table_steigern::on_spinbutton_eigenschaften_grad_anstieg_activate));
   button_grad_basiswerte->button_release_event.connect(SigC::slot(static_cast<class table_steigern*>(this), &table_steigern::on_button_grad_basiswerte_button_release_event));
