// generated 2002/6/4 14:22:46 CEST by thoma@Tiger.(none)
...
{  table_optionen = this;
   ...
   Gtk::Label *label599 = manage(new class Gtk::Label("Anzahl der Dateien in de History"));
   ...
   spinbutton_datei_history->set_editable(true);
