// generated 2002/1/13 10:39:43 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table15 = manage(new class Gtk::Table(1, 5, false));
   ...
   vbox26->pack_start(*frame59);
   vbox26->pack_start(*frame91);
   ...
   table4->attach(*vbox26, 1, 2, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table15->attach(*alignment2, 0, 4, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   vpaned6->set_position(-1);
   vpaned6->pack1(*scrolledwindow30, true, true);
   vpaned6->pack2(*scrolledwindow31, true, true);
   vbox16->pack_start(*label284, false, true, 10);
   ...
   vpaned5->set_position(-1);
   vpaned5->pack1(*scrolledwindow32, true, true);
   vpaned5->pack2(*scrolledwindow11, true, true);
   vbox15->pack_start(*label283, false, true, 10);
   vbox15->pack_start(*vpaned5);
   hpaned2->set_handle_size(10);
   hpaned2->set_gutter_size(10);
   hpaned2->set_position(-1);
   hpaned2->pack1(*vbox16, true, true);
   hpaned2->pack2(*vbox15, false, true);
