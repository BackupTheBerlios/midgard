...
{  midgard_CG = this;
   ...
   ausr_stungsdokument_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Nur sichtbares", Gtk::Menu_Helpers::AccelKey(Gdk::CONTROL_MASK, GDK_A)));
   nur_sichtbares = (Gtk::MenuItem *)&ausr_stungsdokument_menu->items().back();
   
   ausr_stungsdokument_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Alles drucken", Gtk::Menu_Helpers::AccelKey(Gdk::MOD1_MASK, GDK_A)));
   ...
   griff_toolbar_top->set_shadow_type(Gtk::SHADOW_NONE);
   ...
   handlebox_menu->set_shadow_type(Gtk::SHADOW_NONE);
   ...
   frame_lernschema->set_shadow_type(Gtk::SHADOW_NONE);
   ...
   frame_steigern->set_shadow_type(Gtk::SHADOW_NONE);
   ...
   pixmap_notebook_beschreibung->set_size_request(80,-1);
   ...
   notebook_main->property_tab_hborder().set_value(2);
   notebook_main->property_tab_vborder().set_value(0);
   ...
   frame_regionen_status->set_shadow_type(Gtk::SHADOW_NONE);
   ...
   frame_haus_status->set_shadow_type(Gtk::SHADOW_NONE);
   frame_haus_status->set_label_align(0,0);
   ...
   handlebox_status->set_shadow_type(Gtk::SHADOW_NONE);
   ...
   midgard_CG->set_position(Gtk::WIN_POS_NONE);
   midgard_CG->property_allow_shrink().set_value(true);
   midgard_CG->property_allow_grow().set_value(true);
   ...
   main_table->show();
   midgard_CG->show();
   button_neuer_charakter->signal_button_release_event().connect(SigC::slot(*this, &midgard_CG_glade::on_neuer_charakter_release_event));
   button9->signal_button_release_event().connect(SigC::slot(*this, &midgard_CG_glade::on_laden_release_event));
   button8->signal_button_release_event().connect(SigC::slot(*this, &midgard_CG_glade::on_speichern_release_event));
   button_main_drucken->signal_button_release_event().connect(SigC::slot(*this, &midgard_CG_glade::on_latex_release_event));
   ...
   button_menu->signal_button_release_event().connect(SigC::slot(*this, &midgard_CG_glade::on_button_menu_button_release_event));
   ...
   r_ckg_ngig1->signal_activate().connect(SigC::slot(*this, &midgard_CG_glade::on_button_undo_clicked));
   erneut_vorw_rts1->signal_activate().connect(SigC::slot(*this, &midgard_CG_glade::on_button_redo_clicked));
