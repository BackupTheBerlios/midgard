...
{  table_optionen = this;
   ...
   table146->show();
   table_optionen->show();
   entry_html->changed.connect(SigC::slot(this, &table_optionen_glade::on_entry_html_changed));
   entry_tmp_verz->changed.connect(SigC::slot(this, &table_optionen_glade::on_entry_tmp_verz_changed));
   entry_speicher_verz->changed.connect(SigC::slot(this, &table_optionen_glade::on_entry_speicher_verz_changed));
   spinbutton_datei_history->changed.connect(SigC::slot(this, &table_optionen_glade::on_spinbutton_datei_history_changed));
   button_html_browser->clicked.connect(SigC::slot(this, &table_optionen_glade::on_button_html_browser_clicked));
   button_tmp->clicked.connect(SigC::slot(this, &table_optionen_glade::on_button_tmp_clicked));
   button_speicherplatz->clicked.connect(SigC::slot(this, &table_optionen_glade::on_button_speicherplatz_clicked));
}
