// generated 2002/10/30 15:39:53 CET by christof@puck.petig-baender.de
...
{  
   ...
   xml_fileselection->get_ok_button()->clicked.connect(SigC::slot(this, &xml_fileselection_glade::on_ok_button1_clicked));
   xml_fileselection->get_cancel_button()->clicked.connect(SigC::slot(this, &xml_fileselection_glade::on_cancel_button1_clicked));
}
