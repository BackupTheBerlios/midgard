// generated 2002/4/19 8:20:15 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::MenuItem *ansicht_menu = NULL;
   ...
   Gtk::Packer *table_9999 = manage(new class Gtk::Packer());
   ...
   einstellungen1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Ändern"));
   aendern = (Gtk::MenuItem *)einstellungen1_menu->items().back();
   
   main_menubar->items().push_back(Gtk::Menu_Helpers::MenuElem("Magus", *magus1_menu));
   ...
   main_menubar->items().push_back(Gtk::Menu_Helpers::MenuElem("Ansicht"));
   ansicht_menu = (Gtk::MenuItem *)main_menubar->items().back();
   
   main_menubar->items().push_back(Gtk::Menu_Helpers::MenuElem("Ansicht", *ansicht1_menu));
   ansicht1 = (Gtk::MenuItem *)main_menubar->items().back();
   
   main_menubar->items().push_back(Gtk::Menu_Helpers::MenuElem("Einstellungen", *einstellungen1_menu));
   einstellungen1 = (Gtk::MenuItem *)main_menubar->items().back();
   handlebox1->add(*main_menubar);
   ...
   table1->attach(*toolbar2, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   table108->attach(*scrolledwindow_dfr3, 1, 2, 0, 4, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table_9999->add(*handlebox1, GTK_SIDE_TOP, GTK_ANCHOR_NORTH, GTK_FILL_X);
   table_9999->add(*griff_toolbar_top, GTK_SIDE_TOP, GTK_ANCHOR_WEST, 0);
   table_9999->add(*notebook_main, GTK_SIDE_RIGHT, GTK_ANCHOR_CENTER, GTK_FILL_X|GTK_FILL_Y);
   ...
   ansicht_menu->activate.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_ansicht_menu_activate));
   aendern->activate.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::menu_einstellungen_aendern));
