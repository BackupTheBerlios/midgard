...
void midgard_CG::schriften_zeigen()
{
   ...
   MidgardBasicElement::show_list_in_tree(list_Schrift_neu,neue_schrift_tree,Werte,Typ,Database);
}
...
void midgard_CG::sprachen_zeigen()
{
   ...
   MidgardBasicElement::show_list_in_tree(list_Sprache_neu,neue_sprache_tree,Werte,Typ,Database);
}
