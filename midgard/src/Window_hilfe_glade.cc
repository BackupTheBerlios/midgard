// generated 2002/10/30 15:39:52 CET by christof@puck.petig-baender.de
...
{  
   ...
   table35->show();
   Window_hilfe->show();
   button56->clicked.connect(SigC::slot(this, &Window_hilfe_glade::on_button_hilfe_schliessen_clicked));
}
