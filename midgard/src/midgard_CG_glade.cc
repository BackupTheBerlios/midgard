// generated 2002/4/12 11:53:54 CEST by christof@puck.petig-baender.de
...
{  
   ...
   Gtk::Button *button12 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_top->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Beenden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Exit_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   drucken1->activate.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_latex_clicked0));
