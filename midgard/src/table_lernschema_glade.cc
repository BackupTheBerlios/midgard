// generated 2002/5/18 21:49:24 CEST by thoma@Tiger.(none)
...
{  table_lernschema = this;
   ...
   table117->attach(*frame_lernpunkte, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   Tree_Lernschema_Zusatz->leave_notify_event.connect(SigC::slot(static_cast<class table_lernschema*>(this), &table_lernschema::on_Tree_Lernschema_Zusatz_leave_notify_event));
