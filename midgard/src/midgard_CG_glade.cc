// generated 2002/4/27 9:00:43 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::Button *button_beruf = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar3->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Beruf", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Job_trans_50_xpm))->gtkobj()), 0, 0));
   toolbar3->tools().push_back(Gtk::Toolbar_Helpers::Space());
   ...
   Gtk::Table *table_berufswahl = manage(new class Gtk::Table(3, 3, false));
   frame_berufswahl = manage(new class Gtk::Frame("Beruf"));
   ...
   frame_berufswahl->set_label_align(0, 0);
   frame_berufswahl->set_shadow_type(GTK_SHADOW_ETCHED_IN);
   frame_berufswahl->add(*table_berufswahl);
   table121->attach(*table131, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table121->attach(*frame103, 2, 3, 0, 1, 0, 0, 0, 0);
   table121->attach(*frame_berufswahl, 3, 4, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   handlebox_status->add(*label_status);
   main_table->attach(*handlebox_menu, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND, 0, 0);
   main_table->attach(*notebook_main, 0, 1, 2, 3, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   main_table->attach(*griff_toolbar_top, 0, 1, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND, 0, 0);
   main_table->attach(*handlebox_status, 0, 1, 3, 4, GTK_EXPAND|GTK_FILL, GTK_EXPAND, 0, 0);
