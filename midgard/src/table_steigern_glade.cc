// generated 2002/11/12 19:55:02 CET by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   label640->set_justify(GTK_JUSTIFY_CENTER);
   label640->set_line_wrap(false);
   hbox99->pack_start(*pixmap62);
   hbox99->pack_start(*label640, false, false, 0);
   _tooltips.set_tip(*eventbox7, "Geld eingeben", "");
   eventbox7->add(*hbox99);
   ...
   label639->set_justify(GTK_JUSTIFY_CENTER);
   label639->set_line_wrap(false);
   hbox98->pack_start(*pixmap161);
   hbox98->pack_start(*label639, false, false, 0);
   _tooltips.set_tip(*eventbox19, "GFP eingeben", "");
   eventbox19->add(*hbox98);
   ...
   hbox38->pack_start(*pixmap72, false, false, 0);
   ...
   hbox39->pack_start(*pixmap73, false, false, 0);
   ...
   hbox37->pack_start(*pixmap74, false, false, 0);
   ...
   table_handlebox1->attach(*handlebox_steigern, 0, 2, 1, 2, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   scrolledwindow_fert_alt->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   ...
   vpaned1->pack1(*scrolledwindow_fert_alt, true, true);
   ...
   scrolledwindow_waffen_alt->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   ...
   vpaned13->pack1(*scrolledwindow_waffen_alt, true, false);
   ...
   scrolledwindow_sprache_alt->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   ...
   vpaned3->pack1(*scrolledwindow_sprache_alt, true, false);
   ...
   scrolledwindow_schrift_alt->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   ...
   vpaned4->pack1(*scrolledwindow_schrift_alt, true, false);
   ...
   table_steigern->show();
   button_alter->clicked.connect(SigC::slot(this, &table_steigern_glade::on_button_alter_clicked));
   button_gold_eingeben->toggled.connect(SigC::slot(this, &table_steigern_glade::on_button_geld_s_toggled));
   spinbutton_aep->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_aep_activate));
   spinbutton_aep->focus_out_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_aep_focus_out_event));
   spinbutton_aep->focus_in_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_aep_focus_in_event));
   spinbutton_kep->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_kep_activate));
   spinbutton_kep->focus_out_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_kep_focus_out_event));
   spinbutton_kep->focus_in_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_kep_focus_in_event));
   spinbutton_zep->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_zep_activate));
   spinbutton_zep->focus_out_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_zep_focus_out_event));
   spinbutton_zep->focus_in_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_zep_focus_in_event));
   spinbutton_gold->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_gold_activate));
   spinbutton_gold->focus_out_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_gold_focus_out_event));
   spinbutton_gold->focus_in_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_gold_focus_in_event));
   spinbutton_silber->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_silber_activate));
   spinbutton_silber->focus_out_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_silber_focus_out_event));
   spinbutton_silber->focus_in_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_silber_focus_in_event));
   spinbutton_kupfer->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_kupfer_activate));
   spinbutton_kupfer->focus_out_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_kupfer_focus_out_event));
   spinbutton_kupfer->focus_in_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_kupfer_focus_in_event));
   spinbutton_gfp->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_gfp_activate));
   spinbutton_gfp->focus_out_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_gfp_focus_out_event));
   spinbutton_gfp->focus_in_event.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_gfp_focus_in_event));
   checkbutton_EP_Geld->toggled.connect(SigC::slot(this, &table_steigern_glade::on_checkbutton_EP_Geld_toggled));
   checkbutton_gfp->toggled.connect(SigC::slot(this, &table_steigern_glade::on_button_gfp_s_toggled));
   button_EP->toggled.connect(SigC::slot(this, &table_steigern_glade::on_button_EP_toggled));
   vscale_EP_Gold->button_release_event.connect(SigC::slot(this, &table_steigern_glade::vscale_value_changed));
   button_grad->clicked.connect(SigC::slot(this, &table_steigern_glade::on_button_grad_clicked));
   button_grad_ausdauer->clicked.connect(SigC::slot(this, &table_steigern_glade::on_button_grad_ausdauer_clicked));
   button_grad_abwehr->clicked.connect(SigC::slot(this, &table_steigern_glade::on_button_grad_abwehr_clicked));
   button_grad_zaubern->clicked.connect(SigC::slot(this, &table_steigern_glade::on_button_grad_zaubern_clicked));
   grad_anstieg->clicked.connect(SigC::slot(this, &table_steigern_glade::on_grad_anstieg_clicked));
   button_grad_resistenz->clicked.connect(SigC::slot(this, &table_steigern_glade::on_button_grad_resistenz_clicked));
   spinbutton_eigenschaften_grad_anstieg->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_eigenschaften_grad_anstieg_activate));
   button_grad_basiswerte->button_release_event.connect(SigC::slot(this, &table_steigern_glade::on_button_grad_basiswerte_button_release_event));
   togglebutton_pp_verfallen->toggled.connect(SigC::slot(this, &table_steigern_glade::on_togglebutton_pp_verfallen_toggled));
   togglebutton_pp_aep_fuellen->toggled.connect(SigC::slot(this, &table_steigern_glade::on_togglebutton_pp_aep_fuellen_toggled));
   radiobutton_praxis->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radio_praxis_toggled));
   radiobutton_unterweisung->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radio_unterweisung_toggled));
   radiobutton_selbst->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radio_selbst_toggled));
   togglebutton_spruchrolle->toggled.connect(SigC::slot(this, &table_steigern_glade::on_spruchrolle_toggled));
   togglebutton_alle_zauber->toggled.connect(SigC::slot(this, &table_steigern_glade::on_togglebutton_alle_zauber_toggled));
   togglebutton_zaubersalze->toggled.connect(SigC::slot(this, &table_steigern_glade::on_togglebutton_zaubersalze_toggled));
   radiobutton_reduzieren->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radio_reduzieren_toggled));
   radiobutton_verlernen->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radio_verlernen_toggled));
   radiobutton_steigern->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radio_steigern_toggled));
   spinbutton_pp_eingeben->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_pp_eingeben_activate));
   togglebutton_praxispunkte->toggled.connect(SigC::slot(this, &table_steigern_glade::on_togglebutton_praxispunkte_toggled));
   radiobutton_pp_fertigkeit->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radiobutton_pp_fertigkeit_toggled));
   radiobutton_pp_abwehr->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radiobutton_pp_abwehr_toggled));
   radiobutton_pp_zauber->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radiobutton_pp_zauber_toggled));
   radiobutton_pp_spezial->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radiobutton_pp_spezial_toggled));
   radiobutton_pp_resistenz->toggled.connect(SigC::slot(this, &table_steigern_glade::on_radiobutton_pp_resistenz_toggled));
   tree_steigern_zusatz->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_steigern_zusatz_leaf_selected));
   alte_fert_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_alte_fert));
   alte_fert_tree->reorder.connect(SigC::slot(this, &table_steigern_glade::on_alte_fert_reorder));
   neue_fert_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_neue_fert));
   alte_waffen_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_alte_waffen));
   alte_waffen_tree->reorder.connect(SigC::slot(this, &table_steigern_glade::on_alte_waffen_reorder));
   neue_waffen_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_neue_waffen));
   alte_grund_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_alte_grund));
   neue_grund_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_neue_grund));
   alte_zauber_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_alte_zauber));
   alte_zauber_tree->reorder.connect(SigC::slot(this, &table_steigern_glade::on_alte_zauber_reorder));
   neue_zauber_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_neue_zauber));
   alte_zaubermittel_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_alte_zauberwerk));
   alte_zaubermittel_tree->reorder.connect(SigC::slot(this, &table_steigern_glade::on_alte_zaubermittel_reorder));
   neue_zaubermittel_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_neue_zauberwerk));
   alte_kido_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_alte_kido));
   alte_kido_tree->reorder.connect(SigC::slot(this, &table_steigern_glade::on_alte_kido_reorder));
   neue_kido_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_neue_kido));
   alte_sprache_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_alte_sprache));
   alte_sprache_tree->reorder.connect(SigC::slot(this, &table_steigern_glade::on_alte_sprache_reorder));
   neue_sprache_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_neue_sprache));
   alte_schrift_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_alte_schrift));
   neue_schrift_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_selected_neue_schrift));
   button_ruestung_1->toggled.connect(SigC::slot(this, &table_steigern_glade::on_button_ruestung_1_toggled));
   button_ruestung_2->toggled.connect(SigC::slot(this, &table_steigern_glade::on_button_ruestung_2_toggled));
   clist_ruestung->select_row.connect(SigC::slot(this, &table_steigern_glade::on_clist_ruestung_select_row));
   spinbutton_av_bonus->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_av_bonus_activate));
   spinbutton_sl_bonus->activate.connect(SigC::slot(this, &table_steigern_glade::on_spinbutton_sl_bonus_activate));
   entry_magisch->activate.connect(SigC::slot(this, &table_steigern_glade::on_entry_magisch_activate));
   checkbutton_mag_waffenbonus->toggled.connect(SigC::slot(this, &table_steigern_glade::on_checkbutton_mag_waffenbonus_toggled));
   waffenbesitz_alt_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_waffenbesitz_selected_alt));
   waffenbesitz_alt_tree->reorder.connect(SigC::slot(this, &table_steigern_glade::on_alte_waffenbesitz_reorder));
   waffenbesitz_neu_tree->leaf_selected.connect(SigC::slot(this, &table_steigern_glade::on_leaf_waffenbesitz_selected_neu));
