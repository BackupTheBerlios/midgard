// generated 2001/10/15 8:38:43 CEST by thoma@Tiger.
...
{   
   ...
   Gtk::Button *WidgetjkmwHHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   laden_label = manage(new class Gtk::Label("ladenlabel"));
   
   Gtk::Table *table14 = manage(new class Gtk::Table(3, 6, false));
   ...
   laden_label->set_alignment(0, 0.5);
   laden_label->set_padding(0, 0);
   ...
   table14->attach(*notebook2, 0, 6, 2, 3, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table14->attach(*laden_label, 0, 3, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   WidgetjkmwHHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
