// generated 2001/4/3 9:39:18 CEST by thoma@ig23.
...
#include "../pixmaps/NewChar-trans.xpm"
#include "../pixmaps/SaveChar-trans.xpm"
#include "../pixmaps/LoadChar-trans.xpm"
#include "../pixmaps/PrintChar-trans.xpm"
#include "../pixmaps/Help-trans.xpm"
...
#include "../pixmaps/Lang-trans.xpm"
...
{   
   ...
   Gtk::Button *button7 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar1->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Neuer\n"
		"Charakter", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(NewChar_trans_xpm))->gtkobj()), 0, 0));
   Gtk::Button *button8 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar1->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Charakter\n"
		"speichern", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(SaveChar_trans_xpm))->gtkobj()), 0, 0));
   Gtk::Button *button9 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar1->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Charakter\n"
		"laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(LoadChar_trans_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *button10 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar1->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "LaTeX\n"
		"Charakterblattt", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(PrintChar_trans_xpm))->gtkobj()), 0, 0));
   toolbar1->tools().push_back(Gtk::Toolbar_Helpers::Space());
   
   Gtk::Button *button11 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar1->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Hilfe", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Help_trans_xpm))->gtkobj()), 0, 0));
   Gtk::Button *button_info = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar1->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Info", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Edit_2W6_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *button17 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar2->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Muttersprache(n)\n"
		"wählen", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Lang_trans_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *button33 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar9->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Sprachen & Schriften laden", 0, 0, 0, 0, 0));
   ...
   table50->attach(*radio_spruchrolle_auto, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table50->attach(*radio_spruchrolle_wuerfeln, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   frame38->add(*table_magier_steigern);
   ...
   notebook2->pages().push_back(Gtk::Notebook_Helpers::TabElem(*frame40, *hbox24));
   notebook2->pages().push_back(Gtk::Notebook_Helpers::TabElem(*frame39, *hbox25));
   notebook2->pages().push_back(Gtk::Notebook_Helpers::TabElem(*frame38, *hbox26));
   notebook2->pages().push_back(Gtk::Notebook_Helpers::TabElem(*frame50, *hbox27));
