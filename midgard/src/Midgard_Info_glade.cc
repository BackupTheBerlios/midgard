// generated 2002/2/13 16:37:40 CET by thoma@Tiger.
...
{   Midgard_Info = this;
   ...
   table49->attach(*button71, 0, 1, 3, 4, 0, 0, 0, 0);
   ...
   viewport33->show();
   Midgard_Info->show();
   button71->clicked.connect(SigC::slot(static_cast<class Midgard_Info*>(this), &Midgard_Info::tux_clicked));
}
