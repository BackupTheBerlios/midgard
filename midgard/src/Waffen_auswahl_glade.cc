...
{   
   ...
   waffen_clist_auswahl = manage(new class Gtk::CList(4));
   ...
   button4 = manage(new class Gtk::Button("Schließen"));
   
   Gtk::Table *table7 = manage(new class Gtk::Table(3, 2, false));
   waffen_clist_auswahl->set_column_title(0, "Lernpunkte");
   waffen_clist_auswahl->set_column_justification(0, GTK_JUSTIFY_RIGHT);
   waffen_clist_auswahl->set_column_width(0, 80);
   waffen_clist_auswahl->set_column_title(1, "Waffe");
   waffen_clist_auswahl->set_column_width(1, 80);
   waffen_clist_auswahl->set_column_title(2, "Erfolgswert");
   waffen_clist_auswahl->set_column_justification(2, GTK_JUSTIFY_RIGHT);
   waffen_clist_auswahl->set_column_width(2, 80);
   waffen_clist_auswahl->set_column_title(3, "Grundkenntnisse ");
   ...
   table7->attach(*button4, 1, 2, 2, 3, 0, 0, 0, 0);
   ...
   button4->clicked.connect(SigC::slot(static_cast<class Waffen_auswahl*>(this), &Waffen_auswahl::on_close_waffen_clicked));
}
