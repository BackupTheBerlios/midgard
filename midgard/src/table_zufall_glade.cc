...
{  table_zufall = this;
   ...
   table172->attach(*spinbutton_fertigkeit, 1, 2, 2, 3, GTK_SHRINK, GTK_SHRINK, 0, 0);
   table172->attach(*spinbutton_waffen, 2, 3, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*spinbutton_waffen_grund, 3, 4, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*spinbutton_zauber, 4, 5, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*spinbutton_zauberwerk, 5, 6, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*spinbutton_sprachen, 6, 7, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*spinbutton_schriften, 7, 8, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*label612, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label613, 2, 3, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label614, 3, 4, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label615, 4, 5, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label616, 5, 6, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label617, 6, 7, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label618, 7, 8, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label609, 0, 1, 3, 4, GTK_FILL, 0, 0, 0);
   table172->attach(*label610, 0, 1, 5, 6, GTK_FILL, 0, 0, 0);
   table172->attach(*label_spez_fert, 1, 2, 3, 4, GTK_FILL, 0, 0, 0);
   table172->attach(*label_allg_fert, 1, 2, 5, 6, GTK_FILL, 0, 0, 0);
   table172->attach(*vscale_spezallg_fert, 1, 2, 4, 5, 0, GTK_EXPAND|GTK_FILL, 0, 0);
   table172->attach(*label_spez_waff, 2, 3, 3, 4, GTK_FILL, 0, 0, 0);
   table172->attach(*label_spez_spra, 6, 7, 3, 4, GTK_FILL, 0, 0, 0);
   table172->attach(*label_spez_schr, 7, 8, 3, 4, GTK_FILL, 0, 0, 0);
   table172->attach(*label_allg_waff, 2, 3, 5, 6, GTK_FILL, 0, 0, 0);
   table172->attach(*label_allg_spra, 6, 7, 5, 6, GTK_FILL, 0, 0, 0);
   table172->attach(*label_allg_schr, 7, 8, 5, 6, GTK_FILL, 0, 0, 0);
   table172->attach(*vscale_spezallg_waff, 2, 3, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
   table172->attach(*vscale_spezallg_spra, 6, 7, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
   table172->attach(*vscale_spezallg_schr, 7, 8, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
   table172->attach(*button_check100, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   vscale_spezallg_fert->button_release_event.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_vscale_spezall_fert_button_release_event));
   vscale_spezallg_waff->button_release_event.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_vscale_spezall_fert_button_release_event));
   vscale_spezallg_spra->button_release_event.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_vscale_spezall_fert_button_release_event));
   vscale_spezallg_schr->button_release_event.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_vscale_spezall_fert_button_release_event));
