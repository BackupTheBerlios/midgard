...
{   
   ...
   Gtk::Table *table77 = manage(new class Gtk::Table(18, 3, false));
   ...
   table77->attach(*label429, 0, 1, 17, 18, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_praxispunkte, 1, 2, 17, 18, GTK_FILL, 0, 0, 0);
