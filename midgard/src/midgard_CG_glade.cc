// generated 2001/5/28 14:48:34 CEST by thoma@Tiger.
...
{   
   ...
   Gtk::Button *WidgetQJYCHHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   _tooltips.set_tip(*checkbutton_BR, "Fertigkeiten und Zauber des Quellenbuches 'Barbarenwut & Ritterehre'", "");
   ...
   table46->attach(*checkbutton_info_fenster, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   ...
   WidgetQJYCHHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
