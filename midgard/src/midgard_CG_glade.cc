// generated 2002/5/6 19:47:10 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::EventBox *eventbox16 = manage(new class Gtk::EventBox());
   ...
   _tooltips.set_tip(*eventbox16, "Info & Credits", "");
   eventbox16->add(*hbox64);
   ...
   notebook_main->pages().push_back(Gtk::Notebook_Helpers::TabElem(*Midgard_Info, *eventbox16));
