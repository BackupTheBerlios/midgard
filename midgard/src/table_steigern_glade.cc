// generated 2003/2/27 1:03:02 CET by christof@puck.petig-baender.de
...
{  table_steigern = this;
   ...
   pixmap_ns_fertig = Gtk::manage(new class Gtk::Image(_pixmap_ns_fertig_pixmap, _pixmap_ns_fertig_mask));
   ...
   pixmap_ns_waffen = Gtk::manage(new class Gtk::Image(_pixmap_ns_waffen_pixmap, _pixmap_ns_waffen_mask));
   ...
   pixmap_ns_zauber = Gtk::manage(new class Gtk::Image(_pixmap_ns_zauber_pixmap, _pixmap_ns_zauber_mask));
   ...
   pixmap_kurai = Gtk::manage(new class Gtk::Image(_pixmap_kurai_pixmap, _pixmap_kurai_mask));
   ...
   pixmap_ns_kido = Gtk::manage(new class Gtk::Image(_pixmap_ns_kido_pixmap, _pixmap_ns_kido_mask));
   ...
   Gtk::Image *pixmap163 = Gtk::manage(new class Gtk::Image(_pixmap163_pixmap, _pixmap163_mask));
   ...
   pixmap_ns_sprache = Gtk::manage(new class Gtk::Image(_pixmap_ns_sprache_pixmap, _pixmap_ns_sprache_mask));
   ...
   Gtk::Image *pixmap64 = Gtk::manage(new class Gtk::Image(_pixmap64_pixmap, _pixmap64_mask));
   ...
   Gtk::Image *pixmap159 = Gtk::manage(new class Gtk::Image(_pixmap159_pixmap, _pixmap159_mask));
   ...
   Gtk::Image *pixmap160 = Gtk::manage(new class Gtk::Image(_pixmap160_pixmap, _pixmap160_mask));
   ...
   pixmap_ns_besitz = Gtk::manage(new class Gtk::Image(_pixmap_ns_besitz_pixmap, _pixmap_ns_besitz_mask));
   ...
   Gtk::Image *pixmap88 = Gtk::manage(new class Gtk::Image(_pixmap88_pixmap, _pixmap88_mask));
   ...
   label_pp_abwehr = Gtk::manage(new class Gtk::Label(""));
   ...
   Gtk::Image *pixmap62 = Gtk::manage(new class Gtk::Image(_pixmap62_pixmap, _pixmap62_mask));
   ...
   Gtk::Image *pixmap161 = Gtk::manage(new class Gtk::Image(_pixmap161_pixmap, _pixmap161_mask));
   ...
   Gtk::Image *pixmap93 = Gtk::manage(new class Gtk::Image(_pixmap93_pixmap, _pixmap93_mask));
   ...
   Gtk::Image *pixmap125 = Gtk::manage(new class Gtk::Image(_pixmap125_pixmap, _pixmap125_mask));
   ...
   Gtk::Image *pixmap126 = Gtk::manage(new class Gtk::Image(_pixmap126_pixmap, _pixmap126_mask));
   ...
   Gtk::Image *pixmap127 = Gtk::manage(new class Gtk::Image(_pixmap127_pixmap, _pixmap127_mask));
   ...
   Gtk::Image *pixmap130 = Gtk::manage(new class Gtk::Image(_pixmap130_pixmap, _pixmap130_mask));
   ...
   Gtk::Image *pixmap128 = Gtk::manage(new class Gtk::Image(_pixmap128_pixmap, _pixmap128_mask));
   ...
   Gtk::Image *pixmap76 = Gtk::manage(new class Gtk::Image(_pixmap76_pixmap, _pixmap76_mask));
   ...
   Gtk::Image *pixmap77 = Gtk::manage(new class Gtk::Image(_pixmap77_pixmap, _pixmap77_mask));
   ...
   Gtk::Image *pixmap75 = Gtk::manage(new class Gtk::Image(_pixmap75_pixmap, _pixmap75_mask));
   ...
   Gtk::Image *pixmap82 = Gtk::manage(new class Gtk::Image(_pixmap82_pixmap, _pixmap82_mask));
   ...
   Gtk::Image *pixmap81 = Gtk::manage(new class Gtk::Image(_pixmap81_pixmap, _pixmap81_mask));
   ...
   Gtk::Image *pixmap79 = Gtk::manage(new class Gtk::Image(_pixmap79_pixmap, _pixmap79_mask));
   ...
   Gtk::Image *pixmap92 = Gtk::manage(new class Gtk::Image(_pixmap92_pixmap, _pixmap92_mask));
   ...
   Gtk::Image *pixmap91 = Gtk::manage(new class Gtk::Image(_pixmap91_pixmap, _pixmap91_mask));
   ...
   Gtk::Image *pixmap72 = Gtk::manage(new class Gtk::Image(_pixmap72_pixmap, _pixmap72_mask));
   ...
   Gtk::Image *pixmap73 = Gtk::manage(new class Gtk::Image(_pixmap73_pixmap, _pixmap73_mask));
   ...
   Gtk::Image *pixmap74 = Gtk::manage(new class Gtk::Image(_pixmap74_pixmap, _pixmap74_mask));
   ...
   Gtk::Image *pixmap78 = Gtk::manage(new class Gtk::Image(_pixmap78_pixmap, _pixmap78_mask));
   ...
   tree_steigern_zusatz->set_name("tree_steigern_zusatz");
   viewport24->set_name("viewport24");
   viewport24->set_shadow_type(Gtk::SHADOW_NONE);
   viewport24->add(*tree_steigern_zusatz);
   scrolledwindow_landauswahl->set_name("scrolledwindow_landauswahl");
   ...
   alte_fert_tree->set_name("alte_fert_tree");
   scrolledwindow_fert_alt->set_name("scrolledwindow_fert_alt");
   ...
   neue_fert_tree->set_name("neue_fert_tree");
   scrolledwindow55->set_name("scrolledwindow55");
   ...
   label_ns_fertigkeiten->set_name("label_ns_fertigkeiten");
   ...
   pixmap_ns_fertig->set_name("pixmap_ns_fertig");
   ...
   alte_waffen_tree->set_name("alte_waffen_tree");
   scrolledwindow_waffen_alt->set_name("scrolledwindow_waffen_alt");
   ...
   neue_waffen_tree->set_name("neue_waffen_tree");
   scrolledwindow69->set_name("scrolledwindow69");
   ...
   alte_grund_tree->set_name("alte_grund_tree");
   scrolledwindow67->set_name("scrolledwindow67");
   ...
   neue_grund_tree->set_name("neue_grund_tree");
   scrolledwindow68->set_name("scrolledwindow68");
   ...
   label_nw_waffen->set_name("label_nw_waffen");
   ...
   pixmap_ns_waffen->set_name("pixmap_ns_waffen");
   ...
   alte_zauber_tree->set_name("alte_zauber_tree");
   scrolledwindow33->set_name("scrolledwindow33");
   ...
   neue_zauber_tree->set_name("neue_zauber_tree");
   scrolledwindow34->set_name("scrolledwindow34");
   ...
   alte_zaubermittel_tree->set_name("alte_zaubermittel_tree");
   scrolledwindow51->set_name("scrolledwindow51");
   ...
   neue_zaubermittel_tree->set_name("neue_zaubermittel_tree");
   scrolledwindow52->set_name("scrolledwindow52");
   ...
   hpaned3->set_name("hpaned3");
   hpaned3->pack1(*vbox17, Gtk::EXPAND);
   hpaned3->pack2(*vbox18, Gtk::EXPAND);
   table_magier_steigern->set_name("table_magier_steigern");
   ...
   label_ns_zauber->set_name("label_ns_zauber");
   ...
   pixmap_ns_zauber->set_name("pixmap_ns_zauber");
   ...
   alte_kido_tree->set_name("alte_kido_tree");
   scrolledwindow49->set_name("scrolledwindow49");
   ...
   neue_kido_tree->set_name("neue_kido_tree");
   scrolledwindow50->set_name("scrolledwindow50");
   ...
   label_ns_kido->set_name("label_ns_kido");
   ...
   alte_sprache_tree->set_name("alte_sprache_tree");
   scrolledwindow_sprache_alt->set_name("scrolledwindow_sprache_alt");
   ...
   hbox86->set_name("hbox86");
   hbox86->pack_start(*pixmap163);
   hbox86->pack_start(*label600, Gtk::PACK_SHRINK, 0);
   togglebutton_neue_sprache_pp->set_name("togglebutton_neue_sprache_pp");
   ...
   neue_sprache_tree->set_name("neue_sprache_tree");
   scrolledwindow23->set_name("scrolledwindow23");
   ...
   alte_schrift_tree->set_name("alte_schrift_tree");
   scrolledwindow_schrift_alt->set_name("scrolledwindow_schrift_alt");
   ...
   neue_schrift_tree->set_name("neue_schrift_tree");
   scrolledwindow24->set_name("scrolledwindow24");
   ...
   table_sprache_schriften->set_name("table_sprache_schriften");
   ...
   label_ns_sprache->set_name("label_ns_sprache");
   ...
   pixmap_ns_sprache->set_name("pixmap_ns_sprache");
   ...
   pixmap64->set_name("pixmap64");
   pixmap64->set_alignment(0.5,0.5);
   pixmap64->set_padding(0,0);
   label_ruestung_1->set_name("label_ruestung_1");
   ...
   pixmap159->set_name("pixmap159");
   pixmap159->set_alignment(0.5,0.5);
   pixmap159->set_padding(0,0);
   label_ruestung_2->set_name("label_ruestung_2");
   ...
   clist_ruestung->set_name("clist_ruestung");
   ...
   viewport45->set_name("viewport45");
   viewport45->set_shadow_type(Gtk::SHADOW_NONE);
   viewport45->add(*clist_ruestung);
   scrolledwindow82->set_name("scrolledwindow82");
   ...
   label_av_bonus->set_name("label_av_bonus");
   ...
   label_sl_bonus->set_name("label_sl_bonus");
   ...
   spinbutton_av_bonus->set_name("spinbutton_av_bonus");
   ...
   spinbutton_sl_bonus->set_name("spinbutton_sl_bonus");
   ...
   entry_magisch->set_name("entry_magisch");
   ...
   table_magbonus->set_name("table_magbonus");
   ...
   hbox76->set_name("hbox76");
   hbox76->pack_start(*pixmap160);
   hbox76->pack_start(*label593, Gtk::PACK_SHRINK, 0);
   checkbutton_mag_waffenbonus->set_name("checkbutton_mag_waffenbonus");
   ...
   waffenbesitz_alt_tree->set_name("waffenbesitz_alt_tree");
   scrolledwindow84->set_name("scrolledwindow84");
   ...
   waffenbesitz_neu_tree->set_name("waffenbesitz_neu_tree");
   scrolledwindow83->set_name("scrolledwindow83");
   ...
   label_ns_besitz->set_name("label_ns_besitz");
   ...
   label_s_resistenz->set_name("label_s_resistenz");
   ...
   label_s_zaubern->set_name("label_s_zaubern");
   ...
   label_s_abwehr->set_name("label_s_abwehr");
   ...
   label_alter->set_name("label_alter");
   ...
   label_steigertage->set_name("label_steigertage");
   ...
   steigern_typ->set_name("steigern_typ");
   ...
   label_steigern_spezies->set_name("label_steigern_spezies");
   ...
   label_pp_abwehr->set_name("label_pp_abwehr");
   ...
   label_pp_zaubern->set_name("label_pp_zaubern");
   ...
   frame_pp_zaubern->set_name("frame_pp_zaubern");
   ...
   label_pp_resistenz->set_name("label_pp_resistenz");
   ...
   label_pp_spezial->set_name("label_pp_spezial");
   ...
   frame_pp_spezial->set_name("frame_pp_spezial");
   ...
   handlebox_steigern_1->set_name("handlebox_steigern_1");
   ...
   LabelSpin_aep->set_name("LabelSpin_aep");
   label660->set_name("label660");
   ...
   LabelSpin_kep->set_name("LabelSpin_kep");
   label661->set_name("label661");
   ...
   LabelSpin_zep->set_name("LabelSpin_zep");
   label662->set_name("label662");
   ...
   LabelSpin_gold->set_name("LabelSpin_gold");
   label663->set_name("label663");
   ...
   LabelSpin_silber->set_name("LabelSpin_silber");
   label664->set_name("label664");
   ...
   LabelSpin_kupfer->set_name("LabelSpin_kupfer");
   label665->set_name("label665");
   ...
   LabelSpin_gfp->set_name("LabelSpin_gfp");
   label666->set_name("label666");
   ...
   label_Gold->set_name("label_Gold");
   ...
   vscale_EP_Gold->set_name("vscale_EP_Gold");
   ...
   hbox99->set_name("hbox99");
   hbox99->pack_start(*pixmap62);
   hbox99->pack_start(*label640, Gtk::PACK_SHRINK, 0);
   button_gold_eingeben->set_name("button_gold_eingeben");
   ...
   eventbox_eppp_steigern->set_name("eventbox_eppp_steigern");
   ...
   handlebox_steigern_2->set_name("handlebox_steigern_2");
   ...
   flashing_gradanstieg->set_name("flashing_gradanstieg");
   label546->set_name("label546");
   ...
   label_grad_GFP->set_name("label_grad_GFP");
   ...
   button_grad->set_name("button_grad");
   ...
   label_ausdauer_GFP->set_name("label_ausdauer_GFP");
   ...
   button_grad_ausdauer->set_name("button_grad_ausdauer");
   ...
   label_abwehr_GFP->set_name("label_abwehr_GFP");
   ...
   button_grad_abwehr->set_name("button_grad_abwehr");
   ...
   label_zauber_GFP->set_name("label_zauber_GFP");
   ...
   label_resistenz_GFP->set_name("label_resistenz_GFP");
   ...
   button_grad_resistenz->set_name("button_grad_resistenz");
   button_grad_resistenz->set_relief(Gtk::RELIEF_NORMAL);
   button_grad_resistenz->add(*vbox42);
   flashing_eigenschaft->set_name("flashing_eigenschaft");
   label551->set_name("label551");
   ...
   spinbutton_eigenschaften_grad_anstieg->set_name("spinbutton_eigenschaften_grad_anstieg");
   ...
   button_grad_basiswerte->set_name("button_grad_basiswerte");
   ...
   table_gradsteigern_lang->set_name("table_gradsteigern_lang");
   ...
   handlebox_steigern_4->set_name("handlebox_steigern_4");
   ...
   radiobutton_pp_hoch_wie_geht->set_name("radiobutton_pp_hoch_wie_geht");
   ...
   radiobutton_pp_1stufe->set_name("radiobutton_pp_1stufe");
   ...
   togglebutton_pp_verfallen->set_name("togglebutton_pp_verfallen");
   ...
   togglebutton_pp_aep_fuellen->set_name("togglebutton_pp_aep_fuellen");
   ...
   table_pp_einstellungen->set_name("table_pp_einstellungen");
   ...
   radiobutton_unterweisung->set_name("radiobutton_unterweisung");
   ...
   radiobutton_selbst->set_name("radiobutton_selbst");
   ...
   frame_lernen_mit->set_name("frame_lernen_mit");
   ...
   pixmap82->set_name("pixmap82");
   pixmap82->set_alignment(7.45058e-09,0.5);
   pixmap82->set_padding(0,0);
   radio_spruchrolle_auto->set_name("radio_spruchrolle_auto");
   ...
   pixmap81->set_name("pixmap81");
   pixmap81->set_alignment(7.45058e-09,0.5);
   pixmap81->set_padding(0,0);
   radio_spruchrolle_wuerfeln->set_name("radio_spruchrolle_wuerfeln");
   ...
   frame_zauber_zusatz->set_name("frame_zauber_zusatz");
   ...
   radiobutton_reduzieren->set_name("radiobutton_reduzieren");
   ...
   radiobutton_verlernen->set_name("radiobutton_verlernen");
   ...
   radiobutton_steigern->set_name("radiobutton_steigern");
   ...
   frame_fertigkeit->set_name("frame_fertigkeit");
   ...
   spinbutton_pp_eingeben->set_name("spinbutton_pp_eingeben");
   ...
   togglebutton_praxispunkte->set_name("togglebutton_praxispunkte");
   ...
   radiobutton_pp_fertigkeit->set_name("radiobutton_pp_fertigkeit");
   ...
   radiobutton_pp_abwehr->set_name("radiobutton_pp_abwehr");
   ...
   radiobutton_pp_zauber->set_name("radiobutton_pp_zauber");
   ...
   radiobutton_pp_spezial->set_name("radiobutton_pp_spezial");
   ...
   radiobutton_pp_resistenz->set_name("radiobutton_pp_resistenz");
   ...
   vbox_praxispunkte->set_name("vbox_praxispunkte");
   ...
   frame_praxispunkte->set_name("frame_praxispunkte");
   ...
   handlebox_steigern_3->set_name("handlebox_steigern_3");
   ...
   table_handlebox1->set_name("table_handlebox1");
   ...
   table_steigern->set_name("table_steigern");
