...
{  table_zufall = this;
   checkbutton_spezies = manage(new class Gtk::CheckButton("Spezies"));
   checkbutton_herkunft = manage(new class Gtk::CheckButton("Herkunft"));
   checkbutton_typ = manage(new class Gtk::CheckButton("Typ"));
   checkbutton_ange_fert = manage(new class Gtk::CheckButton("angeb. Fert."));
   combo_spezies = manage(new class Gtk::Combo());
   combo_typ = manage(new class Gtk::Combo());
   combo_herkunft = manage(new class Gtk::Combo());
   checkbutton_werte = manage(new class Gtk::CheckButton("Werte"));
   checkbutton_st = manage(new class Gtk::CheckButton("St"));
   checkbutton_gs = manage(new class Gtk::CheckButton("Gs"));
   checkbutton_gw = manage(new class Gtk::CheckButton("Gw"));
   checkbutton_ko = manage(new class Gtk::CheckButton("Ko"));
   checkbutton_in = manage(new class Gtk::CheckButton("In"));
   checkbutton_zt = manage(new class Gtk::CheckButton("Zt"));
   checkbutton_au = manage(new class Gtk::CheckButton("Au"));
   checkbutton_pa = manage(new class Gtk::CheckButton("pA"));
   checkbutton_wk = manage(new class Gtk::CheckButton("Wk"));
   checkbutton_sb = manage(new class Gtk::CheckButton("Sb"));
   checkbutton_b = manage(new class Gtk::CheckButton("B"));
   ...
   Gtk::Image *pixmap172 = manage(new class Gtk::Image(_pixmap172_pixmap, _pixmap172_mask));
   ...
   Gtk::Image *pixmap171 = manage(new class Gtk::Image(_pixmap171_pixmap, _pixmap171_mask));
   ...
   Gtk::Image *pixmap173 = manage(new class Gtk::Image(_pixmap173_pixmap, _pixmap173_mask));
   ...
   radiobutton_proto_verteilen = manage(new class Gtk::RadioButton(_RadioBGroup_proto_verteilen, "Verteile"));
   radiobutton_proto_spezialisieren = manage(new class Gtk::RadioButton(_RadioBGroup_proto_verteilen, "Spezialisieren"));
   ...
   radiobutton_steigern_gfp = manage(new class Gtk::RadioButton(_RadioBGroup_zufall_steigern, "GFP"));
   ...
   radiobutton_steigern_grad = manage(new class Gtk::RadioButton(_RadioBGroup_zufall_steigern, "Grad"));
   ...
   Gtk::Image *pixmap174 = manage(new class Gtk::Image(_pixmap174_pixmap, _pixmap174_mask));
   ...
   frame_werte_vorgaben->set_shadow_type(Gtk::SHADOW_NONE);
   ...
   frame_vorgaben->set_shadow_type(Gtk::SHADOW_IN);
   ...
   frame116->set_shadow_type(Gtk::SHADOW_NONE);
   ...
   frame_prototyp_mod->set_shadow_type(Gtk::SHADOW_IN);
   ...
   frame112->set_shadow_type(Gtk::SHADOW_IN);
