// generated 2004/5/10 10:28:11 CEST by christof@puck.petig-baender.de
...
{  table_lernschema = this;
   ...
   button_angeborene_fert->signal_clicked().connect(SigC::slot(*this, &table_lernschema_glade::on_button_angeborene_fertigkeit));
   ...
   button_beruf->signal_clicked().connect(SigC::slot(*this, &table_lernschema_glade::on_button_beruf));
   ...
   button_lernschema_geld->signal_clicked().connect(SigC::slot(*this, &table_lernschema_glade::on_button_lernschema_geld));
   button_lernschema_waffen->signal_clicked().connect(SigC::slot(*this, &table_lernschema_glade::on_button_lernschema_waffen));
   ...
   button_ruestung->signal_clicked().connect(SigC::slot(*this, &table_lernschema_glade::on_button_ruestung));
   button_ausruestung->signal_clicked().connect(SigC::slot(*this, &table_lernschema_glade::on_button_ausruestung));
