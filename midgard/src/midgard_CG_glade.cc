// generated 2001/4/20 20:27:59 CEST by thoma@ig23.
...
{   
   ...
   Gtk::Table *table61 = manage(new class Gtk::Table(3, 1, false));
   ...
   Gtk::Button *WidgetHcvlGHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Select_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table61->attach(*checkbutton_alle_zauber, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   ...
   table44->attach(*frame63, 2, 3, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 20, 0);
   ...
   WidgetHcvlGHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
