...
{  table_steigern = this;
   ...
   label699->set_alignment(0.5,0.5);
   label699->set_padding(0,0);
   ...
   label700->set_alignment(0.5,0.5);
   label700->set_padding(0,0);
   ...
   label698->set_alignment(0.5,0.5);
   label698->set_padding(0,0);
