// generated 2004/5/10 13:57:44 CEST by christof@puck.petig-baender.de
...
{  table_steigern = this;
   ...
   _tooltips.set_tip(*button_gold_eingeben, "Geld eingeben/ändern", "");
   ...
   _tooltips.set_tip(*checkbutton_gfp, "GFP eingeben/ändern", "");
   ...
   _tooltips.set_tip(*button_EP, "Erfahrungspunkte eingeben/ändern", "");
   ...
   _tooltips.set_tip(*togglebutton_spruchrolle, "Lernen von Spruchrolle", "");
   ...
   table_steigern->show();
   tree_steigern_zusatz->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_steigern_zusatz_leaf_selected), false);
   alte_fert_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_fert), false);
   alte_fert_tree->signal_reorder().connect(SigC::slot(*this, &table_steigern_glade::on_alte_fert_reorder), false);
   neue_fert_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_fert), false);
   alte_waffen_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_waffen), false);
   alte_waffen_tree->signal_reorder().connect(SigC::slot(*this, &table_steigern_glade::on_alte_waffen_reorder), false);
   neue_waffen_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_waffen), false);
   alte_grund_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_grund), false);
   neue_grund_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_grund), false);
   alte_zauber_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_zauber), false);
   alte_zauber_tree->signal_reorder().connect(SigC::slot(*this, &table_steigern_glade::on_alte_zauber_reorder), false);
   neue_zauber_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_zauber), false);
   alte_zaubermittel_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_zauberwerk), false);
   alte_zaubermittel_tree->signal_reorder().connect(SigC::slot(*this, &table_steigern_glade::on_alte_zaubermittel_reorder), false);
   neue_zaubermittel_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_zauberwerk), false);
   alte_kido_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_kido), false);
   alte_kido_tree->signal_reorder().connect(SigC::slot(*this, &table_steigern_glade::on_alte_kido_reorder), false);
   neue_kido_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_kido), false);
   alte_sprache_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_sprache), false);
   alte_sprache_tree->signal_reorder().connect(SigC::slot(*this, &table_steigern_glade::on_alte_sprache_reorder), false);
   neue_sprache_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_sprache), false);
   alte_schrift_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_schrift), false);
   neue_schrift_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_schrift), false);
   ...
   waffenbesitz_alt_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_waffenbesitz_selected_alt), false);
   waffenbesitz_alt_tree->signal_reorder().connect(SigC::slot(*this, &table_steigern_glade::on_alte_waffenbesitz_reorder), false);
   spinbutton_av_bonus->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_spinbutton_av_bonus_activate), false);
   spinbutton_sl_bonus->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_spinbutton_sl_bonus_activate), false);
   entry_magisch->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_entry_magisch_activate), false);
   waffenbesitz_neu_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_waffenbesitz_selected_neu), false);
   notebook_lernen->signal_switch_page().connect(SigC::slot(*this, &table_steigern_glade::on_notebook_lernen_switch_page), false);
   button_alter->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_button_alter_clicked), false);
   LabelSpin_aep->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_LabelSpin_aep_activate), false);
   LabelSpin_kep->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_LabelSpin_kep_activate), false);
   LabelSpin_zep->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_LabelSpin_zep_activate), false);
   LabelSpin_gold->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_LabelSpin_gold_activate), false);
   LabelSpin_silber->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_LabelSpin_silber_activate), false);
   LabelSpin_kupfer->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_LabelSpin_kupfer_activate), false);
   LabelSpin_gfp->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_LabelSpin_gfp_activate), false);
   ...
   spinbutton_eigenschaften_grad_anstieg->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_spinbutton_eigenschaften_grad_anstieg_activate), false);
   ...
   togglebutton_pp_verfallen->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_togglebutton_pp_verfallen_toggled), false);
   togglebutton_pp_aep_fuellen->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_togglebutton_pp_aep_fuellen_toggled), false);
   radiobutton_praxis->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radio_praxis_toggled), false);
   radiobutton_unterweisung->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radio_unterweisung_toggled), false);
   radiobutton_selbst->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radio_selbst_toggled), false);
   radiobutton_reduzieren->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radio_reduzieren_toggled), false);
   radiobutton_verlernen->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radio_verlernen_toggled), false);
   radiobutton_steigern->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radio_steigern_toggled), false);
   spinbutton_pp_eingeben->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_spinbutton_pp_eingeben_activate), false);
