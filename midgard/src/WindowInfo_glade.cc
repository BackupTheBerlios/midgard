...
{  
   ...
   Gtk::Pixmap *pixmap_nein = manage(new class Gtk::Pixmap(Nein_32_xpm));
   ...
   Gtk::Pixmap *pixmap143 = manage(new class Gtk::Pixmap(Clear_32_xpm));
   ...
   Gtk::Pixmap *pixmap187 = manage(new class Gtk::Pixmap(Angeb_Sicht_32_xpm));
   ...
   label648->set_justify(GTK_JUSTIFY_CENTER);
   label648->set_line_wrap(false);
   hbox101->pack_start(*pixmap187);
   hbox101->pack_start(*label648, false, false, 0);
   button_status->set_flags(GTK_CAN_FOCUS);
   button_status->set_relief(GTK_RELIEF_NORMAL);
   ...
   table_schliessen->attach(*button_status, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   scrolledwindow_status->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   ...
   table133->attach(*scrolledwindow_status, 0, 1, 10, 11, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table133->attach(*pixmap_arkanum, 1, 2, 0, 11, 0, 0, 0, 0);
   ...
   pixmap_arkanum->show();
   table133->show();
   button_bestaetigen->clicked.connect(SigC::slot(this, &WindowInfo_glade::on_button_bestaetigen_clicked));
   button_abbrechen->clicked.connect(SigC::slot(this, &WindowInfo_glade::on_button_abbrechen_clicked));
   button_info_ok->clicked.connect(SigC::slot(this, &WindowInfo_glade::on_button_abbrechen_clicked));
   button_erase->clicked.connect(SigC::slot(this, &WindowInfo_glade::on_button_erase_clicked));
   button_status->toggled.connect(SigC::slot(this, &WindowInfo_glade::on_button_status_toggled));
   WindowInfo->delete_event.connect(SigC::slot(this, &WindowInfo_glade::on_WindowInfo_delete_event));
}
