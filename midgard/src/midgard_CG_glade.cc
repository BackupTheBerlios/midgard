// generated 2002/2/6 14:55:35 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table121 = manage(new class Gtk::Table(1, 3, false));
   ...
   table118->attach(*label_spezialwaffe, 0, 1, 4, 5, GTK_FILL, 0, 0, 0);
   ...
   scrolledwindow59->set_usize(127, 120);
   scrolledwindow59->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   scrolledwindow59->add(*viewport37);
   table121->attach(*table118, 2, 3, 0, 1, GTK_EXPAND, 0, 0, 0);
   table121->attach(*vbox26, 1, 2, 0, 1, GTK_EXPAND, 0, 0, 0);
   table121->attach(*scrolledwindow59, 0, 1, 0, 1, GTK_EXPAND, 0, 0, 0);
