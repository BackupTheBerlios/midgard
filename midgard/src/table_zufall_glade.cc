...
{  table_zufall = this;
   ...
   checkbutton_spezies->set_name("checkbutton_spezies");
   ...
   checkbutton_herkunft->set_name("checkbutton_herkunft");
   ...
   checkbutton_typ->set_name("checkbutton_typ");
   ...
   checkbutton_ange_fert->set_name("checkbutton_ange_fert");
   ...
   combo_spezies->get_entry()->set_name("entry7");
   ...
   combo_spezies->get_entry()->set_text("");
   combo_typ->get_entry()->set_name("entry8");
   ...
   combo_typ->get_entry()->set_text("");
   combo_herkunft->get_entry()->set_name("entry9");
   ...
   combo_herkunft->set_name("combo_herkunft");
   ...
   combo_herkunft->get_entry()->set_text("");
   checkbutton_werte->set_name("checkbutton_werte");
   ...
   checkbutton_st->set_name("checkbutton_st");
   ...
   checkbutton_gs->set_name("checkbutton_gs");
   ...
   checkbutton_gw->set_name("checkbutton_gw");
   ...
   checkbutton_ko->set_name("checkbutton_ko");
   ...
   checkbutton_in->set_name("checkbutton_in");
   ...
   checkbutton_zt->set_name("checkbutton_zt");
   ...
   checkbutton_au->set_name("checkbutton_au");
   ...
   checkbutton_pa->set_name("checkbutton_pa");
   ...
   checkbutton_wk->set_name("checkbutton_wk");
   ...
   checkbutton_sb->set_name("checkbutton_sb");
   ...
   checkbutton_b->set_name("checkbutton_b");
   ...
   frame_werte_vorgaben->set_name("frame_werte_vorgaben");
   ...
   frame_vorgaben->set_name("frame_vorgaben");
   ...
   radiobutton_proto_spezialisieren->set_name("radiobutton_proto_spezialisieren");
   ...
   spinbutton_ausnahme->set_name("spinbutton_ausnahme");
   ...
   spinbutton_standard->set_name("spinbutton_standard");
   ...
   spinbutton_grund->set_name("spinbutton_grund");
   ...
   frame_verteilung_auf->set_name("frame_verteilung_auf");
   ...
   tree_prototyp->set_name("tree_prototyp");
   scrolledwindow_prototyp->set_name("scrolledwindow_prototyp");
   ...
   frame_spezialist_typen->set_name("frame_spezialist_typen");
   ...
   eventbox23->set_name("eventbox23");
   eventbox23->add(*table176);
   spinbutton_zauberwerk->set_name("spinbutton_zauberwerk");
   ...
   button_check100->set_name("button_check100");
   ...
   scale_fert->set_name("scale_fert");
   scale_waffen->set_name("scale_waffen");
   scale_sprachen->set_name("scale_sprachen");
   scale_schriften->set_name("scale_schriften");
   hseparator21->set_name("hseparator21");
   spinbutton_fertigkeit->set_name("spinbutton_fertigkeit");
   ...
   spinbutton_waffen_grund->set_name("spinbutton_waffen_grund");
   ...
   spinbutton_sprachen->set_name("spinbutton_sprachen");
   ...
   spinbutton_schriften->set_name("spinbutton_schriften");
   ...
   eventbox21->set_name("eventbox21");
   ...
   frame_prototyp_mod->set_name("frame_prototyp_mod");
   ...
   radiobutton_steigern_gfp->set_name("radiobutton_steigern_gfp");
   ...
   radiobutton_steigern_grad->set_name("radiobutton_steigern_grad");
   ...
   eventbox22->set_name("eventbox22");
   ...
   combo_prototyp->set_name("combo_prototyp");
   ...
   table_zufall->set_name("table_zufall");
