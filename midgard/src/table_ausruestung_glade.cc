// generated 2002/11/1 14:12:02 CET by thoma@Tiger.(none)
...
{  table_ausruestung = this;
   ...
   table105->attach(*togglebutton_unverkauflich, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   entry_artikel_art2->activate.connect(SigC::slot(this, &table_ausruestung_glade::on_entry_artikel_art2_activate));
