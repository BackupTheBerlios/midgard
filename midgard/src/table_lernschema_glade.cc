// generated 2006/1/27 12:50:10 CET by christof@vesta.petig-baender.de
...
{  table_lernschema = this;
   ...
   eventbox_zusatz->property_visible_window().set_value(true);
   eventbox_zusatz->property_above_child().set_value(false);
