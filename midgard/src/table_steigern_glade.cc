// generated 2002/6/17 9:55:47 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   table99->attach(*frame_zauber_zusatz, 5, 6, 0, 1, 0, GTK_FILL, 5, 0);
   table99->attach(*frame_fertigkeit, 3, 4, 0, 1, 0, 0, 10, 0);
   table99->attach(*frame_praxispunkte, 4, 5, 0, 1, GTK_SHRINK, GTK_SHRINK|GTK_FILL, 0, 0);
