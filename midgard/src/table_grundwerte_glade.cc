// generated 2004/5/17 15:43:51 CEST by christof@puck.petig-baender.de
...
{  table_grundwerte = this;
   ...
   table_grundwerte->attach(*hseparator1, 0, 1, 0, 1, Gtk::FILL, Gtk::AttachOptions(), 0, 5);
   table_grundwerte->attach(*table67, 0, 1, 1, 2, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK, 10, 0);
   table_grundwerte->attach(*toolbar2, 0, 1, 0, 1, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK, 0, 0);
   table_grundwerte->attach(*hseparator20, 0, 1, 2, 3, Gtk::SHRINK|Gtk::FILL, Gtk::AttachOptions(), 0, 5);
   table_grundwerte->attach(*table68, 0, 1, 3, 4, Gtk::SHRINK|Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   table_grundwerte->attach(*frame_wuerfelvariante, 0, 1, 4, 5, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK|Gtk::FILL, 0, 0);
   hseparator1->show();
   entry_nameC->show();
   label613->show();
   frame30->show();
