...
private:
        ...
        virtual bool on_angeborene_fertigkeit_button_release_event(GdkEventButton *ev) = 0;
        virtual void on_lernpunkte_wuerfeln_clicked() = 0;
        virtual void on_togglebutton_lernpunkte_edit_toggled() = 0;
        virtual bool on_button_beruf_release_event(GdkEventButton *ev) = 0;
        ...
        virtual bool on_button_lernschema_geld_button_release_event(GdkEventButton *ev) = 0;
        virtual bool on_button_lernschema_waffen_button_release_event(GdkEventButton *ev) = 0;
        ...
        virtual bool on_button_ruestung_button_release_event(GdkEventButton *ev) = 0;
        virtual bool on_button_ausruestung_button_release_event(GdkEventButton *ev) = 0;
};
#endif
