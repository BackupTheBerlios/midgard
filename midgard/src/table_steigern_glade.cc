// generated 2002/11/21 9:59:28 CET by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   handlebox_steigern_1->set_shadow_type(GTK_SHADOW_NONE);
   handlebox_steigern_1->set_handle_position(GTK_POS_LEFT);
   handlebox_steigern_1->set_snap_edge(GTK_POS_TOP);
   ...
   table72->attach(*button_gold_eingeben, 4, 5, 2, 3, GTK_SHRINK, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table72->attach(*checkbutton_gfp, 4, 5, 1, 2, GTK_SHRINK, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table72->attach(*button_EP, 4, 5, 0, 1, GTK_SHRINK, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   handlebox_steigern_2->set_shadow_type(GTK_SHADOW_NONE);
   handlebox_steigern_2->set_handle_position(GTK_POS_LEFT);
   handlebox_steigern_2->set_snap_edge(GTK_POS_TOP);
   ...
   handlebox_steigern_4->set_shadow_type(GTK_SHADOW_NONE);
   handlebox_steigern_4->set_handle_position(GTK_POS_LEFT);
   handlebox_steigern_4->set_snap_edge(GTK_POS_TOP);
   ...
   handlebox_steigern_3->set_shadow_type(GTK_SHADOW_NONE);
   handlebox_steigern_3->set_handle_position(GTK_POS_LEFT);
   handlebox_steigern_3->set_snap_edge(GTK_POS_LEFT);
   handlebox_steigern_3->add(*table99);
   table_handlebox1->set_row_spacings(0);
   table_handlebox1->set_col_spacings(0);
   table_handlebox1->attach(*handlebox_steigern_1, 0, 1, 0, 1, 0, 0, 0, 0);
   table_handlebox1->attach(*handlebox_steigern_2, 1, 2, 0, 1, 0, GTK_FILL, 0, 0);
   table_handlebox1->attach(*handlebox_steigern_4, 2, 3, 0, 2, GTK_SHRINK, GTK_SHRINK, 0, 0);
   table_handlebox1->attach(*handlebox_steigern_3, 0, 2, 1, 2, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
