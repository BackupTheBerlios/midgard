...
{   
   ...
   Gtk::Button *WidgetjPpXGHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(KiDo_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   radiobutton_frau->set_usize(93, 24);
   radiobutton_mann->set_usize(93, 24);
   ...
   WidgetjPpXGHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
