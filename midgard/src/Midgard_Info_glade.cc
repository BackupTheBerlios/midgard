...
{  Midgard_Info = this;
   ...
   table109->attach(*label604, 1, 2, 4, 5, GTK_FILL, 0, 0, 0);
   table109->attach(*label605, 2, 3, 4, 5, GTK_FILL, 0, 0, 0);
   table109->attach(*pixmap169, 0, 1, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
   table109->attach(*label406, 2, 3, 3, 4, GTK_FILL, 0, 0, 0);
   table109->attach(*label407, 1, 2, 3, 4, GTK_FILL, 0, 0, 0);
   table109->attach(*pixmap60, 0, 1, 3, 4, GTK_FILL, GTK_FILL, 0, 0);
