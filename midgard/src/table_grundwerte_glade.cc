// generated 2006/8/14 10:07:51 CEST by christof@vesta.petig-baender.de
...
{  table_grundwerte = this;
...
#endif //
   label_last_edited->set_alignment(0.5,0.5);
   label_last_edited->set_padding(0,0);
   ...
   label702->set_alignment(0.5,0.5);
   label702->set_padding(0,0);
