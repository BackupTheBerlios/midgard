...
{  table_beschreibung = this;
   ...
   Gtk::Pixmap *pixmap148 = manage(new class Gtk::Pixmap(Portrait_32_xpm));
   ...
   button_beschreibung_drucken->clicked.connect(SigC::slot(this, &table_beschreibung_glade::on_button_beschreibung_drucken_clicked));
   button_grafik->button_release_event.connect(SigC::slot(this, &table_beschreibung_glade::on_button_grafik_button_release_event));
   spinbutton_pix_breite->focus_out_event.connect(SigC::slot(this, &table_beschreibung_glade::on_spinbutton_pix_breite_focus_out_event));
   spinbutton_pix_breite->focus_in_event.connect(SigC::slot(this, &table_beschreibung_glade::on_spinbutton_pix_breite_focus_in_event));
   text_charakter_beschreibung->focus_out_event.connect(SigC::slot(this, &table_beschreibung_glade::on_text_charakter_beschreibung_focus_out_event));
   button_fett->clicked.connect(SigC::slot(this, &table_beschreibung_glade::on_button_fett_clicked));
   button_kursiv->clicked.connect(SigC::slot(this, &table_beschreibung_glade::on_button_kursiv_clicked));
   button_liste->clicked.connect(SigC::slot(this, &table_beschreibung_glade::on_button_liste_clicked));
   button_liste2->clicked.connect(SigC::slot(this, &table_beschreibung_glade::on_button_liste2_clicked));
}
