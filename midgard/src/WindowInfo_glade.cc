// generated 2003/4/14 22:42:01 CEST by christof@puck.petig-baender.de
...
{  
   ...
   Gtk::Image *pixmap_ja = Gtk::manage(new class Gtk::Image(_pixmap_ja_pixmap, _pixmap_ja_mask));
   ...
   Gtk::Image *pixmap_nein = Gtk::manage(new class Gtk::Image(_pixmap_nein_pixmap, _pixmap_nein_mask));
   ...
   Gtk::Image *pixmap187 = Gtk::manage(new class Gtk::Image(_pixmap187_pixmap, _pixmap187_mask));
   ...
   pixmap_arkanum = Gtk::manage(new class Gtk::Image(_pixmap_arkanum_pixmap, _pixmap_arkanum_mask));
   
   Gtk::Table *table133 = Gtk::manage(new class Gtk::Table(2, 2, false));
   LogWin->set_name("LogWin");
   pixmap_ja->set_name("pixmap_ja");
   pixmap_ja->set_alignment(0.5,0.5);
   pixmap_ja->set_padding(0,0);
   label570->set_name("label570");
   ...
   table_schliessen->set_name("table_schliessen");
   ...
   LogWin_Status->set_name("LogWin_Status");
   scrolledwindow_status->set_name("scrolledwindow_status");
   ...
   WindowInfo->set_name("WindowInfo");
