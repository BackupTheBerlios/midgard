// generated 2002/11/16 21:13:44 CET by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   _tooltips.set_tip(*eventbox7, "Geld eingeben (Rechte Maustaste: ändern)\n"
		"", "");
   ...
   _tooltips.set_tip(*eventbox19, "GFP eingeben (Rechte Maustaste: ändern)", "");
   ...
   _tooltips.set_tip(*eventbox18, "Erfahrungspunkte eingeben (Rechte Maustaste: ändern)", "");
   ...
   button_gold_eingeben->button_release_event.connect_after(SigC::slot(this, &table_steigern_glade::on_button_gold_eingeben_button_release_event));
   LabelSpin_aep->activate.connect(SigC::slot(this, &table_steigern_glade::on_LabelSpin_aep_activate));
   LabelSpin_kep->activate.connect(SigC::slot(this, &table_steigern_glade::on_LabelSpin_kep_activate));
   LabelSpin_zep->activate.connect(SigC::slot(this, &table_steigern_glade::on_LabelSpin_zep_activate));
   LabelSpin_gold->activate.connect(SigC::slot(this, &table_steigern_glade::on_LabelSpin_gold_activate));
   LabelSpin_silber->activate.connect(SigC::slot(this, &table_steigern_glade::on_LabelSpin_silber_activate));
   LabelSpin_kupfer->activate.connect(SigC::slot(this, &table_steigern_glade::on_LabelSpin_kupfer_activate));
   LabelSpin_gfp->activate.connect(SigC::slot(this, &table_steigern_glade::on_LabelSpin_gfp_activate));
   checkbutton_EP_Geld->toggled.connect(SigC::slot(this, &table_steigern_glade::on_checkbutton_EP_Geld_toggled));
   checkbutton_gfp->button_release_event.connect_after(SigC::slot(this, &table_steigern_glade::on_checkbutton_gfp_button_release_event));
   button_EP->button_release_event.connect_after(SigC::slot(this, &table_steigern_glade::on_button_EP_eingeben_button_release_event));
