// generated 2001/12/31 16:32:15 CET by thoma@Tiger.
...
#include "../pixmaps/right_arr.xpm"
#include "../pixmaps/left_arr.xpm"
...
{   
   ...
   Gtk::Pixmap *pixmap70 = manage(new class Gtk::Pixmap(right_arr_xpm));
   Gtk::Button *button_waffe_trans = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap71 = manage(new class Gtk::Pixmap(left_arr_xpm));
   ...
   button_grad_zaubern = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar38->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Zaubern", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Zauber_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *button_grad_basiswerte = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar38->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Basiswerte", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Dice_W100_trans_50_xpm))->gtkobj()), 0, 0));
