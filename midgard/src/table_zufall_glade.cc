// generated 2004/5/10 13:57:53 CEST by christof@puck.petig-baender.de
...
{  table_zufall = this;
   ...
   spinbutton_ausnahme->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_spinbutton_ausnahme_activate), false);
   spinbutton_standard->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_spinbutton_standard_activate), false);
   spinbutton_grund->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_spinbutton_grund_activate), false);
   tree_prototyp->signal_leaf_selected().connect(SigC::slot(*this, &table_zufall_glade::on_tree_prototyp_leaf_selected), false);
   spinbutton_zauberwerk->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_spinbutton_zauberwerk_activate), false);
   button_check100->signal_clicked().connect(SigC::slot(*this, &table_zufall_glade::on_button_check100_clicked), false);
   scale_fert->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_scale_fert_activate), false);
   scale_waffen->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_scale_waffen_activate), false);
   scale_sprachen->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_scale_sprachen_activate), false);
   scale_schriften->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_scale_schriften_activate), false);
   spinbutton_fertigkeit->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_spinbutton_fertigkeit_activate), false);
   spinbutton_waffen->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_spinbutton_waffen_activate), false);
   spinbutton_waffen_grund->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_spinbutton_waffen_grund_activate), false);
   spinbutton_zauber->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_spinbutton_zauber_activate), false);
   spinbutton_sprachen->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_spinbutton_sprachen_activate), false);
   spinbutton_schriften->signal_activate().connect(SigC::slot(*this, &table_zufall_glade::on_spinbutton_schriften_activate), false);
