// generated 2002/1/3 16:05:43 CET by thoma@Tiger.
...
#include "../pixmaps/right_arr-exp.xpm"
#include "../pixmaps/left_arr-exp.xpm"
...
{   
   ...
   Gtk::Pixmap *pixmap70 = manage(new class Gtk::Pixmap(right_arr_exp_xpm));
   Gtk::Button *button_waffe_trans = manage(new class Gtk::Button());
   Gtk::Pixmap *pixmap71 = manage(new class Gtk::Pixmap(left_arr_exp_xpm));
   ...
   Gtk::Pixmap *pixmap78 = manage(new class Gtk::Pixmap(Steigern_trans_32_xpm));
