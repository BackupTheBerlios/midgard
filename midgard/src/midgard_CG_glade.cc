// generated 2002/2/23 20:05:16 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table121 = manage(new class Gtk::Table(1, 5, false));
   Gtk::Table *table112 = manage(new class Gtk::Table(1, 1, false));
   ...
   Gtk::Label *label537 = manage(new class Gtk::Label("angeborene\n"
		"Fertigkeiten"));
   Gtk::Table *table119 = manage(new class Gtk::Table(2, 4, false));
   ...
   Gtk::Table *table127 = manage(new class Gtk::Table(2, 1, false));
   Gtk::Table *table126 = manage(new class Gtk::Table(1, 2, false));
   ...
   table66->attach(*typauswahl_2, 2, 3, 1, 2, GTK_FILL, 0, 0, 0);
   table66->attach(*fixed5, 3, 4, 0, 1, GTK_FILL, GTK_FILL, 20, 0);
   ...
   table96->attach(*frame_KiDo_lernschema, 6, 7, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table121->attach(*frame59, 0, 1, 0, 1, 0, 0, 0, 0);
   table121->attach(*table_berufswahl, 4, 5, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table121->attach(*togglebutton_spezialwaffe, 1, 2, 0, 1, GTK_FILL, GTK_EXPAND, 0, 0);
   table112->attach(*table121, 0, 1, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table119->attach(*pixmap95, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table119->attach(*pixmap97, 3, 4, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table119->attach(*label537, 1, 3, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   table116->attach(*toolbar3, 0, 1, 0, 1, GTK_SHRINK|GTK_FILL, 0, 22, 0);
   ...
   table127->attach(*frame101, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table127->attach(*frame102, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table126->attach(*table116, 0, 1, 0, 1, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table126->attach(*table127, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table108->attach(*table112, 0, 1, 2, 3, GTK_SHRINK, GTK_SHRINK, 0, 0);
