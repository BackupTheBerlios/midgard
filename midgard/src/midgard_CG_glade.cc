// generated 2004/5/9 23:57:55 CEST by christof@puck.petig-baender.de
...
{  midgard_CG = this;
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Neuer Abenteurer", Gtk::Menu_Helpers::AccelKey(GDK_N, Gdk::MOD1_MASK), *image67));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Öffnen", Gtk::Menu_Helpers::AccelKey(GDK_O, Gdk::CONTROL_MASK), *image68));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Speichern", Gtk::Menu_Helpers::AccelKey(GDK_S, Gdk::CONTROL_MASK), *image70));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Schließen", Gtk::Menu_Helpers::AccelKey(GDK_W, Gdk::CONTROL_MASK), *image74));
   schlie__en1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Beenden", Gtk::Menu_Helpers::AccelKey(GDK_Q, Gdk::CONTROL_MASK), *image75));
   beenden1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie5 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   bearbeiten1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Rückgängig", Gtk::Menu_Helpers::AccelKey(GDK_Z, Gdk::CONTROL_MASK), *image76));
