// generated 2002/3/9 23:58:53 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table134 = manage(new class Gtk::Table(1, 2, false));
   ...
   table134->attach(*button_beschreibung_drucken, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table134->attach(*button_grafik, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table23->attach(*scrolledwindow80, 0, 2, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table23->attach(*label398, 1, 2, 0, 1, 0, 0, 5, 5);
