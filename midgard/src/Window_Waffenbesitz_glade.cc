...
{  
   ...
   Gtk::AccelGroup *Window_Waffenbesitz_accgrp = Gtk::AccelGroup::create();
   _data = new GlademmData(Window_Waffenbesitz_accgrp);
   ...
   Gtk::Pixmap *pixmap141 = manage(new class Gtk::Pixmap(wizzard_trans_50_2_xpm));
   Gtk::Label *label561 = manage(new class Gtk::Label("Magischen Bonus\n"
		"eingeben"));
   Gtk::HBox *hbox65 = manage(new class Gtk::HBox(false, 0));
   ...
   pixmap141->set_alignment(0.5, 0.5);
   pixmap141->set_padding(0, 0);
   label561->set_alignment(0.5, 0.5);
   label561->set_padding(0, 0);
   hbox65->pack_start(*pixmap141);
   hbox65->pack_start(*label561, false, false, 0);
   ...
   checkbutton_mag_waffenbonus->add(*hbox65);
   ...
   Window_Waffenbesitz->set_modal(true);
   Window_Waffenbesitz->set_policy(false, true, true);
   Window_Waffenbesitz->add_accel_group(*(_data->getAccelGroup()));
   ...
   waffenbesitz_alt_tree->reorder.connect(SigC::slot(static_cast<class Window_Waffenbesitz*>(this), &Window_Waffenbesitz::on_alte_waffen_reorder));
