...
{  table_optionen = this;
   ...
   table147->attach(*spinbutton_datei_history, 1, 2, 5, 6, Gtk::EXPAND|Gtk::SHRINK|Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   ...
   table147->attach(*label575, 0, 2, 0, 1, Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   ...
   table146->show();
   table_optionen->show();
   entry_html->signal_changed().connect(SigC::slot(*this, &table_optionen_glade::on_entry_html_changed), false);
   entry_tmp_verz->signal_changed().connect(SigC::slot(*this, &table_optionen_glade::on_entry_tmp_verz_changed), false);
   entry_speicher_verz->signal_changed().connect(SigC::slot(*this, &table_optionen_glade::on_entry_speicher_verz_changed), false);
   spinbutton_datei_history->signal_changed().connect(SigC::slot(*this, &table_optionen_glade::on_spinbutton_datei_history_changed), false);
