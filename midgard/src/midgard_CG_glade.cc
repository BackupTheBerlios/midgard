...
{   
   ...
   optionmenu_land = manage(new class Gtk::OptionMenu());
   ...
   Gtk::Button *WidgetjpKvHHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   optionmenu_land->set_flags(GTK_CAN_FOCUS);
   {   
      
      Gtk::Menu *_m(manage(new Gtk::Menu()));
      Gtk::MenuItem *_mi;
      _mi = manage(new Gtk::MenuItem("Stadt"));
      _m->append(*_mi);
      _mi->show();
      _mi->set_user_data((gpointer)0);
      _mi = manage(new Gtk::MenuItem("Land"));
      _m->append(*_mi);
      _mi->show();
      _mi->set_user_data((gpointer)1);
      optionmenu_land->set_menu(*_m);
      optionmenu_land->set_history(0);
   }
   ...
   table66->attach(*optionmenu_spezies, 3, 4, 0, 1, GTK_FILL, 0, 0, 0);
   table66->attach(*fixed5, 1, 2, 0, 1, GTK_FILL, GTK_FILL, 20, 0);
   table66->attach(*optionmenu_land, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   optionmenu_land->get_menu()->deactivate.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_optionmenu_land_deactivate));
   ...
   WidgetjpKvHHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
