...
{  
   ...
   Gtk::AccelGroup *Window_ruestung_accgrp = Gtk::AccelGroup::create();
   _data = new GlademmData(Window_ruestung_accgrp);
   ...
   Window_ruestung->add_accel_group(*(_data->getAccelGroup()));
