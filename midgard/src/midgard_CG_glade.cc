// generated 2001/4/10 8:12:36 CEST by thoma@ig23.
...
{   
   ...
   optionmenu_rassen = manage(new class Gtk::OptionMenu());
   ...
   Gtk::Button *WidgethjpVGHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Select_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table1->attach(*optionmenu_rassen, 3, 4, 2, 3, GTK_FILL, 0, 0, 0);
   ...
   WidgethjpVGHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
