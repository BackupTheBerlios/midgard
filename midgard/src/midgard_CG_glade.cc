// generated 2002/2/6 11:28:12 CET by thoma@Tiger.
...
{   
   ...
   table_berufswahl = manage(new class Gtk::Table(2, 2, false));
   
   Gtk::Table *table118 = manage(new class Gtk::Table(5, 1, false));
   ...
   button_fachkenntnisse = manage(new class Gtk::Button());
   ...
   button_allgemeinwissen = manage(new class Gtk::Button());
   ...
   button_waffen = manage(new class Gtk::Button());
   ...
   button_zauber = manage(new class Gtk::Button());
   ...
   Gtk::Table *table117 = manage(new class Gtk::Table(1, 2, false));
   ...
   Gtk::Table *table116 = manage(new class Gtk::Table(1, 2, false));
   ...
   Gtk::Table *table112 = manage(new class Gtk::Table(2, 3, false));
   ...
   Gtk::Table *table108 = manage(new class Gtk::Table(3, 2, false));
   ...
   vbox_berufsname->pack_start(*label_spezialwaffe, false, false, 0);
   ...
   table_berufswahl->attach(*label542, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table_berufswahl->attach(*entry_berufsname, 1, 2, 1, 2, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table_berufswahl->attach(*button_beruf, 0, 1, 0, 2, GTK_FILL, 0, 0, 0);
   table118->attach(*table_kido_lernschema, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table118->attach(*vbox_berufsname, 0, 1, 3, 4, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table118->attach(*table_berufswahl, 0, 1, 2, 3, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   vbox33->pack_start(*button_fachkenntnisse, false, false, 0);
   ...
   vbox34->pack_start(*button_allgemeinwissen, false, false, 0);
   ...
   vbox36->pack_start(*button_waffen, false, false, 0);
   ...
   vbox37->pack_start(*button_zauber, false, false, 0);
   ...
   vbox35->pack_end(*button_untyp_fertigkeiten, false, false, 0);
   ...
   table96->attach(*frame80, 2, 4, 0, 1, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   frame24->set_label_align(0, 0);
   frame24->set_shadow_type(GTK_SHADOW_ETCHED_IN);
   frame24->add(*table96);
   table117->attach(*table118, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table119->attach(*pixmap98, 1, 2, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   table119->attach(*label537, 1, 3, 0, 1, GTK_FILL, 0, 0, 0);
   table119->attach(*pixmap96, 2, 3, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table116->attach(*vbox26, 1, 2, 0, 1, GTK_EXPAND, GTK_FILL, 0, 0);
   ...
   viewport37->set_shadow_type(GTK_SHADOW_NONE);
   viewport37->add(*clist_sinne);
   scrolledwindow59->set_usize(127, -1);
   scrolledwindow59->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   scrolledwindow59->add(*viewport37);
   table112->attach(*label544, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table112->attach(*label_lernschma_titel, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   table112->attach(*scrolledwindow73, 1, 2, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table112->attach(*scrolledwindow72, 2, 3, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table112->attach(*scrolledwindow59, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   table108->attach(*table116, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table108->attach(*table112, 0, 1, 2, 3, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table108->attach(*scrolledwindow74, 1, 2, 0, 3, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   button_fachkenntnisse->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_fach_fertigkeiten_wahl_clicked));
   ...
   button_allgemeinwissen->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_allgemein_fertigkeiten_wahl_clicked));
   ...
   button_waffen->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_waffen_wahl_clicked));
   ...
   button_zauber->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_zauber_wahl_clicked));
