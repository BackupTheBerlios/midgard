// $Id: midgard_CG.cc,v 1.177 2002/03/12 12:01:56 thoma Exp $
...
cout << "Option Wizard = "<<OptionenCheck(Wizard_immer_starten).active<<'\n';
cout << "Option Bilder = "<<OptionenCheck(showPics).active<<'\n';
