...
{  midgard_CG = this;
   ...
   notebook_main->pages().push_back(Gtk::Notebook_Helpers::TabElem(*table_beschreibung, *eventbox_beschreibung));
   ...
   frame_haus_status->set_shadow_type(GTK_SHADOW_NONE);
   ...
   hbox88->pack_start(*frame_haus_status, false, false, 0);
   ...
   exportieren_ranas_pdf_dokumente->activate.connect(SigC::slot(this, &midgard_CG_glade::on_exportieren_ranas_pdf_dokumente_activate));
   ...
   eventbox_beschreibung->button_release_event.connect(SigC::slot(this, &midgard_CG_glade::on_eventbox_beschreibung_button_release_event));
