// $Id: Midgard_Info.cc,v 1.73 2002/12/14 23:45:11 christof Exp $
...
void Midgard_Info::set_Regionen(const std::vector<cH_Region>& Regionen)
{
  ...
  Gtk::Image *_pi2=manage(new Gtk::Image(Gdk::Pixbuf::create_from_xpm_data(Dfr3_50_xpm)));
  ...
  Gtk::Image *_pi3=manage(new Gtk::Image(Gdk::Pixbuf::create_from_xpm_data(Kurai_50_xpm)));
  ...
  Gtk::Image *_pi=manage(new Gtk::Image(Gdk::Pixbuf::create_from_xpm_data(pdolch__xpm)));
  ...
  Gtk::Image *_pc=manage(new Gtk::Image(Gdk::Pixbuf::create_from_xpm_data(Money_50_xpm)));
  ...
  Gtk::Image *_pc2=manage(new Gtk::Image(Gdk::Pixbuf::create_from_xpm_data(Money_50_xpm)));
