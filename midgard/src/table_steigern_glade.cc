...
{  table_steigern = this;
   ...
   Gtk::EventBox *eventbox24 = Gtk::manage(new class Gtk::EventBox());
   ...
   button_rolle = new class ChoiceButton();
   button_pp_variante = new class ChoiceButton();
   ...
   Gtk::Label *label669 = Gtk::manage(new class Gtk::Label("Aktion"));
   ...
   clist_ruestung->set_fixed_height_mode(false);
   clist_ruestung->set_hover_selection(false);
   clist_ruestung->set_hover_expand(false);
#endif //
   ...
   eventbox24->set_events(Gdk::BUTTON_PRESS_MASK);
   eventbox24->add(*label655);
   frame85->set_shadow_type(Gtk::SHADOW_ETCHED_IN);
   frame85->set_label_align(0,0.5);
   frame85->add(*table104);
   frame85->set_label_widget(*eventbox24);
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_1->set_expanded(false);
   ...
   label699->set_line_wrap(false);
   label699->set_use_markup(false);
   label699->set_selectable(false);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_2->set_expanded(false);
   ...
   label700->set_line_wrap(false);
   label700->set_use_markup(false);
   label700->set_selectable(false);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_4->set_expanded(false);
   ...
   table102->attach(*togglebutton_alle_zauber, 0, 1, 0, 1, Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   table102->attach(*togglebutton_zaubersalze, 0, 1, 1, 2, Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   ...
   button_rolle->set_flags(Gtk::CAN_FOCUS);
   button_pp_variante->set_flags(Gtk::CAN_FOCUS);
   ...
   table101->attach(*button_rolle, 1, 2, 0, 1, Gtk::EXPAND|Gtk::FILL, Gtk::FILL, 0, 0);
   table101->attach(*button_pp_variante, 2, 3, 0, 1, Gtk::EXPAND|Gtk::FILL, Gtk::FILL, 0, 0);
   ...
   _tooltips.set_tip(*togglebutton_praxispunkte, "Praxispunkte eingeben", "");
   ...
   label698->set_line_wrap(false);
   label698->set_use_markup(false);
   label698->set_selectable(false);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_3->set_expanded(false);
   ...
   eventbox24->signal_button_press_event().connect(SigC::slot(*this, &table_steigern_glade::pp_eingeben_click), false);
   ...
   button_rolle->signal_changed().connect(SigC::slot(*this, &table_steigern_glade::button_rolle_changed));
   button_pp_variante->signal_changed().connect(SigC::slot(*this, &table_steigern_glade::button_ppvar_changed));
   ...
   radiobutton_pp_fertigkeit->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radiobutton_pp_fertigkeit_toggled), false);
