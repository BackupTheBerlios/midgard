// generated 2002/7/2 14:16:58 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::Button *button_html_hilfe = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_top->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Anleitung", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Help_trans_50_xpm))->gtkobj()), 0, 0));
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Space());
