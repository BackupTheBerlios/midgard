// generated 2002/3/11 20:03:01 CET by thoma@Tiger.
...
{   
   ...
   radiobutton_eigenschaften_standard = manage(new class Gtk::RadioButton(_RadioBGroup_Eigenschaften_wuerfeln, "Standard"));
   radiobutton_eigenschaften_zuweisen = manage(new class Gtk::RadioButton(_RadioBGroup_Eigenschaften_wuerfeln, "Zuweisen"));
   radiobutton_eigenschaften_69 = manage(new class Gtk::RadioButton(_RadioBGroup_Eigenschaften_wuerfeln, "6 von 9"));
   ...
   Gtk::ScrolledWindow *scrolledwindow74 = manage(new class Gtk::ScrolledWindow());
   ...
   scrolledwindow74->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   scrolledwindow74->add(*viewport36);
   ...
   table108->attach(*scrolledwindow74, 1, 2, 0, 4, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table15->attach(*pixmap_Wald, 1, 2, 0, 1, 0, GTK_FILL, 0, 0);
