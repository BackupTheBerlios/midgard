// generated 2002/1/24 19:23:02 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table77 = manage(new class Gtk::Table(8, 6, false));
   frame_datenbank = manage(new class Gtk::Frame("Laden der Datenbank"));
   
   Gtk::Pixmap *pixmap90 = manage(new class Gtk::Pixmap(MAGUS_Logo_Text_halb_xpm));
   Gtk::Table *table49 = manage(new class Gtk::Table(6, 3, false));
   Gtk::Viewport *viewport33 = manage(new class Gtk::Viewport());
   Gtk::ScrolledWindow *scrolledwindow71 = manage(new class Gtk::ScrolledWindow());
   ...
   table109->attach(*pixmap1, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table109->attach(*label327, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table109->attach(*label328, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   table109->attach(*pixmap3, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table109->attach(*label331, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table109->attach(*label332, 2, 3, 1, 2, GTK_FILL, 0, 0, 0);
   table109->attach(*pixmap2, 0, 1, 2, 3, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table109->attach(*label329, 1, 2, 2, 3, GTK_FILL, 0, 0, 0);
   table109->attach(*label330, 2, 3, 2, 3, GTK_FILL, 0, 0, 0);
   table109->attach(*pixmap60, 0, 1, 3, 4, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table109->attach(*label407, 1, 2, 3, 4, GTK_FILL, 0, 0, 0);
   table109->attach(*label406, 2, 3, 3, 4, GTK_FILL, 0, 0, 0);
   table109->attach(*hseparator17, 0, 3, 5, 6, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table109->attach(*pixmap5, 0, 1, 6, 7, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table109->attach(*label335, 1, 2, 6, 7, GTK_FILL, 0, 0, 0);
   table109->attach(*label336, 2, 3, 6, 7, GTK_FILL, 0, 0, 0);
   table109->attach(*pixmap56, 0, 1, 7, 8, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table109->attach(*label399, 1, 2, 7, 8, GTK_FILL, 0, 0, 0);
   table109->attach(*label400, 2, 3, 7, 8, GTK_FILL, 0, 0, 0);
   table109->attach(*pixmap6, 0, 1, 8, 9, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table109->attach(*label337, 1, 2, 8, 9, GTK_FILL, 0, 0, 0);
   table109->attach(*label338, 2, 3, 8, 9, GTK_FILL, 0, 0, 0);
   table109->attach(*pixmap57, 0, 1, 9, 10, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table109->attach(*label401, 1, 3, 9, 10, GTK_FILL, 0, 0, 0);
   table109->attach(*label531, 0, 3, 4, 5, GTK_FILL, 0, 0, 0);
   ...
   table77->attach(*label424, 4, 5, 0, 1, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_ausnahmen, 5, 6, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   table77->attach(*progressbar_pflicht, 3, 4, 7, 8, GTK_FILL, 0, 0, 0);
   table77->attach(*label423, 2, 3, 7, 8, GTK_FILL, 0, 0, 0);
   table77->attach(*label419, 2, 3, 6, 7, GTK_FILL, 0, 0, 0);
   table77->attach(*label418, 2, 3, 5, 6, GTK_FILL, 0, 0, 0);
   table77->attach(*label420, 2, 3, 4, 5, GTK_FILL, 0, 0, 0);
   table77->attach(*label417, 2, 3, 3, 4, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_schrift, 3, 4, 6, 7, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_sprache, 3, 4, 5, 6, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_kido, 3, 4, 4, 5, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_zauberwerk, 3, 4, 3, 4, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_zauber, 3, 4, 2, 3, GTK_FILL, 0, 0, 0);
   table77->attach(*label416, 2, 3, 2, 3, GTK_FILL, 0, 0, 0);
   table77->attach(*label430, 2, 3, 1, 2, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_aliaswaffen, 3, 4, 1, 2, GTK_FILL, 0, 0, 0);
   table77->attach(*label422, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_waffen, 3, 4, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   table49->attach(*hseparator19, 0, 2, 3, 4, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table49->attach(*pixmap65, 0, 2, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*label340, 0, 2, 1, 2, 0, 0, 5, 5);
   table49->attach(*versionsnummer, 0, 2, 2, 3, 0, 0, 0, 0);
   table49->attach(*frame99, 0, 1, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*frame_regionen, 1, 2, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*toolbar_close, 2, 3, 0, 4, GTK_FILL, 0, 0, 0);
   table49->attach(*frame_datenbank, 0, 3, 5, 6, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*pixmap90, 2, 3, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
   viewport33->add(*table49);
   scrolledwindow71->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   scrolledwindow71->add(*viewport33);
   Midgard_Info->set_title("Midgard");
   Midgard_Info->set_default_size(800, 600);
   Midgard_Info->add(*scrolledwindow71);
   hseparator19->show();
   pixmap65->show();
   label340->show();
   versionsnummer->show();
