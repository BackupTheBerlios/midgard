...
\end{tabular}\hfill
\begin{tabular}{|c|c|}\hline
\makebox[0.6cm]{Sb}&\makebox[0.6cm]{{\sb}}\\\hline
\end{tabular}\hfill
\begin{tabular}{|c|c|}\hline
...
\end{tabular}\hfill
\begin{tabular}{|c|c|}\hline
\makebox[0.6cm]{GG}&\makebox[0.6cm]{{\gg}}\\\hline
\end{tabular}\hfill
\begin{tabular}{|c|c|}\hline
...
\multicolumn{5}{c}{\small Universelle Fertigkeiten}\\[0.5ex]
Balancieren&+8&         &Schlittenfahren&+3     \\
Beredsamkeit&+3&        &Schlösser öffnen&+0    \\
Beschatten&+3&          &Schwimmen&+3           \\
Betäuben&+6&            &Seilkunst&+4           \\
Fallen&+8&              &Springen&+8            \\
Fallen entdecken&+0&    &Spurenlesen&+0         \\
Fallen entschärfen&+0&  &Stehlen&+3             \\
Fallenstellen&+1&       &Tarnen&+1              \\
Fangen&+8&              &Tauchen&+9             \\
Geheimmech. öffnen&+1&  &Überleben&+6           \\
Geländelauf&+8&         &Verbergen&+4           \\
Horchen&+2&             &Verführen&+3           \\
Kanufahren&+3&          &Verhören&+3            \\
