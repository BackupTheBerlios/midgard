// generated 2002/4/29 11:28:00 CEST by christof@puck.petig-baender.de
// using glademm V0.6.4c_cvs
//
// DO NOT EDIT THIS FILE ! It was created using
// /home/christof/cvs/christof/glade--/src/glade-- midgard.glade
...
{  
   ...
   Gtk::Table *table132 = manage(new class Gtk::Table(1, 2, false));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Wizard beenden", "<Control><Shift>W"));
   ...
   midgard_CG->set_policy(false, true, true);
