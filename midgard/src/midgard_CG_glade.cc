// generated 2001/12/27 16:20:36 CET by thoma@Tiger.
...
{   
   ...
   toolbar_fert = manage(new class Gtk::Toolbar(GTK_ORIENTATION_HORIZONTAL, GTK_TOOLBAR_BOTH));
   button_fert_sort = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_fert->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Fertigkeiten\n"
   ...
   Gtk::Pixmap *pixmap75 = manage(new class Gtk::Pixmap(Reduzieren_trans_32_xpm));
   ...
   Gtk::Pixmap *pixmap76 = manage(new class Gtk::Pixmap(Verlernen_trans_32_xpm));
   ...
   Gtk::Pixmap *pixmap77 = manage(new class Gtk::Pixmap(Steigern_trans_32_xpm));
   ...
   alte_fert_tree = new class SimpleTree(6, 6);
   ...
   alte_waffen_tree = new class SimpleTree(6, 6);
   ...
   alte_schrift_tree = new class SimpleTree(7, 7);
   ...
   _tooltips.set_tip(*button_fert_sort, "Die gelernten Fertigkeiten werden in der aktuellen Reinfolge für den Ausdruck sortiert", "");
   toolbar_fert->set_usize(80, -1);
   toolbar_fert->set_space_size(10);
   toolbar_fert->set_tooltips(true);
   ...
   table99->attach(*toolbar_fert, 7, 8, 0, 1, 0, 0, 0, 0);
   ...
   table15->attach(*vpaned1, 0, 4, 0, 1, 0, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   table18->attach(*hpaned2, 0, 3, 0, 1, GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
