// generated 2002/4/12 8:49:52 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::Table *table129 = manage(new class Gtk::Table(4, 1, false));
   ...
   table129->attach(*button_close_wizard, 0, 1, 3, 4, GTK_FILL, 0, 0, 0);
   table129->attach(*togglebutton_wizard_start, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
