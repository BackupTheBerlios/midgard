// generated 2002/4/16 10:04:21 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::Pixmap *pixmap146 = manage(new class Gtk::Pixmap(Descr_Char_40_xpm));
   ...
   eventbox_optionen->add(*pixmap152);
