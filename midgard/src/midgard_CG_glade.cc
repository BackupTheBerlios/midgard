...
{  midgard_CG = this;
   ...
   label_notebook_grundwerte->set_width_chars(-1);
   ...
   label_notebook_lernen->set_width_chars(-1);
   ...
   label_notebook_steigern->set_width_chars(-1);
   ...
   label_notebook_beschreibung->set_width_chars(-1);
   ...
   label_notebook_ausruestung->set_width_chars(-1);
   ...
   label_notebook_optionen->set_width_chars(-1);
   ...
   label_notebook_info->set_width_chars(-1);
   ...
   label_notebook_news->set_width_chars(-1);
   ...
   label_status->set_width_chars(-1);
   ...
   label_wizard->set_width_chars(-1);
