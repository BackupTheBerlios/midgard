...
{  table_steigern = this;
   ...
   alte_fert_tree = new class MidgardBasicTree(MidgardBasicTree::FERT_ALT);
   
   Gtk::ScrolledWindow *scrolledwindow_fert_alt = Gtk::manage(new class Gtk::ScrolledWindow());
   neue_fert_tree = new class MidgardBasicTree(MidgardBasicTree::FERT_NEU);
   ...
   neue_waffen_tree = new class MidgardBasicTree(MidgardBasicTree::WAFFE_NEU);
   ...
   Gtk::EventBox *eventbox26 = Gtk::manage(new class Gtk::EventBox());
   Gtk::Table *table76 = Gtk::manage(new class Gtk::Table(2, 2, false));
   Gtk::Label *label697 = Gtk::manage(new class Gtk::Label("Mensch Hl Gr.8 30J 20Tage"));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_1 = Gtk::manage(new class Gtk::Expander());
#else //
   ...
   Gtk::Adjustment *vscale_EP_Gold_adj = Gtk::manage(new class Gtk::Adjustment(49.4, 33, 68, 1, 1, 1));
   ...
   button_sonder = new class ChoiceButton();
   button_EP = new class ChoiceButton();
   button_GFP = new class ChoiceButton();
   button_gold = new class ChoiceButton();
   
   Gtk::Table *table72 = Gtk::manage(new class Gtk::Table(2, 2, false));
   Gtk::Label *label699 = Gtk::manage(new class Gtk::Label("1000GFP 50%GS"));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_2 = Gtk::manage(new class Gtk::Expander());
#else //
   ...
   Gtk::Label *label700 = Gtk::manage(new class Gtk::Label("neuer Grad erreicht"));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_4 = Gtk::manage(new class Gtk::Expander());
#else //
   ...
   Gtk::Label *label534 = Gtk::manage(new class Gtk::Label("Alle Zauber\n"
		"anzeigen"));
   Gtk::VBox *hbox49 = Gtk::manage(new class Gtk::VBox(false, 0));
   ...
   Gtk::Label *label516 = Gtk::manage(new class Gtk::Label("spezielle\n"
		"Praxispunkte\n"
		"eingeben"));
   Gtk::HBox *hbox40 = Gtk::manage(new class Gtk::HBox(false, 0));
   togglebutton_praxispunkte = Gtk::manage(new class Gtk::ToggleButton());
   
   Gtk::RadioButton::Group _RadioBGroup_radiobutton_pp_abwehr;
   radiobutton_pp_abwehr = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_pp_abwehr, "Abwehr"));
   radiobutton_pp_zauber = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_pp_abwehr, "Zaubern"));
   radiobutton_pp_spezial = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_pp_abwehr));
   radiobutton_pp_resistenz = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_pp_abwehr, "Resistenz"));
   ...
   Gtk::Label *label698 = Gtk::manage(new class Gtk::Label("Steigern Praxis"));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_3 = Gtk::manage(new class Gtk::Expander());
#else //
   ...
   label_ns_fertigkeiten->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_ns_fertigkeiten->set_width_chars(-1);
   ...
   label530->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label530->set_width_chars(-1);
   ...
   label529->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label529->set_width_chars(-1);
   ...
   label_nw_waffen->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_nw_waffen->set_width_chars(-1);
   ...
   label379->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label379->set_width_chars(-1);
   ...
   label380->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label380->set_width_chars(-1);
   ...
   label_ns_zauber->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_ns_zauber->set_width_chars(-1);
   ...
   label_ns_kido->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_ns_kido->set_width_chars(-1);
   vbox24->pack_start(*label_ns_kido, Gtk::PACK_SHRINK, 0);
   vbox24->pack_start(*pixmap_ns_kido);
   label282->set_justify(Gtk::JUSTIFY_CENTER);
   label282->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label282->set_width_chars(-1);
   ...
   label281->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label281->set_width_chars(-1);
   ...
   label_ns_sprache->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_ns_sprache->set_width_chars(-1);
   vbox25->pack_start(*label_ns_sprache, Gtk::PACK_SHRINK, 0);
   vbox25->pack_start(*pixmap_ns_sprache, Gtk::PACK_SHRINK, 0);
   label_ruestung_1->set_justify(Gtk::JUSTIFY_CENTER);
   label_ruestung_1->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_ruestung_1->set_width_chars(-1);
   ...
   label_ruestung_2->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_ruestung_2->set_width_chars(-1);
   ...
   label671->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label671->set_width_chars(-1);
   ...
   label593->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label593->set_width_chars(-1);
   ...
   label_av_bonus->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_av_bonus->set_width_chars(-1);
   label_sl_bonus->set_alignment(0,0.5);
   label_sl_bonus->set_justify(Gtk::JUSTIFY_CENTER);
   label_sl_bonus->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_sl_bonus->set_width_chars(-1);
   label596->set_alignment(0,0.5);
   label596->set_justify(Gtk::JUSTIFY_CENTER);
   label596->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label596->set_width_chars(-1);
   ...
   label672->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label672->set_width_chars(-1);
   ...
   label_ns_besitz->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_ns_besitz->set_width_chars(-1);
   vbox58->pack_start(*label_ns_besitz, Gtk::PACK_SHRINK, 0);
   vbox58->pack_start(*pixmap_ns_besitz, Gtk::PACK_SHRINK, 0);
   notebook_lernen->set_flags(Gtk::CAN_FOCUS);
   notebook_lernen->set_show_border(false);
   notebook_lernen->set_tab_pos(Gtk::POS_LEFT);
   notebook_lernen->set_scrollable(true);
   notebook_lernen->append_page(*table15, *vbox21);
   notebook_lernen->pages().back().set_tab_label_packing(false, false, Gtk::PACK_START);
   ...
   label_s_grad->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_s_grad->set_width_chars(-1);
   label646->set_justify(Gtk::JUSTIFY_LEFT);
   label646->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label646->set_width_chars(-1);
   ...
   label_s_resistenz->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_s_resistenz->set_width_chars(-1);
   label647->set_justify(Gtk::JUSTIFY_LEFT);
   label647->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label647->set_width_chars(-1);
   ...
   label_s_zaubern->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_s_zaubern->set_width_chars(-1);
   label648->set_justify(Gtk::JUSTIFY_LEFT);
   label648->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label648->set_width_chars(-1);
   ...
   label_s_abwehr->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_s_abwehr->set_width_chars(-1);
   ...
   label_alter->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_alter->set_width_chars(-1);
   ...
   label_s_ap->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_s_ap->set_width_chars(-1);
   ...
   label_steigertage->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_steigertage->set_width_chars(-1);
   label652->set_justify(Gtk::JUSTIFY_LEFT);
   label652->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label652->set_width_chars(-1);
   ...
   steigern_typ->set_ellipsize(Pango::ELLIPSIZE_NONE);
   steigern_typ->set_width_chars(-1);
   label653->set_justify(Gtk::JUSTIFY_LEFT);
   label653->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label653->set_width_chars(-1);
   ...
   label_steigern_spezies->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_steigern_spezies->set_width_chars(-1);
   label654->set_justify(Gtk::JUSTIFY_LEFT);
   label654->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label654->set_width_chars(-1);
   ...
   label_pp_abwehr->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_pp_abwehr->set_width_chars(-1);
   label656->set_justify(Gtk::JUSTIFY_LEFT);
   label656->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label656->set_width_chars(-1);
   ...
   label_pp_zaubern->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_pp_zaubern->set_width_chars(-1);
   label657->set_justify(Gtk::JUSTIFY_LEFT);
   label657->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label657->set_width_chars(-1);
   ...
   label_pp_resistenz->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_pp_resistenz->set_width_chars(-1);
   label658->set_justify(Gtk::JUSTIFY_LEFT);
   label658->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label658->set_width_chars(-1);
   ...
   label_pp_spezial->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_pp_spezial->set_width_chars(-1);
   label659->set_justify(Gtk::JUSTIFY_LEFT);
   label659->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label659->set_width_chars(-1);
   ...
   label655->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label655->set_width_chars(-1);
   ...
   eventbox26->set_events(Gdk::BUTTON_PRESS_MASK);
   eventbox26->add(*frame85);
   ...
   table76->attach(*eventbox26, 1, 4, 2, 3, Gtk::FILL, Gtk::FILL, 0, 0);
   label697->set_flags(Gtk::CAN_FOCUS);
   label697->set_justify(Gtk::JUSTIFY_LEFT);
   label697->set_selectable(true);
   label697->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label697->set_width_chars(-1);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_1->set_expanded(true);
   handlebox_steigern_1->set_spacing(0);
#endif //
   handlebox_steigern_1->add(*table76);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_1->set_label_widget(*label697);
#endif //
   label660->set_justify(Gtk::JUSTIFY_LEFT);
   label660->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label660->set_width_chars(-1);
   ...
   label661->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label661->set_width_chars(-1);
   ...
   label662->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label662->set_width_chars(-1);
   ...
   label663->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label663->set_width_chars(-1);
   ...
   label664->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label664->set_width_chars(-1);
   ...
   label665->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label665->set_width_chars(-1);
   ...
   label666->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label666->set_width_chars(-1);
   ...
   label_EP->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_EP->set_width_chars(-1);
   label_Gold->set_alignment(0,0.5);
   label_Gold->set_justify(Gtk::JUSTIFY_CENTER);
   label_Gold->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_Gold->set_width_chars(-1);
   vscale_EP_Gold->set_flags(Gtk::CAN_FOCUS);
   vscale_EP_Gold->set_update_policy(Gtk::UPDATE_CONTINUOUS);
   vscale_EP_Gold->set_inverted(false);
   ...
   button_sonder->set_flags(Gtk::CAN_FOCUS);
   button_EP->set_flags(Gtk::CAN_FOCUS);
   button_GFP->set_flags(Gtk::CAN_FOCUS);
   button_gold->set_flags(Gtk::CAN_FOCUS);
   ...
   table72->attach(*button_sonder, 1, 2, 1, 2, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK|Gtk::FILL, 0, 0);
   table72->attach(*button_EP, 4, 5, 0, 1, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK|Gtk::FILL, 0, 0);
   table72->attach(*button_GFP, 4, 5, 1, 2, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK|Gtk::FILL, 0, 0);
   table72->attach(*button_gold, 4, 5, 2, 3, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK|Gtk::FILL, 0, 0);
   label699->set_justify(Gtk::JUSTIFY_LEFT);
   label699->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label699->set_width_chars(-1);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_2->set_spacing(0);
#endif //
   handlebox_steigern_2->add(*table72);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_2->set_label_widget(*label699);
#endif //
   label546->set_justify(Gtk::JUSTIFY_CENTER);
   label546->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label546->set_width_chars(-1);
   label_grad_GFP->set_justify(Gtk::JUSTIFY_CENTER);
   label_grad_GFP->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_grad_GFP->set_width_chars(-1);
   ...
   label547->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label547->set_width_chars(-1);
   label_ausdauer_GFP->set_justify(Gtk::JUSTIFY_CENTER);
   label_ausdauer_GFP->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_ausdauer_GFP->set_width_chars(-1);
   ...
   label548->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label548->set_width_chars(-1);
   label_abwehr_GFP->set_justify(Gtk::JUSTIFY_CENTER);
   label_abwehr_GFP->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_abwehr_GFP->set_width_chars(-1);
   ...
   label549->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label549->set_width_chars(-1);
   label_zauber_GFP->set_justify(Gtk::JUSTIFY_CENTER);
   label_zauber_GFP->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_zauber_GFP->set_width_chars(-1);
   ...
   _tooltips.set_tip(*button_grad_zaubern, "Zaubern steigern", "");
   button_grad_zaubern->set_relief(Gtk::RELIEF_NORMAL);
   button_grad_zaubern->add(*vbox41);
   label552->set_justify(Gtk::JUSTIFY_CENTER);
   label552->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label552->set_width_chars(-1);
   ...
   label550->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label550->set_width_chars(-1);
   label_resistenz_GFP->set_justify(Gtk::JUSTIFY_CENTER);
   label_resistenz_GFP->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_resistenz_GFP->set_width_chars(-1);
   ...
   label551->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label551->set_width_chars(-1);
   ...
   _tooltips.set_tip(*button_grad_basiswerte, "Würfeln/Eingeben ob sich die Basiswerte beim Gradanstieg erhöhen. Zusätzlich wird die Schicksalsgunst erhöht.", "");
   ...
   label700->set_justify(Gtk::JUSTIFY_LEFT);
   label700->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label700->set_width_chars(-1);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_4->set_spacing(0);
#endif //
   handlebox_steigern_4->add(*table75);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_4->set_label_widget(*label700);
#endif //
   label534->set_justify(Gtk::JUSTIFY_CENTER);
   label534->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label534->set_width_chars(-1);
   ...
   label533->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label533->set_width_chars(-1);
   ...
   table102->pack_start(*togglebutton_alle_zauber);
   table102->pack_start(*togglebutton_zaubersalze);
   label668->set_justify(Gtk::JUSTIFY_LEFT);
   label668->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label668->set_width_chars(-1);
   ...
   button_wie_tun->set_flags(Gtk::CAN_FOCUS);
   table101->set_row_spacings(0);
   table101->set_col_spacings(0);
   table101->attach(*button_wie_tun, 0, 1, 0, 1, Gtk::EXPAND|Gtk::FILL, Gtk::EXPAND|Gtk::FILL, 0, 0);
   label667->set_justify(Gtk::JUSTIFY_LEFT);
   label667->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label667->set_width_chars(-1);
   ...
   button_was_tun->set_flags(Gtk::CAN_FOCUS);
   table100->set_border_width(3);
   table100->set_row_spacings(0);
   table100->set_col_spacings(0);
   table100->attach(*button_was_tun, 0, 1, 0, 1, Gtk::FILL, Gtk::EXPAND|Gtk::FILL, 0, 0);
   label669->set_justify(Gtk::JUSTIFY_LEFT);
   label669->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label669->set_width_chars(-1);
   ...
   label516->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label516->set_width_chars(-1);
   hbox40->pack_start(*pixmap78);
   hbox40->pack_start(*label516, Gtk::PACK_SHRINK, 0);
   togglebutton_praxispunkte->set_flags(Gtk::CAN_FOCUS);
   _tooltips.set_tip(*togglebutton_praxispunkte, "Praxispunkte für Abwehr, Resistenz etc. eingeben", "");
   ...
   label670->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label670->set_width_chars(-1);
   ...
   label698->set_justify(Gtk::JUSTIFY_LEFT);
   label698->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label698->set_width_chars(-1);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_3->set_expanded(true);
   handlebox_steigern_3->set_spacing(0);
#endif //
   handlebox_steigern_3->add(*table99);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   handlebox_steigern_3->set_label_widget(*label698);
#endif //
   ...
   table_steigern->attach(*scrolledwindow_landauswahl, 1, 2, 0, 1, Gtk::EXPAND|Gtk::SHRINK|Gtk::FILL, Gtk::FILL, 0, 0);
   table_steigern->attach(*notebook_lernen, 0, 2, 2, 3, Gtk::EXPAND|Gtk::SHRINK|Gtk::FILL, Gtk::EXPAND|Gtk::SHRINK|Gtk::FILL, 0, 0);
   table_steigern->attach(*table_handlebox1, 0, 1, 0, 1, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK, 0, 0);
   ...
   alte_fert_tree->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_fert2));
   ...
   neue_fert_tree->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_neue_fert_clicked));
   ...
   alte_waffen_tree->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_alte_waffen_clicked));
   neue_waffen_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_waffen));
   neue_waffen_tree->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_neue_waffen_clicked));
   alte_grund_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_grund));
   alte_grund_tree->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_alte_grund_clicked));
   neue_grund_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_grund));
   neue_grund_tree->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_neue_grund_clicked));
   ...
   alte_sprache_tree->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_alte_sprache_clicked));
   neue_sprache_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_sprache));
   neue_sprache_tree->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_neue_sprache_clicked));
   alte_schrift_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_alte_schrift));
   alte_schrift_tree->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_alte_schrift_clicked));
   neue_schrift_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_selected_neue_schrift));
   neue_schrift_tree->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_neue_schrift_clicked));
   button_ruestung_1->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_button_ruestung_1_toggled), false);
   button_ruestung_2->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_button_ruestung_2_toggled), false);
   checkbutton_mag_waffenbonus->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_checkbutton_mag_waffenbonus_toggled), false);
   ...
   spinbutton_av_bonus->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_spinbutton_av_bonus_activate), true);
   spinbutton_sl_bonus->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_spinbutton_sl_bonus_activate), true);
   entry_magisch->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_entry_magisch_activate), false);
   waffenbesitz_neu_tree->signal_leaf_selected().connect(SigC::slot(*this, &table_steigern_glade::on_leaf_waffenbesitz_selected_neu));
   notebook_lernen->signal_switch_page().connect(SigC::slot(*this, &table_steigern_glade::on_notebook_lernen_switch_page), true);
   button_alter->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_button_alter_clicked), false);
   eventbox26->signal_button_press_event().connect(SigC::slot(*this, &table_steigern_glade::pp_eingeben_click), false);
   ...
   vscale_EP_Gold->signal_button_release_event().connect(SigC::slot(*this, &table_steigern_glade::vscale_value_changed), false);
   button_sonder->signal_changed().connect(SigC::slot(*this, &table_steigern_glade::button_sonder_changed));
   button_grad->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_button_grad_clicked), false);
   button_grad_ausdauer->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_button_grad_ausdauer_clicked), false);
   button_grad_abwehr->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_button_grad_abwehr_clicked), false);
   button_grad_zaubern->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_button_grad_zaubern_clicked), false);
   grad_anstieg->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_grad_anstieg_clicked), false);
   button_grad_resistenz->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_button_grad_resistenz_clicked), false);
   spinbutton_eigenschaften_grad_anstieg->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_spinbutton_eigenschaften_grad_anstieg_activate), true);
   button_grad_basiswerte->signal_clicked().connect(SigC::slot(*this, &table_steigern_glade::on_button_grad_basiswerte), false);
   togglebutton_alle_zauber->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_togglebutton_alle_zauber_toggled), false);
   togglebutton_zaubersalze->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_togglebutton_zaubersalze_toggled), false);
   button_wie_tun->signal_changed().connect(SigC::slot(*this, &table_steigern_glade::button_wie_tun_changed));
   button_was_tun->signal_changed().connect(SigC::slot(*this, &table_steigern_glade::button_was_tun_changed));
   spinbutton_pp_eingeben->signal_activate().connect(SigC::slot(*this, &table_steigern_glade::on_spinbutton_pp_eingeben_activate), true);
   togglebutton_praxispunkte->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_togglebutton_praxispunkte_toggled), false);
   radiobutton_pp_abwehr->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radiobutton_pp_abwehr_toggled), false);
   radiobutton_pp_zauber->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radiobutton_pp_zauber_toggled), false);
   radiobutton_pp_spezial->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radiobutton_pp_spezial_toggled), false);
   radiobutton_pp_resistenz->signal_toggled().connect(SigC::slot(*this, &table_steigern_glade::on_radiobutton_pp_resistenz_toggled), false);
}
...
{  delete tree_steigern_zusatz;
   ...
   delete button_sonder;
   delete button_EP;
   delete button_GFP;
   delete button_gold;
   delete flashing_gradanstieg;
   delete flashing_eigenschaft;
   delete button_wie_tun;
   delete button_was_tun;
}
