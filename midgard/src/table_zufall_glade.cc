...
{  table_zufall = this;
   ...
   Gtk::Table *table172 = manage(new class Gtk::Table(9, 8, false));
   ...
   table172->attach(*frame_verteilung_auf, 1, 7, 6, 7, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table172->attach(*frame_spezialist_typen, 1, 7, 7, 8, GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table172->attach(*frame116, 0, 1, 6, 8, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
