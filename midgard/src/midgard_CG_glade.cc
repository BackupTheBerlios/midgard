// generated 2001/6/20 17:25:16 CEST by thoma@Tiger.
...
{   
   ...
   Gtk::ScrolledWindow *scrolledwindow54 = manage(new class Gtk::ScrolledWindow());
   ...
   Gtk::Button *WidgetJJKnHHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   scrolledwindow28->add(*scrolledwindow53);
   viewport2->add(*neue_fert_tree);
   scrolledwindow54->set_policy(GTK_POLICY_ALWAYS, GTK_POLICY_ALWAYS);
   scrolledwindow54->add(*viewport2);
   scrolledwindow29->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   scrolledwindow29->add(*scrolledwindow54);
   ...
   WidgetJJKnHHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
