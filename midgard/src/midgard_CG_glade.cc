...
{  midgard_CG = this;
   ...
   grundwerte_background->property_visible_window().set_value(true);
   grundwerte_background->property_above_child().set_value(false);
   ...
   eventbox_grundwerte->property_above_child().set_value(false);
   ...
   eventbox_lernen->property_above_child().set_value(false);
   ...
   eventbox_steigern->property_above_child().set_value(false);
   ...
   eventbox_beschreibung->property_above_child().set_value(false);
   ...
   eventbox_ausruestung->property_above_child().set_value(false);
   ...
   eventbox_optionen->property_above_child().set_value(false);
   ...
   eventbox_credits->property_above_child().set_value(false);
   ...
   eventbox_geschichte->property_above_child().set_value(false);
   ...
   eventbox_zufall->property_above_child().set_value(false);
   ...
   eventbox_Original_Midgard->property_visible_window().set_value(true);
   eventbox_Original_Midgard->property_above_child().set_value(false);
   ...
   eventbox_NSC_aktiv->property_visible_window().set_value(true);
   eventbox_NSC_aktiv->property_above_child().set_value(false);
   ...
   eventbox_wizard_aktiv->property_visible_window().set_value(true);
   eventbox_wizard_aktiv->property_above_child().set_value(false);
