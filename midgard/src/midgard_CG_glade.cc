// generated 2002/1/14 11:30:16 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Adjustment *spinbutton_alter_adj = manage(new class Gtk::Adjustment(1, 0, 10000, 1, 10, 10));
   ...
   Gtk::Adjustment *spinbutton_groesse_adj = manage(new class Gtk::Adjustment(1, 0, 10000, 1, 10, 10));
   ...
   Gtk::Adjustment *spinbutton_Cgewicht_adj = manage(new class Gtk::Adjustment(1, 0, 50000, 1, 10, 10));
   ...
   Gtk::Adjustment *spinbutton_ap_adj = manage(new class Gtk::Adjustment(1, 0, 100, 1, 10, 10));
   spinbutton_ap = manage(new class Gtk::SpinButton(*spinbutton_ap_adj, 1, 0));
   
   Gtk::Frame *frame11 = manage(new class Gtk::Frame("AP"));
   Gtk::Adjustment *spinbutton_lp_adj = manage(new class Gtk::Adjustment(1, 0, 100, 1, 10, 10));
   ...
   Gtk::Table *table67 = manage(new class Gtk::Table(4, 4, false));
   ...
   Gtk::Pixmap *pixmap90 = manage(new class Gtk::Pixmap(Gross_dfr4_xpm));
   ...
   button_lernpunkte_edit = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar3->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Lernpunkte\n"
   ...
   Gtk::Pixmap *pixmap94 = manage(new class Gtk::Pixmap(Gross_dfr3_xpm));
   ...
   Gtk::Pixmap *pixmap93 = manage(new class Gtk::Pixmap(Gross_Wald_xpm));
   ...
   Gtk::Pixmap *pixmap92 = manage(new class Gtk::Pixmap(Gross_kurai_xpm));
   ...
   table67->attach(*frame92, 2, 3, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table1->attach(*pixmap90, 4, 5, 0, 6, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table4->attach(*pixmap94, 3, 4, 0, 5, 0, 0, 0, 0);
   ...
   table15->attach(*pixmap93, 2, 3, 0, 1, 0, GTK_FILL, 0, 0);
   ...
   table_kido_steigern->attach(*pixmap92, 1, 2, 0, 1, 0, 0, 0, 0);
   ...
   button_lernpunkte_edit->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_lernpunkte_editieren_clicked));
