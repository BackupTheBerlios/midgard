// generated 2003/1/30 23:16:42 CET by christof@puck.petig-baender.de
...
{  midgard_CG = this;
   ...
   Gtk::Button *button_neuer_charakter = Gtk::manage(new class Gtk::Button("Neu"));
   Gtk::EventBox *eventbox30 = Gtk::manage(new class Gtk::EventBox());
   Gtk::Button *button9 = Gtk::manage(new class Gtk::Button("Öffnen"));
   Gtk::EventBox *eventbox27 = Gtk::manage(new class Gtk::EventBox());
   Gtk::Button *button8 = Gtk::manage(new class Gtk::Button("Speichern"));
   Gtk::EventBox *eventbox28 = Gtk::manage(new class Gtk::EventBox());
   button_main_drucken = Gtk::manage(new class Gtk::Button("Drucken"));
   
   Gtk::EventBox *eventbox29 = Gtk::manage(new class Gtk::EventBox());
   ...
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*eventbox30));
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*eventbox27));
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*eventbox28));
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*eventbox29));
   ...
   eventbox29->add(*button_main_drucken);
