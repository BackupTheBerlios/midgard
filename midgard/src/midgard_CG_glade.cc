// generated 2001/4/4 8:09:30 CEST by thoma@ig23.
...
#include "../pixmaps/EditChar-trans.xpm"
...
{   
   ...
   Gtk::Button *button15 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar2->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Werte\n"
		"editieren", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(EditChar_trans_xpm))->gtkobj()), 0, 0));
   ...
   clist_kido = manage(new class Gtk::CList(2));
   ...
   Gtk::Label *label347 = manage(new class Gtk::Label("KiDo"));
   ...
   Gtk::Pixmap *pixmap44 = manage(new class Gtk::Pixmap(Select_trans_50_xpm));
   ...
   Gtk::Pixmap *pixmap43 = manage(new class Gtk::Pixmap(Select_trans_50_xpm));
   ...
   Gtk::Pixmap *pixmap42 = manage(new class Gtk::Pixmap(Select_trans_50_xpm));
   ...
   Gtk::Button *WidgetWmyVGHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, 0, 0, 0));
   ...
   steigern_kido_clist_alt = manage(new class Gtk::CList(4));
   
   Gtk::ScrolledWindow *scrolledwindow49 = manage(new class Gtk::ScrolledWindow());
   steigern_kido_clist_neu = manage(new class Gtk::CList(4));
   ...
   Gtk::Label *label361 = manage(new class Gtk::Label("KiDo"));
   ...
   clist_kido->set_column_title(0, "HoHo\n"
		"(Technik)");
   clist_kido->set_column_justification(0, GTK_JUSTIFY_CENTER);
   clist_kido->set_column_width(0, 80);
   clist_kido->set_column_title(1, "Stil");
   clist_kido->set_column_justification(1, GTK_JUSTIFY_CENTER);
   ...
   label347->set_alignment(0.5, 0.5);
   label347->set_padding(0, 0);
   ...
   notebook3->pages().push_back(Gtk::Notebook_Helpers::TabElem(*table_kido_lernen, *label347));
   ...
   table56->attach(*radiobutton_praxis_wuerfeln_waffen, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   table50->attach(*radio_spruchrolle_auto, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   table44->attach(*frame60, 1, 2, 0, 1, 0, GTK_FILL, 23, 0);
   ...
   table_magier_steigern->attach(*vpaned2, 0, 1, 1, 2, 0, GTK_FILL, 0, 0);
   ...
   table60->attach(*toolbar34, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   frame62->add(*table59);
   steigern_kido_clist_alt->set_usize(250, -1);
   ...
   steigern_kido_clist_alt->set_column_justification(1, GTK_JUSTIFY_RIGHT);
   steigern_kido_clist_alt->set_column_width(1, 80);
   steigern_kido_clist_alt->set_column_title(2, "Kosten");
   steigern_kido_clist_alt->set_column_justification(2, GTK_JUSTIFY_CENTER);
   steigern_kido_clist_alt->set_column_width(2, 80);
   steigern_kido_clist_alt->set_column_title(3, "Stil");
   steigern_kido_clist_alt->set_column_justification(3, GTK_JUSTIFY_CENTER);
   ...
   steigern_kido_clist_neu->set_usize(250, -1);
   steigern_kido_clist_neu->set_column_title(0, "HoHo");
   steigern_kido_clist_neu->set_column_justification(0, GTK_JUSTIFY_CENTER);
   ...
   steigern_kido_clist_neu->set_column_title(2, "Kosten");
   steigern_kido_clist_neu->set_column_justification(2, GTK_JUSTIFY_RIGHT);
   steigern_kido_clist_neu->set_column_width(2, 80);
   steigern_kido_clist_neu->set_column_title(3, "Stil");
   ...
   label361->set_alignment(0.5, 0.5);
   label361->set_padding(0, 0);
   ...
   notebook2->pages().push_back(Gtk::Notebook_Helpers::TabElem(*table_kido_steigern, *label361));
   ...
   WidgetWmyVGHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
