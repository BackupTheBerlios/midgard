...
protected:
	   ...
	   {   SPEZIAL, 
        ...
        class Gtk::Table *table_zauber_lernschema;
        class Gtk::Button *button71;
        class Gtk::Button *button72;
        class Gtk::Label *label_spezialwaffe;
        class Gtk::Table *table_lernschema_buttons;
