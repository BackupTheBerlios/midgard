// generated 2002/5/25 9:19:00 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   table157->attach(*scrolledwindow_landauswahl, 2, 3, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table_steigern->attach(*handlebox6, 0, 2, 1, 2, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
