// generated 2001/12/18 10:55:41 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Label *label_anzahl_Ex = manage(new class Gtk::Label(" Einhandwaffen"));
   Gtk::Label *label_anzahl_Ax = manage(new class Gtk::Label(" beliebige Waffen"));
   ...
   table40->attach(*toolbar40, 3, 4, 0, 1, GTK_FILL, 0, 0, 5);
