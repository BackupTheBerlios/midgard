// generated 2002/1/18 19:52:08 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Label *label438 = manage(new class Gtk::Label("Illustrationen von Werner Öckl\n"
   ...
   Gtk::Label *label531 = manage(new class Gtk::Label("Beim Abtippen der Daten haben Nils Richter,\n"
		"Sebastian Horstmann, Joachim Jordan und viele\n"
		"andere geholfen."));
   ...
   Gtk::Table *table77 = manage(new class Gtk::Table(23, 3, false));
   ...
   Gtk::Table *table49 = manage(new class Gtk::Table(18, 5, false));
   ...
   table77->attach(*label416, 0, 1, 10, 11, GTK_FILL, 0, 0, 0);
   table77->attach(*label417, 0, 1, 11, 12, GTK_FILL, 0, 0, 0);
   table77->attach(*label419, 0, 1, 14, 15, GTK_FILL, 0, 0, 0);
   table77->attach(*label418, 0, 1, 13, 14, GTK_FILL, 0, 0, 0);
   table77->attach(*label420, 0, 1, 12, 13, GTK_FILL, 0, 0, 0);
   ...
   table77->attach(*progressbar_zauber, 1, 2, 10, 11, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_sprache, 1, 2, 13, 14, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_zauberwerk, 1, 2, 11, 12, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_kido, 1, 2, 12, 13, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_schrift, 1, 2, 14, 15, GTK_FILL, 0, 0, 0);
   table77->attach(*label421, 0, 1, 7, 8, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_grundkenntnisse, 1, 2, 7, 8, GTK_FILL, 0, 0, 0);
   table77->attach(*label422, 0, 1, 8, 9, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_waffen, 1, 2, 8, 9, GTK_FILL, 0, 0, 0);
   table77->attach(*label423, 0, 1, 15, 16, GTK_FILL, 0, 0, 0);
   table77->attach(*label424, 0, 1, 16, 17, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_pflicht, 1, 2, 15, 16, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_ausnahmen, 1, 2, 16, 17, GTK_FILL, 0, 0, 0);
   table77->attach(*label425, 0, 1, 17, 18, GTK_FILL, 0, 0, 0);
   table77->attach(*label426, 0, 1, 18, 19, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_spezies, 1, 2, 17, 18, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_typen, 1, 2, 18, 19, GTK_FILL, 0, 0, 0);
   table77->attach(*label427, 0, 1, 19, 20, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_grad, 1, 2, 19, 20, GTK_FILL, 0, 0, 0);
   table77->attach(*label428, 0, 1, 20, 21, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_spezial, 1, 2, 20, 21, GTK_FILL, 0, 0, 0);
   table77->attach(*label430, 0, 1, 9, 10, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_aliaswaffen, 1, 2, 9, 10, GTK_FILL, 0, 0, 0);
   ...
   table77->attach(*label436, 0, 1, 22, 23, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_preise, 1, 2, 22, 23, GTK_FILL, 0, 0, 0);
   ...
   table49->attach(*toolbar_close, 2, 3, 17, 18, 0, 0, 0, 0);
   table49->attach(*label400, 2, 3, 11, 12, GTK_FILL, 0, 0, 0);
   table49->attach(*pixmap56, 0, 1, 11, 12, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*label399, 1, 2, 11, 12, GTK_FILL, 0, 5, 0);
   table49->attach(*label406, 2, 3, 7, 8, GTK_FILL, 0, 0, 0);
   table49->attach(*label407, 1, 2, 7, 8, GTK_FILL, 0, 0, 0);
   table49->attach(*pixmap60, 0, 1, 7, 8, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*pixmap65, 0, 3, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*pixmap61, 4, 5, 0, 4, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table49->attach(*pixmap57, 0, 1, 14, 15, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*pixmap7, 0, 1, 15, 16, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*label401, 1, 3, 14, 15, GTK_FILL, 0, 0, 0);
   table49->attach(*label339, 1, 3, 15, 16, GTK_FILL, 0, 0, 0);
   table49->attach(*label438, 1, 3, 16, 17, GTK_FILL, 0, 0, 0);
   table49->attach(*pixmap66, 0, 1, 16, 17, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*label531, 0, 3, 8, 9, GTK_FILL, 0, 0, 0);
   table49->attach(*frame_datenbank, 4, 5, 4, 17, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*vseparator18, 3, 4, 0, 17, GTK_EXPAND, GTK_FILL, 0, 0);
