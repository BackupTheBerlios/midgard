// generated 2002/1/5 11:55:01 CET by thoma@Tiger.
...
{   
   ...
   clist_herkunftsland->set_column_title(0, "Land");
   clist_herkunftsland->set_column_width(0, 80);
   clist_herkunftsland->set_column_title(1, "Kontinent");
   ...
   Window_herkunft->set_modal(true);
