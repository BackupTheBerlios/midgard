// generated 2001/8/12 21:31:34 CEST by thoma@Tiger.
...
{   
   ...
   Gtk::Button *WidgetqvJwGHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table27->attach(*label207, 0, 1, 3, 4, GTK_FILL, 0, 10, 0);
   ...
   table27->attach(*label208, 3, 4, 3, 4, GTK_FILL, 0, 10, 0);
   ...
   WidgetqvJwGHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
