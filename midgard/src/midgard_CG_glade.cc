// generated 2002/1/11 11:17:19 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table46 = manage(new class Gtk::Table(1, 1, false));
   ...
   scrolledwindow64->set_usize(170, -1);
   ...
   table93->attach(*scrolledwindow64, 0, 1, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
