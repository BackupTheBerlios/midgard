// generated 2001/8/23 21:20:55 CEST by thoma@Tiger.
...
{   
   ...
   Gtk::Button *WidgetqYKwHHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *button_sprache_sort = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar9->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Sprachen \n"
		"sortieren", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Sort_Lang_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Adjustment *vscale_EP_Gold_adj = manage(new class Gtk::Adjustment(50, 33, 67, 1, 1, 1));
   ...
   Gtk::Button *button_grad_ausdauer = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar38->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Ausdauer\n"
		"würfeln", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Dice_2W6_trans_50_xpm))->gtkobj()), 0, 0));
   Gtk::Button *button_grad_azr = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar38->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Abw., Zau.\n"
		"und Res.", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Steigern_trans_32_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *grad_anstieg = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar17->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Grad, Ausdauer, Abwehr, Zaubern, Resistenz  \n"
		"an Grad anpassen", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Anpass_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   eventbox_MCG = manage(new class Gtk::EventBox());
   ...
   _tooltips.set_tip(*button_grad_azr, "Abwehr, Zaubern und Resistenz an den Grad anpassen", "");
   ...
   table14->attach(*notebook2, 0, 6, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   table14->attach(*table42, 5, 6, 0, 1, 0, 0, 0, 0);
   ...
   WidgetqYKwHHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
   ...
   button_grad_azr->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_button_grad_azr_clicked));
