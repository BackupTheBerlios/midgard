...
{  table_grundwerte = this;
   ...
   pixmap_dfr4 = manage(new class Gtk::Image(_pixmap_dfr4_pixmap, _pixmap_dfr4_mask));
   ...
   Gtk::Image *button_grundwerte_img = manage(new class Gtk::Image(_button_grundwerte_img_pixmap, _button_grundwerte_img_mask));
   ...
   Gtk::Image *button_abg_werte_img = manage(new class Gtk::Image(_button_abg_werte_img_pixmap, _button_abg_werte_img_mask));
   ...
   radiobutton_frau->set_size_request(0,0);
   ...
   table_grundwerte->attach(*hseparator20, 0, 4, 4, 5, Gtk::FILL, Gtk::AttachOptions(), 0, 5);
   table_grundwerte->attach(*table68, 0, 4, 5, 6, Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   table_grundwerte->attach(*table65, 0, 4, 0, 1, Gtk::FILL, Gtk::FILL, 0, 0);
   table_grundwerte->attach(*hseparator1, 0, 4, 2, 3, Gtk::FILL, Gtk::AttachOptions(), 0, 5);
   table_grundwerte->attach(*pixmap_dfr4, 4, 5, 0, 7, Gtk::EXPAND|Gtk::SHRINK|Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   ...
   table_grundwerte->attach(*frame_wuerfelvariante, 0, 1, 6, 7, Gtk::FILL, Gtk::FILL, 0, 0);
   hseparator20->show();
   resistenz->show();
   gift_wert->show();
   label199->show();
   ...
   button_grundwerte->signal_button_release_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_button_grundwerte_button_release_event));
