...
{  
   ...
   Gtk::HandleBox *handlebox2 = manage(new class Gtk::HandleBox());
   Gtk::Table *table65 = manage(new class Gtk::Table(1, 2, false));
   ...
   Gtk::Label *label571 = manage(new class Gtk::Label("GLOBALE EINSTELLUNGEN"));
   Gtk::Label *label572 = manage(new class Gtk::Label("Anzeige"));
   Gtk::CheckButton *checkbutton1 = manage(new class Gtk::CheckButton("Wizard automatisch starten", 0, 0.5));
   Gtk::CheckButton *checkbutton2 = manage(new class Gtk::CheckButton("Bilder anzeigen", 0, 0.5));
   Gtk::CheckButton *checkbutton3 = manage(new class Gtk::CheckButton("Infofenster anzeigen", 0, 0.5));
   Gtk::CheckButton *checkbutton4 = manage(new class Gtk::CheckButton("Grundwerte nur über Maustasten würfeln", 0, 0.5));
   Gtk::Label *label578 = manage(new class Gtk::Label("HTML-Browser (für Hilfe)"));
   Gtk::Entry *entry4 = manage(new class Gtk::Entry());
   Gtk::Table *table145 = manage(new class Gtk::Table(1, 2, false));
   Gtk::CheckButton *checkbutton5 = manage(new class Gtk::CheckButton("Minihilfen anzeigen", 0, 0.5));
   frame_globale_optionen = manage(new class frame_globale_optionen(_data));
   
   Gtk::Table *table142 = manage(new class Gtk::Table(8, 1, false));
   ...
   Gtk::Table *table144 = manage(new class Gtk::Table(3, 2, false));
   Gtk::VBox *vbox47 = manage(new class Gtk::VBox(false, 0));
   Gtk::Button *button69 = manage(new class Gtk::Button("Übernehmen"));
   Gtk::Button *button70 = manage(new class Gtk::Button("Verwerfen"));
   Gtk::VSeparator *vseparator27 = manage(new class Gtk::VSeparator());
   Gtk::VSeparator *vseparator28 = manage(new class Gtk::VSeparator());
   frame_drucken = manage(new class frame_drucken(_data));
   
   Gtk::Table *table141 = manage(new class Gtk::Table(3, 3, false));
   Gtk::Table *table140 = manage(new class Gtk::Table(2, 1, false));
   Gtk::Pixmap *pixmap152 = manage(new class Gtk::Pixmap(Regio_Hausregel_50_xpm));
   ...
   Gtk::Button *button7 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_top->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Neu", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(NewChar_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   button_undo = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_top->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Zurück", 0, 0, 0, 0, 0));
   button_redo = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_top->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Vorwärts", 0, 0, 0, 0, 0));
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Space());
   ...
   Gtk::MenuItem *a1 = NULL;
   Gtk::MenuItem *b1 = NULL;
   Gtk::Menu *geschichte1_menu = manage(new class Gtk::Menu());
   Gtk::MenuItem *geschichte1 = NULL;
   Gtk::Menu *bearbeiten1_menu = manage(new class Gtk::Menu());
   Gtk::MenuItem *bearbeiten1 = NULL;
   Gtk::CheckMenuItem *meldungen1 = NULL;
   Gtk::CheckMenuItem *wizard1 = NULL;
   Gtk::Menu *fenster1_menu = manage(new class Gtk::Menu());
   Gtk::MenuItem *fenster1 = NULL;
   Gtk::CheckMenuItem *bilder1 = NULL;
   Gtk::CheckMenuItem *men_leiste1 = NULL;
   Gtk::CheckMenuItem *_u_ere_knopfleiste1 = NULL;
   Gtk::CheckMenuItem *icons1 = NULL;
   Gtk::CheckMenuItem *beschriftungen1 = NULL;
   Gtk::Menu *gestaltung1_menu = manage(new class Gtk::Menu());
   Gtk::MenuItem *gestaltung1 = NULL;
   Gtk::Menu *ansicht1_menu = manage(new class Gtk::Menu());
   Gtk::MenuItem *ansicht1 = NULL;
   Gtk::CheckMenuItem *originalregeln1 = NULL;
   Gtk::Menu *einstellungen1_menu = manage(new class Gtk::Menu());
   Gtk::MenuItem *einstellungen1 = NULL;
   menubar1 = manage(new class Gtk::MenuBar());
   
   Gtk::HandleBox *handlebox1 = manage(new class Gtk::HandleBox());
   Gtk::Table *table_9999 = manage(new class Gtk::Table(4, 1, false));
   ...
   handlebox2->add(*toolbar2);
   table65->attach(*handlebox2, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table126->attach(*handlebox3, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table14->attach(*handlebox4, 0, 1, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   table14->attach(*handlebox5, 1, 2, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table78->attach(*handlebox7, 0, 2, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   label571->set_alignment(0, 0.5);
   label571->set_padding(0, 10);
   label572->set_alignment(0, 0.5);
   label572->set_padding(0, 0);
   checkbutton1->set_flags(GTK_CAN_FOCUS);
   checkbutton1->set_active(true);
   checkbutton2->set_flags(GTK_CAN_FOCUS);
   checkbutton2->set_active(true);
   checkbutton3->set_flags(GTK_CAN_FOCUS);
   checkbutton3->set_active(true);
   checkbutton4->set_flags(GTK_CAN_FOCUS);
   label578->set_alignment(0, 0.5);
   label578->set_padding(0, 0);
   entry4->set_editable(true);
   entry4->set_text("mozilla ");
   table145->attach(*label578, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table145->attach(*entry4, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   checkbutton5->set_flags(GTK_CAN_FOCUS);
   checkbutton5->set_active(true);
   table142->attach(*label572, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table142->attach(*checkbutton1, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table142->attach(*checkbutton2, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   table142->attach(*checkbutton3, 0, 1, 3, 4, GTK_FILL, 0, 0, 0);
   table142->attach(*checkbutton4, 0, 1, 4, 5, GTK_FILL, 0, 0, 0);
   table142->attach(*table145, 0, 1, 7, 8, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table142->attach(*checkbutton5, 0, 1, 5, 6, GTK_FILL, 0, 0, 0);
   table142->attach(*frame_globale_optionen, 0, 1, 6, 7, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   entry2->set_text("$TEMP");
   entry3->set_editable(true);
   entry3->set_text("$HOME/magus");
   table144->attach(*label576, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table144->attach(*label577, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table144->attach(*entry2, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table144->attach(*entry3, 1, 2, 1, 2, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   vbox47->pack_start(*label575, false, false, 0);
   vbox47->pack_start(*table144);
   button69->set_flags(GTK_CAN_FOCUS);
   button70->set_flags(GTK_CAN_FOCUS);
   table141->attach(*table142, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table141->attach(*vbox47, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table141->attach(*button69, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   table141->attach(*button70, 2, 3, 2, 3, GTK_FILL, 0, 0, 0);
   table141->attach(*vseparator27, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table141->attach(*vseparator28, 1, 2, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   table141->attach(*frame_drucken, 2, 3, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   table140->attach(*label571, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table140->attach(*table141, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   pixmap152->set_alignment(0.5, 0.5);
   pixmap152->set_padding(0, 0);
   ...
   notebook_main->pages().push_back(Gtk::Notebook_Helpers::TabElem(*table140, *pixmap152));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Neuen Abenteurer", "<Control>N"));
   neuen_abenteurer1 = (Gtk::MenuItem *)magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Laden", "<Control>O"));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Drucken", "<Control>P"));
   ...
   geschichte1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("A"));
   a1 = (Gtk::MenuItem *)geschichte1_menu->items().back();
   
   geschichte1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("B"));
   b1 = (Gtk::MenuItem *)geschichte1_menu->items().back();
   ...
   bearbeiten1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Geschichte", *geschichte1_menu));
   geschichte1 = (Gtk::MenuItem *)bearbeiten1_menu->items().back();
   
   fenster1_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("Meldungen"));
   meldungen1 = (Gtk::CheckMenuItem *)fenster1_menu->items().back();
   meldungen1->set_show_toggle(true);
   
   
   fenster1_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("Wizard"));
   wizard1 = (Gtk::CheckMenuItem *)fenster1_menu->items().back();
   wizard1->set_show_toggle(true);
   
   
   gestaltung1_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("Bilder"));
   bilder1 = (Gtk::CheckMenuItem *)gestaltung1_menu->items().back();
   bilder1->set_active(true);
   bilder1->set_show_toggle(true);
   
   
   gestaltung1_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("Menüleiste"));
   men_leiste1 = (Gtk::CheckMenuItem *)gestaltung1_menu->items().back();
   men_leiste1->set_active(true);
   men_leiste1->set_show_toggle(true);
   
   
   gestaltung1_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("äußere Knopfleiste"));
   _u_ere_knopfleiste1 = (Gtk::CheckMenuItem *)gestaltung1_menu->items().back();
   _u_ere_knopfleiste1->set_active(true);
   _u_ere_knopfleiste1->set_show_toggle(true);
   
   
   gestaltung1_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("Icons"));
   icons1 = (Gtk::CheckMenuItem *)gestaltung1_menu->items().back();
   icons1->set_active(true);
   icons1->set_show_toggle(true);
   
   
   gestaltung1_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("Beschriftungen"));
   beschriftungen1 = (Gtk::CheckMenuItem *)gestaltung1_menu->items().back();
   beschriftungen1->set_active(true);
   beschriftungen1->set_show_toggle(true);
   
   
   ansicht1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Fenster", *fenster1_menu));
   fenster1 = (Gtk::MenuItem *)ansicht1_menu->items().back();
   
   ansicht1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Gestaltung", *gestaltung1_menu));
   gestaltung1 = (Gtk::MenuItem *)ansicht1_menu->items().back();
   
   einstellungen1_menu->items().push_back(Gtk::Menu_Helpers::CheckMenuElem("Originalregeln"));
   originalregeln1 = (Gtk::CheckMenuItem *)einstellungen1_menu->items().back();
   originalregeln1->set_active(true);
   originalregeln1->set_show_toggle(true);
   
   
   menubar1->items().push_back(Gtk::Menu_Helpers::MenuElem("Magus", *magus1_menu));
   magus1 = (Gtk::MenuItem *)menubar1->items().back();
   
   menubar1->items().push_back(Gtk::Menu_Helpers::MenuElem("Bearbeiten", *bearbeiten1_menu));
   bearbeiten1 = (Gtk::MenuItem *)menubar1->items().back();
   
   menubar1->items().push_back(Gtk::Menu_Helpers::MenuElem("Ansicht", *ansicht1_menu));
   ansicht1 = (Gtk::MenuItem *)menubar1->items().back();
   
   menubar1->items().push_back(Gtk::Menu_Helpers::MenuElem("Einstellungen", *einstellungen1_menu));
   einstellungen1 = (Gtk::MenuItem *)menubar1->items().back();
   handlebox1->add(*menubar1);
   table_9999->attach(*notebook_main, 0, 1, 2, 3, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table_9999->attach(*griff_toolbar_top, 0, 1, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   table_9999->attach(*handlebox1, 0, 1, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   bilder1->show();
   men_leiste1->show();
   _u_ere_knopfleiste1->show();
   icons1->show();
   beschriftungen1->show();
   gestaltung1_menu->show();
   gestaltung1->show();
   ansicht1_menu->show();
   ansicht1->show();
   originalregeln1->show();
   einstellungen1_menu->show();
   einstellungen1->show();
   menubar1->show();
   handlebox1->show();
   table_9999->show();
   ...
   drucken1->activate.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_drucken_clicked));
