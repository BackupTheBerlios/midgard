// generated 2001/11/5 10:28:53 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table77 = manage(new class Gtk::Table(10, 3, false));
   ...
   table77->attach(*label416, 0, 1, 5, 6, GTK_FILL, 0, 0, 0);
   table77->attach(*label417, 0, 1, 6, 7, GTK_FILL, 0, 0, 0);
   table77->attach(*label419, 0, 1, 9, 10, GTK_FILL, 0, 0, 0);
   table77->attach(*label418, 0, 1, 8, 9, GTK_FILL, 0, 0, 0);
   table77->attach(*label420, 0, 1, 7, 8, GTK_FILL, 0, 0, 0);
   ...
   table77->attach(*progressbar_zauber, 1, 2, 5, 6, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_sprache, 1, 2, 8, 9, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_zauberwerk, 1, 2, 6, 7, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_kido, 1, 2, 7, 8, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_schrift, 1, 2, 9, 10, GTK_FILL, 0, 0, 0);
   ...
   table49->attach(*frame_datenbank, 4, 5, 12, 18, GTK_FILL, GTK_FILL, 0, 0);
