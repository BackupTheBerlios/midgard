// generated 2002/4/3 11:55:48 CEST by thoma@Tiger.(none)
...
{  
   ...
   button_grundwerte = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar2->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Eigenschaften\n"
