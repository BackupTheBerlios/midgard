...
{   
   ...
   clist_kido_auswahl->set_column_title(0, "Technik");
   clist_kido_auswahl->set_column_justification(0, GTK_JUSTIFY_CENTER);
   clist_kido_auswahl->set_column_width(0, 80);
   clist_kido_auswahl->set_column_title(1, "AP");
   clist_kido_auswahl->set_column_justification(1, GTK_JUSTIFY_CENTER);
   clist_kido_auswahl->set_column_width(1, 80);
   clist_kido_auswahl->set_column_title(2, "Stil");
   ...
   clist_kido_auswahl->set_column_justification(3, GTK_JUSTIFY_CENTER);
