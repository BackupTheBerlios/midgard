// generated 2002/4/12 10:12:20 CEST by christof@puck.petig-baender.de
...
protected:
	   ...
	   {  STIL, hart, sanft, gemischt, 
        ...
        class Gtk::ScrolledWindow *scrolledwindow_lernschema;
        class Gtk::Label *label_lernschma_titel;
        class SimpleTree *Beruf_tree;
        class Gtk::ScrolledWindow *scrolledwindow_beruf;
        class MidgardBasicTree *Tree_Lernschema_Zusatz;
        class Gtk::Frame *frame_lernschema_zusatz;
        class MidgardBasicTree *tree_angeb_fert;
        class Gtk::ScrolledWindow *scrolledwindow_ange_fert;
        ...
        class Gtk::Label *label_berufskategorie;
        class Gtk::Label *label_berufsstern_erklaerung;
        class Gtk::Table *table_berufswahl;
