// generated 2006/1/27 12:50:11 CET by christof@vesta.petig-baender.de
...
{  table_zufall = this;
   ...
   combo_herkunft->get_entry()->set_has_frame(true);
   combo_herkunft->get_entry()->set_activates_default(false);
   ...
   label691->set_alignment(0.5,0.5);
   label691->set_padding(0,0);
   label691->set_justify(Gtk::JUSTIFY_LEFT);
   label691->set_line_wrap(false);
   label691->set_use_markup(false);
   label691->set_selectable(false);
   ...
   label690->set_alignment(0.5,0.5);
   label690->set_padding(0,0);
   label690->set_justify(Gtk::JUSTIFY_LEFT);
   label690->set_line_wrap(false);
   label690->set_use_markup(false);
   label690->set_selectable(false);
   ...
   label693->set_alignment(0.5,0.5);
   label693->set_padding(0,0);
   label693->set_justify(Gtk::JUSTIFY_LEFT);
   label693->set_line_wrap(false);
   label693->set_use_markup(false);
   label693->set_selectable(false);
   ...
   label694->set_alignment(0.5,0.5);
   label694->set_padding(0,0);
   label694->set_justify(Gtk::JUSTIFY_LEFT);
   label694->set_line_wrap(false);
   label694->set_use_markup(false);
   label694->set_selectable(false);
   ...
   eventbox23->property_visible_window().set_value(true);
   eventbox23->property_above_child().set_value(false);
   ...
   eventbox21->property_visible_window().set_value(true);
   eventbox21->property_above_child().set_value(false);
   ...
   eventbox22->property_visible_window().set_value(true);
   eventbox22->property_above_child().set_value(false);
   ...
   combo_prototyp->get_entry()->set_has_frame(true);
   combo_prototyp->get_entry()->set_activates_default(false);
   ...
   label695->set_alignment(0.5,0.5);
   label695->set_padding(0,0);
   label695->set_justify(Gtk::JUSTIFY_LEFT);
   label695->set_line_wrap(false);
   label695->set_use_markup(false);
   label695->set_selectable(false);
   ...
   label692->set_alignment(0.5,0.5);
   label692->set_padding(0,0);
   label692->set_justify(Gtk::JUSTIFY_LEFT);
   label692->set_line_wrap(false);
   label692->set_use_markup(false);
   label692->set_selectable(false);
