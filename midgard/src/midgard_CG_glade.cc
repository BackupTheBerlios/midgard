...
{   
   ...
   checkbutton_EP_Geld = manage(new class Gtk::CheckButton("mit EP/PP steigern"));
   ...
   button_fert_laden = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_fert->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Fertigkeiten\n"
   ...
   Gtk::Label *label518 = manage(new class Gtk::Label("Selbstsudium"));
   ...
   Gtk::Table *table99 = manage(new class Gtk::Table(1, 5, false));
   ...
   Gtk::Button *WidgetjLyWGHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table99->attach(*frame_fertigkeit, 1, 2, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   table99->attach(*toolbar_fert, 0, 1, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 5, 0);
   table99->attach(*table76, 4, 5, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   table99->attach(*frame_lernen_mit, 2, 3, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 10, 0);
   ...
   radio_waffen_steigern->set_flags(GTK_CAN_FOCUS);
   radio_waffen_steigern->set_active(true);
   radio_waffen_reduzieren->set_flags(GTK_CAN_FOCUS);
   ...
   togglebutton_praxispunkte_waffen->set_flags(GTK_CAN_FOCUS);
   radiobutton_praxis_wuerfeln_waffen->set_flags(GTK_CAN_FOCUS);
   radiobutton_praxis_wuerfeln_waffen->set_active(true);
   radiobutton_praxis_auto_waffen->set_flags(GTK_CAN_FOCUS);
   ...
   radiobutton_grundkenntnisse_verlernen->set_flags(GTK_CAN_FOCUS);
   ...
   radio_sprache_steigern->set_flags(GTK_CAN_FOCUS);
   radio_sprache_reduzieren->set_flags(GTK_CAN_FOCUS);
   radio_sprache_verlernen->set_flags(GTK_CAN_FOCUS);
   ...
   button_fert_laden->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_fertigkeiten_laden_clicked));
   ...
   WidgetjLyWGHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
