// generated 2002/4/15 11:48:10 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::Table *table140 = manage(new class Gtk::Table(1, 1, false));
   ...
   table147->attach(*entry4, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table147->attach(*label576, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   table147->attach(*label577, 0, 1, 3, 4, GTK_FILL, 0, 0, 0);
   table147->attach(*entry2, 1, 2, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table147->attach(*entry3, 1, 2, 3, 4, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   ...
   table140->attach(*table146, 0, 1, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
