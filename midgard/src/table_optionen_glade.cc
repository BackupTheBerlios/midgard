...
{  table_optionen = this;
   ...
   Gtk::Adjustment *spinbutton_datei_history_adj = manage(new class Gtk::Adjustment(1, 0, 10, 1, 10, 10));
   spinbutton_datei_history = manage(new class Gtk::SpinButton(*spinbutton_datei_history_adj, 1, 0));
   
   Gtk::Table *table147 = manage(new class Gtk::Table(5, 2, false));
   ...
   entry_speicher_verz->set_text("~/magusbartusel@yahoo.debartusel@yahoo.debartusel@yahoo.debartusel@yahoo.debartusel@yahoo.debartusel@yahoo.de");
   ...
   table147->attach(*spinbutton_datei_history, 1, 2, 4, 5, GTK_EXPAND|GTK_FILL, 0, 0, 0);
