...
private:
        virtual gint on_button_ausruestung_druck_release_event(GdkEventButton *ev) = 0;
        virtual void on_togglebutton_gruppe_neu_toggled() = 0;
        virtual void on_togglebutton_artikel_neu_toggled() = 0;
        virtual void on_entry_typ_activate() = 0;
        virtual void on_entry_eigenschaft_activate() = 0;
        ...
        virtual gint on_combo_entry_artikel_art_focus_out_event(GdkEventFocus *ev) = 0;
        virtual void on_combo_entry_art2_activate() = 0;
        virtual gint on_combo_entry_art2_focus_out_event(GdkEventFocus *ev) = 0;
        virtual void on_ausruestung_loeschen_clicked() = 0;
        virtual void on_entry_artikel_art_activate() = 0;
