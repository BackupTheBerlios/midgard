// generated 2002/1/16 9:28:09 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table107 = manage(new class Gtk::Table(2, 1, false));
   ...
   table107->attach(*label530, 0, 1, 0, 1, 0, 0, 0, 0);
   table107->attach(*vpaned13, 0, 1, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   label529->set_alignment(0, 0.5);
   ...
   table106->attach(*label529, 0, 1, 0, 1, 0, 0, 0, 0);
   table106->attach(*vpaned12, 0, 1, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   hpaned5->set_handle_size(10);
   hpaned5->set_gutter_size(6);
   hpaned5->set_position(-1);
   hpaned5->pack1(*table107, true, true);
   hpaned5->pack2(*table106, true, true);
