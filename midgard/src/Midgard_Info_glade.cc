// generated 2002/5/8 8:59:01 CEST by thoma@Tiger.(none)
...
#include <gtk--/table.h>
#include <gtk--/frame.h>
#include "../pixmaps/MAGUS-Logo-Text-halb-t2.xpm"
...
{  Midgard_Info = this;
   ...
   Gtk::Label *label531 = manage(new class Gtk::Label("Beim Abtippen der Daten haben Nils Richter,\n"
		"Sebastian Horstmann, Joachim Jordan,\n"
		"Alessandro Filipetti und viele\n"
		"andere geholfen."));
   ...
   Gtk::Pixmap *pixmap90 = manage(new class Gtk::Pixmap(MAGUS_Logo_Text_halb_t2_xpm));
   ...
   Gtk::Table *table149 = manage(new class Gtk::Table(1, 2, false));
   ...
   table149->attach(*pixmap106, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table149->attach(*pixmap154, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table49->attach(*table149, 0, 1, 3, 4, GTK_FILL, GTK_FILL, 0, 0);
