...
{  table_beschreibung = this;
   ...
   Glib::RefPtr<Gdk::Bitmap> _grafik_image_mask;
   Glib::RefPtr<Gdk::Pixmap> _grafik_image_pixmap = Gdk::Pixmap::create_from_xpm(get_default_colormap(), _grafik_image_mask, Portrait_32_xpm);
   grafik_image = Gtk::manage(new class Gtk::Image(_grafik_image_pixmap, _grafik_image_mask));
