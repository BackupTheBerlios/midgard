// generated 2001/12/30 9:39:31 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table100 = manage(new class Gtk::Table(3, 3, false));
   ...
   alte_fert_tree = new class SimpleTree(7, 7);
   ...
   alte_waffen_tree = new class SimpleTree(7, 7);
   ...
   alte_sprache_tree = new class SimpleTree(6, 6);
   ...
   alte_schrift_tree = new class SimpleTree(6, 6);
   ...
   neue_schrift_tree = new class SimpleTree(2, 2);
   ...
   table50->attach(*pixmap42, 0, 1, 0, 2, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table102->attach(*table50, 1, 2, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table15->attach(*scrolledwindow_landauswahl, 4, 5, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table_magier_steigern->attach(*hpaned3, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
