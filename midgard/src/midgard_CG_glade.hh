...
protected:
        ...
        ~midgard_CG_glade();
private:
        virtual gint on_neuer_charakter_release_event(GdkEventButton *ev) = 0;
        virtual gint on_laden_release_event(GdkEventButton *ev) = 0;
        virtual gint on_speichern_release_event(GdkEventButton *ev) = 0;
        virtual gint on_latex_release_event(GdkEventButton *ev) = 0;
        virtual void on_button_undo_clicked() = 0;
        virtual void on_button_redo_clicked() = 0;
        virtual gint on_button_menu_button_release_event(GdkEventButton *ev) = 0;
        virtual void on_button_info_clicked() = 0;
        virtual void on_button_hilfe_clicked() = 0;
        ...
        virtual void on_hilfe_menu_activate() = 0;
        virtual void on_info_credits_menu_activate() = 0;
        virtual void on_news_menu_activate() = 0;
        virtual gint on_eventbox_credits_button_release_event(GdkEventButton *ev) = 0;
        virtual gint on_eventbox_grundwerte_button_release_event(GdkEventButton *ev) = 0;
        virtual gint on_eventbox_lernen_button_release_event(GdkEventButton *ev) = 0;
        virtual gint on_eventbox_steigern_button_release_event(GdkEventButton *ev) = 0;
        virtual gint on_eventbox_beschreibung_button_release_event(GdkEventButton *ev) = 0;
        virtual gint on_eventbox_ausruestung_button_release_event(GdkEventButton *ev) = 0;
        virtual gint on_eventbox_optionen_button_release_event(GdkEventButton *ev) = 0;
        ...
        virtual gint on_eventbox_geschichte_button_release_event(GdkEventButton *ev) = 0;
        virtual gint on_eventbox_zufall_button_release_event(GdkEventButton *ev) = 0;
        virtual void on_notebook_main_switch_page(Gtk::Notebook_Helpers::Page *p0, guint p1) = 0;
        virtual gint on_midgard_CG_delete_event(GdkEventAny *ev) = 0;
        virtual gint on_eventbox_MCG_button_press_event(GdkEventButton *ev) = 0;
};
#endif
