// generated 2002/6/14 11:46:04 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   table_handlebox1 = manage(new class Gtk::Table(1, 3, false));
   ...
   Gtk::Table *table72 = manage(new class Gtk::Table(3, 4, false));
   ...
   togglebutton_pp_aep_fuellen = manage(new class Gtk::ToggleButton("Mit EP\n"
		"auffüllen"));
   ...
   table_handlebox1->attach(*handlebox5, 1, 2, 0, 1, 0, 0, 0, 0);
   ...
   table72->attach(*button_gold_eingeben, 3, 4, 2, 3, 0, 0, 0, 0);
   table72->attach(*hbox30, 0, 3, 0, 1, GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table72->attach(*hbox31, 0, 3, 2, 3, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table72->attach(*frame41, 1, 3, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   table72->attach(*checkbutton_EP_Geld, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table72->attach(*checkbutton_gfp, 3, 4, 1, 2, GTK_FILL, 0, 0, 0);
   table72->attach(*button_EP, 3, 4, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   table_pp_einstellungen->attach(*togglebutton_pp_aep_fuellen, 1, 2, 0, 2, 0, GTK_FILL, 0, 0);
   table101->attach(*radiobutton_praxis, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   table101->attach(*radiobutton_unterweisung, 0, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table101->attach(*radiobutton_selbst, 0, 2, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   table99->attach(*table72, 2, 3, 0, 1, 0, GTK_FILL, 0, 0);
   table99->attach(*eventbox1, 1, 2, 0, 1, GTK_SHRINK, GTK_SHRINK|GTK_FILL, 0, 0);
