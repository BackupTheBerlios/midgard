// generated 2002/10/30 15:39:48 CET by christof@puck.petig-baender.de
...
{  table_steigern = this;
   ...
   notebook_lernen->switch_page.connect(SigC::slot(this, &table_steigern_glade::on_notebook_lernen_switch_page));
}
