// generated 2002/5/14 8:49:07 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::Table *table_grundwerte = manage(new class Gtk::Table(7, 5, false));
   ...
   table_grundwerte->attach(*hseparator20, 0, 4, 4, 5, GTK_FILL, 0, 0, 5);
   table_grundwerte->attach(*table_werte_wuerfeln, 0, 1, 6, 7, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table_grundwerte->attach(*table68, 0, 4, 5, 6, GTK_FILL, 0, 0, 0);
   table_grundwerte->attach(*table65, 0, 4, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   table_grundwerte->attach(*table67, 0, 4, 3, 4, GTK_FILL, 0, 10, 0);
   table_grundwerte->attach(*pixmap_dfr4, 4, 5, 0, 6, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table_grundwerte->attach(*hseparator1, 0, 4, 2, 3, GTK_FILL, 0, 0, 5);
   table_grundwerte->attach(*toolbar2, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
