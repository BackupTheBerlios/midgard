...
{  table_ausruestung = this;
...
#endif //
   Glib::RefPtr<Gdk::Bitmap> _button_ausruestung_loeschen_img_mask;
   Glib::RefPtr<Gdk::Pixmap> _button_ausruestung_loeschen_img_pixmap = Gdk::Pixmap::create_from_xpm(get_default_colormap(), _button_ausruestung_loeschen_img_mask, Trash_32_xpm);
   Gtk::Image *button_ausruestung_loeschen_img = Gtk::manage(new class Gtk::Image(_button_ausruestung_loeschen_img_pixmap, _button_ausruestung_loeschen_img_mask));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
...
#endif //
   Glib::RefPtr<Gdk::Bitmap> _checkbutton_ausruestung_geld_img_mask;
   Glib::RefPtr<Gdk::Pixmap> _checkbutton_ausruestung_geld_img_pixmap = Gdk::Pixmap::create_from_xpm(get_default_colormap(), _checkbutton_ausruestung_geld_img_mask, Money_50_xpm);
   Gtk::Image *checkbutton_ausruestung_geld_img = Gtk::manage(new class Gtk::Image(_checkbutton_ausruestung_geld_img_pixmap, _checkbutton_ausruestung_geld_img_mask));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   checkbutton_ausruestung_geld = Gtk::manage(new class Gtk::ToggleToolButton(*checkbutton_ausruestung_geld_img, "Mit Geld\n"
		"ausrüsten"));
#endif //
   
   Glib::RefPtr<Gdk::Bitmap> _togglebutton_unverkauflich_img_mask;
   Glib::RefPtr<Gdk::Pixmap> _togglebutton_unverkauflich_img_pixmap = Gdk::Pixmap::create_from_xpm(get_default_colormap(), _togglebutton_unverkauflich_img_mask, Angeb_Sicht_32_xpm);
   Gtk::Image *togglebutton_unverkauflich_img = Gtk::manage(new class Gtk::Image(_togglebutton_unverkauflich_img_pixmap, _togglebutton_unverkauflich_img_mask));
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   ...
   togglebutton_unverkauflich->set_homogeneous(false);
   ...
   table_artikel->attach(*button_artikel_speichern, 7, 8, 0, 2, Gtk::SHRINK, Gtk::SHRINK|Gtk::FILL, 0, 0);
   ...
   _tooltips.set_tip(*eventbox25, "Artikel mit der Maus von unten nach oben ziehen oder umordnen", "");
