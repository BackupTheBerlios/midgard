// generated 2004/5/10 13:57:37 CEST by christof@puck.petig-baender.de
...
{  table_grundwerte = this;
   ...
   spinbutton_gg->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gg_activate), false);
   ...
   button_grundwerte->signal_clicked().connect(SigC::slot(*this, &table_grundwerte_glade::on_button_grundwerte), false);
   radiobutton_mann->signal_toggled().connect(SigC::slot(*this, &table_grundwerte_glade::on_radiobutton_mann_toggled), false);
   radiobutton_frau->signal_toggled().connect(SigC::slot(*this, &table_grundwerte_glade::on_radiobutton_frau_toggled), false);
   ...
   radiobutton_stadt->signal_toggled().connect(SigC::slot(*this, &table_grundwerte_glade::on_radiobutton_stadt_land_toggled), false);
   radiobutton_land->signal_toggled().connect(SigC::slot(*this, &table_grundwerte_glade::on_radiobutton_stadt_land_toggled), false);
   ...
   spinbutton_zt->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_zt_activate), false);
