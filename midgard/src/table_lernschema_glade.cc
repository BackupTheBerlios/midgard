// generated 2002/11/11 11:00:58 CET by thoma@Tiger.(none)
...
{  table_lernschema = this;
   ...
   togglebutton_gelernt_verlernen->set_flags(GTK_CAN_FOCUS);
   togglebutton_gelernt_verlernen->set_relief(GTK_RELIEF_NORMAL);
   ...
   table122->attach(*scrolledwindow73, 0, 2, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table122->attach(*togglebutton_gelernt_verlernen, 1, 2, 0, 1, GTK_SHRINK, GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   button_waffe_trans->clicked.connect(SigC::slot(this, &table_lernschema_glade::on_button_waffe_trans_clicked));
   button_fach_trans->clicked.connect(SigC::slot(this, &table_lernschema_glade::on_button_fach_trans_clicked));
   spinbutton_fach->activate.connect_after(SigC::slot(this, &table_lernschema_glade::on_spinbutton_fach_activate));
   spinbutton_fach->focus_out_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_fach_focus_out_event));
   spinbutton_fach->focus_in_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_fach_focus_in_event));
   button_fachkenntnisse->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_lernliste_wahl_toggled));
   spinbutton_allgemein->activate.connect_after(SigC::slot(this, &table_lernschema_glade::on_spinbutton_allgemein_activate));
   spinbutton_allgemein->focus_out_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_allgemein_focus_out_event));
   spinbutton_allgemein->focus_in_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_allgemein_focus_in_event));
   button_allgemeinwissen->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_lernliste_wahl_toggled));
   spinbutton_unge->activate.connect_after(SigC::slot(this, &table_lernschema_glade::on_spinbutton_unge_activate));
   spinbutton_unge->focus_out_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_unge_focus_out_event));
   spinbutton_unge->focus_in_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_unge_focus_in_event));
   button_untyp_fertigkeiten->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_lernliste_wahl_toggled));
   combo_kido_stil->get_entry()->activate.connect(SigC::slot(this, &table_lernschema_glade::on_combo_kido_stil_activate));
   combo_kido_stil->get_entry()->focus_out_event.connect(SigC::slot(this, &table_lernschema_glade::on_combo_kido_stil_focus_out_event));
   combo_kido_stil->get_entry()->changed.connect(SigC::slot(this, &table_lernschema_glade::on_combo_kido_stil_changed));
   button_kido_auswahl->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_kido_wahl_clicked));
   spinbutton_waffen->activate.connect_after(SigC::slot(this, &table_lernschema_glade::on_spinbutton_waffen_activate));
   spinbutton_waffen->focus_out_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_waffen_focus_out_event));
   spinbutton_waffen->focus_in_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_waffen_focus_in_event));
   button_waffen->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_lernliste_wahl_toggled));
   button_waffen->clicked.connect(SigC::slot(this, &table_lernschema_glade::on_button_waffen_clicked));
   spinbutton_zauber->activate.connect_after(SigC::slot(this, &table_lernschema_glade::on_spinbutton_zaubern_activate));
   spinbutton_zauber->focus_out_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_zaubern_focus_out_event));
   spinbutton_zauber->focus_in_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_zaubern_focus_in_event));
   button_zauber->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_lernliste_wahl_toggled));
   combo_magier_spezialgebiet->get_entry()->activate.connect(SigC::slot(this, &table_lernschema_glade::on_combo_magier_spezialgebiet_activate));
   combo_magier_spezialgebiet->get_entry()->focus_out_event.connect(SigC::slot(this, &table_lernschema_glade::on_combo_magier_spezialgebiet_focus_out_event));
   combo_magier_spezialgebiet->get_entry()->changed.connect(SigC::slot(this, &table_lernschema_glade::on_combo_magier_changed));
   togglebutton_spezialwaffe->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_togglebutton_spezialwaffe_toggled));
   eventbox_zusatz->leave_notify_event.connect(SigC::slot(this, &table_lernschema_glade::on_eventbox_zusatz_leave_notify_event));
   togglebutton_teure_anzeigen->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_togglebutton_teure_anzeigen_toggled));
   togglebutton_gelernte_anzeigen->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_togglebutton_gelernte_anzeigen_toggled));
   tree_gelerntes->leaf_selected.connect(SigC::slot(this, &table_lernschema_glade::on_tree_gelerntes_leaf_selected));
   checkbutton_einschraenkungen_zusatz->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_togglebutton_einschraenkungen_zusatz_anzeigen_toggled));
   button_herkunft->clicked.connect(SigC::slot(this, &table_lernschema_glade::on_herkunftsland_clicked));
   button_angeborene_fert->button_release_event.connect(SigC::slot(this, &table_lernschema_glade::on_angeborene_fertigkeit_button_release_event));
   button_lernpunkte->clicked.connect(SigC::slot(this, &table_lernschema_glade::on_lernpunkte_wuerfeln_clicked));
   togglebutton_lernpunkte_edit->toggled.connect(SigC::slot(this, &table_lernschema_glade::on_togglebutton_lernpunkte_edit_toggled));
   button_beruf->button_release_event.connect(SigC::slot(this, &table_lernschema_glade::on_button_beruf_release_event));
   spinbutton_beruf->activate.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_beruf_activate));
   spinbutton_beruf->focus_in_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_beruf_focus_in));
   entry_berufsname->activate.connect(SigC::slot(this, &table_lernschema_glade::on_entry_berufsname_activate));
   button_lernschema_geld->button_release_event.connect(SigC::slot(this, &table_lernschema_glade::on_button_lernschema_geld_button_release_event));
   button_lernschema_waffen->button_release_event.connect(SigC::slot(this, &table_lernschema_glade::on_button_lernschema_waffen_button_release_event));
   spinbutton_waffen_lernschema->activate.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_waffen_lernschema_activate));
   spinbutton_waffen_lernschema->focus_in_event.connect(SigC::slot(this, &table_lernschema_glade::on_spinbutton_waffen_lernschema_focus_in_event));
   button_ruestung->button_release_event.connect(SigC::slot(this, &table_lernschema_glade::on_button_ruestung_button_release_event));
   button_ausruestung->button_release_event.connect(SigC::slot(this, &table_lernschema_glade::on_button_ausruestung_button_release_event));
}
