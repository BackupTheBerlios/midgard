// generated 2002/11/28 10:37:00 CET by thoma@Tiger.(none)
...
{  table_ausruestung = this;
   ...
   combo_region->get_entry()->set_editable(true);
   ...
   combo_einheit->get_entry()->set_editable(true);
   ...
   table105->attach(*entry_artikel_art, 0, 1, 1, 2, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   ...
   entry_typ->activate.connect(SigC::slot(this, &table_ausruestung_glade::on_entry_typ_activate));
   entry_eigenschaft->activate.connect(SigC::slot(this, &table_ausruestung_glade::on_entry_eigenschaft_activate));
   ...
   entry_artikel_art->activate.connect(SigC::slot(this, &table_ausruestung_glade::on_entry_artikel_art_activate));
