// generated 2003/4/14 22:41:54 CEST by christof@puck.petig-baender.de
...
{  table_beschreibung = this;
   ...
   Gtk::Image *pixmap147 = Gtk::manage(new class Gtk::Image(_pixmap147_pixmap, _pixmap147_mask));
   ...
   Gtk::Image *pixmap148 = Gtk::manage(new class Gtk::Image(_pixmap148_pixmap, _pixmap148_mask));
   ...
   pixmap148->set_name("pixmap148");
   pixmap148->set_alignment(0.5,0.5);
   pixmap148->set_padding(0,0);
   label_grafik->set_name("label_grafik");
   ...
   spinbutton_pix_breite->set_name("spinbutton_pix_breite");
   ...
   text_charakter_beschreibung->set_name("text_charakter_beschreibung");
   ...
   table_beschreibung->set_name("table_beschreibung");
