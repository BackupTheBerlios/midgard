// generated 2002/10/24 8:37:42 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   Gtk::Pixmap *pixmap82 = manage(new class Gtk::Pixmap(Automat_32_xpm));
   ...
   Gtk::Pixmap *pixmap81 = manage(new class Gtk::Pixmap(Green_Dice_trans_50_xpm));
   ...
   table50->attach(*radio_spruchrolle_auto, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table50->attach(*radio_spruchrolle_wuerfeln, 0, 1, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
