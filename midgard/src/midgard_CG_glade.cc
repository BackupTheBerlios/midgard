// generated 2002/1/25 8:30:09 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Button *button_EP = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar37->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Erfahrungspunkte\n"
		"eingeben", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(EP_Eingabe2_50_xpm))->gtkobj()), 0, 0));
   ...
   table_kido_lernen->attach(*scrolledwindow46, 0, 3, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   _tooltips.set_tip(*togglebutton_alle_zauber, "Zaubersalze können gelernt werden", "");
