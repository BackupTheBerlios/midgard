// generated 2001/5/15 23:18:13 CEST by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table28 = manage(new class Gtk::Table(4, 4, false));
   ...
   Gtk::Pixmap *pixmap52 = manage(new class Gtk::Pixmap(Draco_small_frame_comp_xpm));
   ...
   Gtk::Table *table1 = manage(new class Gtk::Table(8, 5, false));
   ...
   steigern_zauber_clist_alt = manage(new class Gtk::CList(3));
   
   Gtk::ScrolledWindow *scrolledwindow33 = manage(new class Gtk::ScrolledWindow());
   steigern_zauber_clist_neu = manage(new class Gtk::CList(5));
   ...
   Gtk::Button *WidgetJWJLKHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table28->attach(*frame11, 3, 4, 2, 3, 0, GTK_FILL, 5, 0);
   table28->attach(*frame10, 3, 4, 1, 2, GTK_EXPAND, GTK_FILL, 5, 0);
   ...
   fixed4->put(*checkbutton_HD, 0, 96);
   ...
   fixed5->put(*optionmenu_spezies, 128, 8);
   {   
   ...
   frame57->add(*table30);
   table1->attach(*frame56, 2, 3, 6, 7, GTK_FILL, 0, 5, 0);
   table1->attach(*frame55, 1, 2, 6, 7, GTK_FILL, 0, 5, 0);
   table1->attach(*frame54, 0, 1, 6, 7, GTK_FILL, 0, 5, 0);
   table1->attach(*frame58, 0, 3, 5, 6, GTK_FILL, GTK_FILL, 0, 5);
   ...
   table1->attach(*fixed5, 2, 3, 2, 3, GTK_FILL, GTK_FILL, 0, 0);
   table1->attach(*typauswahl_2, 0, 2, 3, 4, GTK_FILL, 0, 5, 5);
   table1->attach(*hseparator1, 0, 3, 4, 5, GTK_FILL, GTK_FILL, 0, 6);
   table1->attach(*pixmap52, 3, 5, 2, 8, GTK_FILL, GTK_FILL, 0, 0);
   table1->attach(*frame57, 2, 3, 7, 8, GTK_FILL, GTK_FILL, 5, 0);
   ...
   steigern_zauber_clist_alt->set_column_title(1, "Ursprung");
   steigern_zauber_clist_alt->set_column_justification(1, GTK_JUSTIFY_RIGHT);
   steigern_zauber_clist_alt->set_column_width(1, 80);
   steigern_zauber_clist_alt->set_column_title(2, "Kosten");
   steigern_zauber_clist_alt->set_column_justification(2, GTK_JUSTIFY_RIGHT);
   steigern_zauber_clist_alt->set_column_width(2, 80);
   ...
   steigern_zauber_clist_neu->set_column_title(2, "Ursprung");
   steigern_zauber_clist_neu->set_column_width(2, 80);
   steigern_zauber_clist_neu->set_column_title(3, "Kosten");
   steigern_zauber_clist_neu->set_column_justification(3, GTK_JUSTIFY_RIGHT);
   steigern_zauber_clist_neu->set_column_width(3, 80);
   steigern_zauber_clist_neu->set_column_title(4, "Art");
   steigern_zauber_clist_neu->set_column_width(4, 80);
   ...
   WidgetJWJLKHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
