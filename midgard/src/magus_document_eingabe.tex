...
\begin{document}
%\IfFileExists{drache.png}{\parbox{10cm}{\includegraphics[width=10cm]{drache.png}}}
...
%\IfFileExists{drache.png}{\parbox{10cm}{\reflectbox{\includegraphics[width=10cm]{drache.png}}}}%
...
\end{tabular}\hfill
\begin{tabular}{|c|l|}\hline
Körpergröße&\makebox[0.8cm]{\resizebox*{1.0cm}{1.5ex}{\koerpergroesse~(\koerpergroessebez)}}\\\hline
\end{tabular}
...
Schmecken      & \sinnsc     &Abwehr        & \boab  &Resistenz     & \res    & \ppresistenz \\
Tasten         & \sinnt      &Zaubern       & \boza  &Geistesmagie  & \psy    & \\
Sechster Sinn  & \sinnss     &Geistmagie    & \bopsy &Körpermagie   & \phs    & \\
               &             &Körpermagie   & \bophs &Umgebungsmagie& \phk    & \\
\multicolumn{2}{|l|}{\hand}  &Umgebungsmagie& \bophk &Gift          & \gift   & \\\hline
\end{tabular}
}
\hfill
