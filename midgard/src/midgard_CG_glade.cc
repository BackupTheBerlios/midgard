...
{  midgard_CG = this;
   ...
   Glib::RefPtr<Gdk::Bitmap> _pixmap_status_wizard_mask;
   Glib::RefPtr<Gdk::Pixmap> _pixmap_status_wizard_pixmap = Gdk::Pixmap::create_from_xpm(get_default_colormap(), _pixmap_status_wizard_mask, MAGUS_Logo_Tiny_xpm);
   pixmap_status_wizard = Gtk::manage(new class Gtk::Image(_pixmap_status_wizard_pixmap, _pixmap_status_wizard_mask));
