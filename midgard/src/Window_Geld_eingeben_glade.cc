...
{  
   ...
   Gtk::AccelGroup *Window_Geld_eingeben_accgrp = Gtk::AccelGroup::create();
   _data = new GlademmData(Window_Geld_eingeben_accgrp);
   ...
   Window_Geld_eingeben->set_modal(true);
   Window_Geld_eingeben->add_accel_group(*(_data->getAccelGroup()));
   ...
   spinbutton_silber->activate.connect(SigC::slot(static_cast<class Window_Geld_eingeben*>(this), &Window_Geld_eingeben::on_spinbutton_silber_activate));
   spinbutton_kupfer->activate.connect(SigC::slot(static_cast<class Window_Geld_eingeben*>(this), &Window_Geld_eingeben::on_spinbutton_kupfer_activate));
   ...
   spinbutton_gold->activate.connect(SigC::slot(static_cast<class Window_Geld_eingeben*>(this), &Window_Geld_eingeben::on_spinbutton_gold_activate));
}
