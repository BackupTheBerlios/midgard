// generated 2002/10/30 15:41:39 CET by christof@puck.petig-baender.de
...
{  table_zufall = this;
   ...
   Gtk::RadioButton::Group _RadioBGroup_proto_verteilen;
   radiobutton_proto_verteilen = manage(new class Gtk::RadioButton(_RadioBGroup_proto_verteilen, "Verteile", 0, 0.5));
   radiobutton_proto_spezialisieren = manage(new class Gtk::RadioButton(_RadioBGroup_proto_verteilen, "Spezialisieren", 0, 0.5));
   
   Gtk::Table *table174 = manage(new class Gtk::Table(2, 1, false));
   Gtk::Frame *frame116 = manage(new class Gtk::Frame());
   Gtk::Label *label627 = manage(new class Gtk::Label("Ausnahmekenntnisse"));
   Gtk::Label *label625 = manage(new class Gtk::Label("Grundkenntnisse"));
   Gtk::Label *label626 = manage(new class Gtk::Label("Standardkenntnisse"));
   Gtk::Adjustment *spinbutton_ausnahme_adj = manage(new class Gtk::Adjustment(1, 0, 100, 1, 10, 10));
   spinbutton_ausnahme = manage(new class Gtk::SpinButton(*spinbutton_ausnahme_adj, 1, 0));
   
   Gtk::Adjustment *spinbutton_standard_adj = manage(new class Gtk::Adjustment(1, 0, 100, 1, 10, 10));
   spinbutton_standard = manage(new class Gtk::SpinButton(*spinbutton_standard_adj, 1, 0));
   
   Gtk::Adjustment *spinbutton_grund_adj = manage(new class Gtk::Adjustment(1, 0, 100, 1, 10, 10));
   spinbutton_grund = manage(new class Gtk::SpinButton(*spinbutton_grund_adj, 1, 0));
   ...
   Gtk::Table *table176 = manage(new class Gtk::Table(2, 2, false));
   Gtk::EventBox *eventbox23 = manage(new class Gtk::EventBox());
   ...
   Gtk::Table *table172 = manage(new class Gtk::Table(6, 8, false));
   Gtk::EventBox *eventbox21 = manage(new class Gtk::EventBox());
   Gtk::Table *table175 = manage(new class Gtk::Table(2, 1, false));
   ...
   radiobutton_proto_verteilen->set_flags(GTK_CAN_FOCUS);
   radiobutton_proto_verteilen->set_mode(true);
   radiobutton_proto_verteilen->set_active(false);
   radiobutton_proto_spezialisieren->set_flags(GTK_CAN_FOCUS);
   ...
   table174->attach(*radiobutton_proto_verteilen, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table174->attach(*radiobutton_proto_spezialisieren, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   frame116->set_shadow_type(GTK_SHADOW_NONE);
   frame116->set_label_align(0,0);
   frame116->add(*table174);
   label627->set_alignment(0,0.5);
   label627->set_padding(0,0);
   label627->set_justify(GTK_JUSTIFY_CENTER);
   label627->set_line_wrap(false);
   label625->set_alignment(0,0.5);
   label625->set_padding(0,0);
   label625->set_justify(GTK_JUSTIFY_CENTER);
   label625->set_line_wrap(false);
   label626->set_alignment(0,0.5);
   label626->set_padding(0,0);
   label626->set_justify(GTK_JUSTIFY_CENTER);
   label626->set_line_wrap(false);
   spinbutton_ausnahme->set_flags(GTK_CAN_FOCUS);
   spinbutton_ausnahme->set_update_policy(GTK_UPDATE_ALWAYS);
   spinbutton_ausnahme->set_numeric(false);
   spinbutton_ausnahme->set_digits(0);
   spinbutton_ausnahme->set_wrap(false);
   spinbutton_ausnahme->set_snap_to_ticks(false);
   spinbutton_standard->set_flags(GTK_CAN_FOCUS);
   spinbutton_standard->set_update_policy(GTK_UPDATE_ALWAYS);
   spinbutton_standard->set_numeric(false);
   spinbutton_standard->set_digits(0);
   spinbutton_standard->set_wrap(false);
   spinbutton_standard->set_snap_to_ticks(false);
   spinbutton_grund->set_flags(GTK_CAN_FOCUS);
   spinbutton_grund->set_update_policy(GTK_UPDATE_ALWAYS);
   spinbutton_grund->set_numeric(false);
   spinbutton_grund->set_digits(0);
   spinbutton_grund->set_wrap(false);
   spinbutton_grund->set_snap_to_ticks(false);
   table173->set_row_spacings(0);
   table173->set_col_spacings(3);
   table173->attach(*label627, 4, 6, 0, 1, GTK_FILL, 0, 0, 0);
   table173->attach(*label625, 0, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table173->attach(*label626, 2, 4, 0, 1, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   table173->attach(*spinbutton_ausnahme, 4, 5, 1, 2, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table173->attach(*spinbutton_standard, 2, 3, 1, 2, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table173->attach(*spinbutton_grund, 0, 1, 1, 2, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   frame_verteilung_auf->set_shadow_type(GTK_SHADOW_ETCHED_IN);
   frame_verteilung_auf->set_label_align(0,0);
   frame_verteilung_auf->add(*table173);
   scrolledwindow_prototyp->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   scrolledwindow_prototyp->add(*tree_prototyp);
   frame_spezialist_typen->set_shadow_type(GTK_SHADOW_ETCHED_IN);
   frame_spezialist_typen->set_label_align(0,0);
   frame_spezialist_typen->add(*scrolledwindow_prototyp);
   table176->set_row_spacings(0);
   table176->set_col_spacings(0);
   table176->attach(*frame116, 0, 1, 0, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table176->attach(*frame_verteilung_auf, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table176->attach(*frame_spezialist_typen, 1, 2, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table172->attach(*scale_fert, 1, 2, 2, 5, GTK_FILL, GTK_FILL, 0, 0);
   table172->attach(*scale_waffen, 2, 3, 2, 5, GTK_FILL, GTK_FILL, 0, 0);
   table172->attach(*scale_sprachen, 6, 7, 2, 5, GTK_FILL, GTK_FILL, 0, 0);
   table172->attach(*scale_schriften, 7, 8, 2, 5, GTK_FILL, GTK_FILL, 0, 0);
   table172->attach(*hseparator21, 0, 8, 5, 6, GTK_SHRINK|GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   table172->attach(*spinbutton_fertigkeit, 1, 2, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table172->attach(*spinbutton_waffen, 2, 3, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table172->attach(*spinbutton_waffen_grund, 3, 4, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table172->attach(*spinbutton_zauber, 4, 5, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table172->attach(*spinbutton_sprachen, 6, 7, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table172->attach(*spinbutton_schriften, 7, 8, 1, 2, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   ...
   table175->attach(*eventbox23, 0, 1, 1, 2, GTK_SHRINK, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   table175->attach(*eventbox21, 0, 1, 0, 1, GTK_EXPAND|GTK_SHRINK, GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   frame111->show();
   table_zufall->show();
   checkbutton_spezies->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_spezies_toggled));
   checkbutton_herkunft->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_herkunft_toggled));
   checkbutton_typ->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_typ_toggled));
   combo_spezies->get_entry()->activate.connect(SigC::slot(this, &table_zufall_glade::on_combo_spezies_activate));
   combo_spezies->get_entry()->focus_out_event.connect(SigC::slot(this, &table_zufall_glade::on_combo_spezies_focus_out_event));
   combo_spezies->get_entry()->changed.connect(SigC::slot(this, &table_zufall_glade::on_combo_spezies_changed));
   combo_typ->get_entry()->activate.connect(SigC::slot(this, &table_zufall_glade::on_combo_typ_activate));
   combo_typ->get_entry()->focus_out_event.connect(SigC::slot(this, &table_zufall_glade::on_combo_typ__focus_out_event));
   combo_typ->get_entry()->changed.connect(SigC::slot(this, &table_zufall_glade::on_combo_typ__changed));
   combo_herkunft->get_entry()->activate.connect(SigC::slot(this, &table_zufall_glade::on_combo_typ_activate));
   combo_herkunft->get_entry()->focus_out_event.connect(SigC::slot(this, &table_zufall_glade::on_combo_typ__focus_out_event));
   combo_herkunft->get_entry()->changed.connect(SigC::slot(this, &table_zufall_glade::on_combo_typ__changed));
   checkbutton_werte->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_werte_toggled));
   checkbutton_st->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_st_toggled));
   checkbutton_gs->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_gs_toggled));
   checkbutton_gw->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_gw_toggled));
   checkbutton_ko->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_ko_toggled));
   checkbutton_in->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_in_toggled));
   checkbutton_zt->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_zt_toggled));
   checkbutton_au->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_au_toggled));
   checkbutton_pa->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_pa_toggled));
   checkbutton_wk->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_wk_toggled));
   checkbutton_sb->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_sb_toggled));
   checkbutton_b->toggled.connect(SigC::slot(this, &table_zufall_glade::on_checkbutton_b_toggled));
   togglebutton_vorgaben->toggled.connect(SigC::slot(this, &table_zufall_glade::on_togglebutton_vorgaben_toggled));
   button_zufall_voll->clicked.connect(SigC::slot(this, &table_zufall_glade::on_button_zufall_voll_clicked));
   button_steigern->clicked.connect(SigC::slot(this, &table_zufall_glade::on_button_steigern_clicked));
   radiobutton_proto_verteilen->toggled.connect(SigC::slot(this, &table_zufall_glade::on_radiobutton_proto_verteilen_toggled));
   radiobutton_proto_spezialisieren->toggled.connect(SigC::slot(this, &table_zufall_glade::on_radiobutton_proto_spezialisieren_toggled));
   spinbutton_ausnahme->activate.connect(SigC::slot(this, &table_zufall_glade::on_spinbutton_ausnahme_activate));
   spinbutton_standard->activate.connect(SigC::slot(this, &table_zufall_glade::on_spinbutton_standard_activate));
   spinbutton_grund->activate.connect(SigC::slot(this, &table_zufall_glade::on_spinbutton_grund_activate));
   tree_prototyp->leaf_selected.connect(SigC::slot(this, &table_zufall_glade::on_tree_prototyp_leaf_selected));
   spinbutton_zauberwerk->activate.connect(SigC::slot(this, &table_zufall_glade::on_spinbutton_zauberwerk_activate));
   button_check100->clicked.connect(SigC::slot(this, &table_zufall_glade::on_button_check100_clicked));
   scale_fert->activate.connect(SigC::slot(this, &table_zufall_glade::on_scale_fert_activate));
   scale_waffen->activate.connect(SigC::slot(this, &table_zufall_glade::on_scale_waffen_activate));
   scale_sprachen->activate.connect(SigC::slot(this, &table_zufall_glade::on_scale_sprachen_activate));
   scale_schriften->activate.connect(SigC::slot(this, &table_zufall_glade::on_scale_waffen_activate));
   spinbutton_fertigkeit->activate.connect(SigC::slot(this, &table_zufall_glade::on_spinbutton_fertigkeit_activate));
   spinbutton_waffen->activate.connect(SigC::slot(this, &table_zufall_glade::on_spinbutton_waffen_activate));
   spinbutton_waffen_grund->activate.connect(SigC::slot(this, &table_zufall_glade::on_spinbutton_waffen_grund_activate));
   spinbutton_zauber->activate.connect(SigC::slot(this, &table_zufall_glade::on_spinbutton_zauber_activate));
   spinbutton_sprachen->activate.connect(SigC::slot(this, &table_zufall_glade::on_spinbutton_sprachen_activate));
   spinbutton_schriften->activate.connect(SigC::slot(this, &table_zufall_glade::on_spinbutton_schriften_activate));
   radiobutton_steigern_gfp->toggled.connect(SigC::slot(this, &table_zufall_glade::on_radiobutton_steigern_gfp_toggled));
   radiobutton_steigern_grad->toggled.connect(SigC::slot(this, &table_zufall_glade::on_radiobutton_steigern_grad_toggled));
   combo_prototyp->get_entry()->activate.connect(SigC::slot(this, &table_zufall_glade::on_combo_prototyp_activate));
   combo_prototyp->get_entry()->focus_out_event.connect(SigC::slot(this, &table_zufall_glade::on_combo_prototyp_focus_out_event));
   combo_prototyp->get_entry()->changed.connect(SigC::slot(this, &table_zufall_glade::on_combo_prototyp_changed));
   togglebutton_prototyp->toggled.connect(SigC::slot(this, &table_zufall_glade::on_togglebutton_prototyp_toggled));
}
