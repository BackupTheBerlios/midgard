// generated 2001/12/10 13:09:20 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Button *WidgetjwYpGHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table78->attach(*scrolledwindow58, 0, 2, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table78->attach(*pixmap51, 2, 3, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   ...
   WidgetjwYpGHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
