...
{  table_grundwerte = this;
   ...
   Gtk::RadioButton::Group _RadioBGroup_radiobutton_eigenschaften_standard;
   radiobutton_eigenschaften_standard = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_eigenschaften_standard, "Standard"));
   radiobutton_eigenschaften_zuweisen = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_eigenschaften_standard, "Zuweisen"));
   radiobutton_eigenschaften_69 = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_eigenschaften_standard, "6 von 9"));
   vbox_gw_wuerfeln = Gtk::manage(new class Gtk::VBox(true, 0));
   
   Gtk::RadioButton::Group _RadioBGroup_radiobutton_mann;
   radiobutton_mann = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_mann, "männlich"));
   radiobutton_frau = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_mann, "weiblich"));
   
   Gtk::VBox *vbox47 = Gtk::manage(new class Gtk::VBox(false, 0));
   combo_typ = Gtk::manage(new class Gtk::Combo());
   combo_typ2 = Gtk::manage(new class Gtk::Combo());
   
   Gtk::VBox *vbox46 = Gtk::manage(new class Gtk::VBox(false, 0));
   Gtk::RadioButton::Group _RadioBGroup_radiobutton_stadt;
   radiobutton_stadt = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_stadt, "Stadt"));
   radiobutton_land = Gtk::manage(new class Gtk::RadioButton(_RadioBGroup_radiobutton_stadt, "Land"));
   
   Gtk::VBox *vbox48 = Gtk::manage(new class Gtk::VBox(false, 0));
   eventbox_werte_edit = Gtk::manage(new class Gtk::EventBox());
   
   Gtk::Fixed *fixed5 = Gtk::manage(new class Gtk::Fixed());
   ...
   Gtk::Image *pixmap115 = Gtk::manage(new class Gtk::Image(_pixmap115_pixmap, _pixmap115_mask));
   ...
   Gtk::Table *table65 = Gtk::manage(new class Gtk::Table(2, 2, false));
   Glib::RefPtr<Gdk::Bitmap> _pixmap_dfr4_mask;
   Glib::RefPtr<Gdk::Pixmap> _pixmap_dfr4_pixmap = Gdk::Pixmap::create_from_xpm(get_default_colormap(), _pixmap_dfr4_mask, Gross_dfr4_pre_xpm);
   pixmap_dfr4 = Gtk::manage(new class Gtk::Image(_pixmap_dfr4_pixmap, _pixmap_dfr4_mask));
   ...
   Glib::RefPtr<Gdk::Bitmap> _button_grundwerte_img_mask;
   Glib::RefPtr<Gdk::Pixmap> _button_grundwerte_img_pixmap = Gdk::Pixmap::create_from_xpm(get_default_colormap(), _button_grundwerte_img_mask, Dice_W100_trans_50_xpm);
   Gtk::Image *button_grundwerte_img = Gtk::manage(new class Gtk::Image(_button_grundwerte_img_pixmap, _button_grundwerte_img_mask));
   
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::ButtonElem("Eigen-\n"
		"schaften", *button_grundwerte_img, Gtk::Toolbar_Helpers::Callback0()));
   ...
   Glib::RefPtr<Gdk::Bitmap> _button_abg_werte_img_mask;
   Glib::RefPtr<Gdk::Pixmap> _button_abg_werte_img_pixmap = Gdk::Pixmap::create_from_xpm(get_default_colormap(), _button_abg_werte_img_mask, Dices2_trans_50_xpm);
   Gtk::Image *button_abg_werte_img = Gtk::manage(new class Gtk::Image(_button_abg_werte_img_pixmap, _button_abg_werte_img_mask));
   ...
   spinbutton_ap->set_name("spinbutton_ap");
   ...
   spinbutton_lp->set_name("spinbutton_lp");
   ...
   spinbutton_grad->set_name("spinbutton_grad");
   ...
   spinbutton_alter->set_name("spinbutton_alter");
   ...
   spinbutton_Cgewicht->set_name("spinbutton_Cgewicht");
   ...
   spinbutton_groesse->set_name("spinbutton_groesse");
   ...
   entry_herkunft->set_name("entry_herkunft");
   ...
   combo_stand->get_entry()->set_name("entry3");
   ...
   combo_stand->set_name("combo_stand");
   ...
   entry_spezialisierung->set_name("entry_spezialisierung");
   ...
   spinbutton_tage->set_name("spinbutton_tage");
   ...
   eventbox11->set_name("eventbox11");
   ...
   spinbutton_gg->set_name("spinbutton_gg");
   ...
   eventbox12->set_name("eventbox12");
   _tooltips.set_tip(*eventbox12, "Göttliche Gnade", "");
   eventbox12->add(*frame95);
   spinbutton_sg->set_name("spinbutton_sg");
   ...
   eventbox13->set_name("eventbox13");
   _tooltips.set_tip(*eventbox13, "Schicksalsgunst", "");
   eventbox13->add(*frame96);
   spinbutton_gfp->set_name("spinbutton_gfp");
   ...
   combo_hand->set_name("combo_hand");
   ...
   entry_bezeichnung->set_name("entry_bezeichnung");
   ...
   entry_merkmale->set_name("entry_merkmale");
   ...
   combo_spezies->get_entry()->set_name("combo_spezies");
   ...
   combo_spezies->set_name("combo_spezies");
   ...
   combo_spezies->get_entry()->set_text("");
   radiobutton_eigenschaften_standard->set_name("radiobutton_eigenschaften_standard");
   ...
   radiobutton_eigenschaften_standard->set_relief(Gtk::RELIEF_NORMAL);
   radiobutton_eigenschaften_standard->set_mode(true);
   radiobutton_eigenschaften_standard->set_active(true);
   radiobutton_eigenschaften_zuweisen->set_name("radiobutton_eigenschaften_zuweisen");
   ...
   radiobutton_eigenschaften_zuweisen->set_relief(Gtk::RELIEF_NORMAL);
   radiobutton_eigenschaften_zuweisen->set_mode(true);
   radiobutton_eigenschaften_zuweisen->set_active(false);
   radiobutton_eigenschaften_69->set_name("radiobutton_eigenschaften_69");
   ...
   radiobutton_eigenschaften_69->set_relief(Gtk::RELIEF_NORMAL);
   radiobutton_eigenschaften_69->set_mode(true);
   radiobutton_eigenschaften_69->set_active(false);
   vbox_gw_wuerfeln->set_name("vbox_gw_wuerfeln");
   ...
   button_grundwerte->set_name("button_grundwerte");
   ...
   radiobutton_mann->set_name("radiobutton_mann");
   radiobutton_mann->set_flags(Gtk::CAN_FOCUS);
   radiobutton_mann->set_relief(Gtk::RELIEF_NORMAL);
   radiobutton_mann->set_mode(true);
   radiobutton_mann->set_active(true);
   radiobutton_frau->set_name("radiobutton_frau");
   radiobutton_frau->set_flags(Gtk::CAN_FOCUS);
   radiobutton_frau->set_relief(Gtk::RELIEF_NORMAL);
   radiobutton_frau->set_mode(true);
   radiobutton_frau->set_active(false);
   vbox47->set_name("vbox47");
   vbox47->pack_start(*radiobutton_mann, Gtk::PACK_SHRINK, 0);
   vbox47->pack_start(*radiobutton_frau, Gtk::PACK_SHRINK, 0);
   combo_typ->get_entry()->set_name("combo_typ_");
   ...
   combo_typ->get_entry()->set_text("");
   combo_typ2->get_entry()->set_name("combo_typ2_");
   ...
   combo_typ2->set_name("combo_typ2");
   ...
   combo_typ2->get_entry()->set_text("");
   vbox46->set_name("vbox46");
   vbox46->pack_start(*combo_typ, Gtk::PACK_SHRINK, 0);
   vbox46->pack_start(*combo_typ2, Gtk::PACK_SHRINK, 0);
   radiobutton_stadt->set_name("radiobutton_stadt");
   radiobutton_stadt->set_flags(Gtk::CAN_FOCUS);
   radiobutton_stadt->set_relief(Gtk::RELIEF_NORMAL);
   radiobutton_stadt->set_mode(true);
   radiobutton_stadt->set_active(false);
   radiobutton_land->set_name("radiobutton_land");
   radiobutton_land->set_flags(Gtk::CAN_FOCUS);
   radiobutton_land->set_relief(Gtk::RELIEF_NORMAL);
   radiobutton_land->set_mode(true);
   radiobutton_land->set_active(false);
   vbox48->set_name("vbox48");
   vbox48->pack_start(*radiobutton_stadt, Gtk::PACK_SHRINK, 0);
   vbox48->pack_start(*radiobutton_land, Gtk::PACK_SHRINK, 0);
   button_abg_werte->set_name("button_abg_werte");
   button_abg_werte->set_flags(Gtk::CAN_FOCUS);
   eventbox_werte_edit->set_name("eventbox_werte_edit");
   fixed5->set_name("fixed5");
   toolbar2->set_name("toolbar2");
   toolbar2->set_tooltips(true);
   hseparator20->set_name("hseparator20");
   resistenz->set_name("resistenz");
   ...
   abwehr_wert->set_name("abwehr_wert");
   ...
   zaubern_wert->set_name("zaubern_wert");
   ...
   vseparator15->set_name("vseparator15");
   table29->set_name("table29");
   ...
   label_gestalt->set_name("label_gestalt");
   ...
   spinbutton_b->set_name("spinbutton_b");
   ...
   spinbutton_au->set_name("spinbutton_au");
   ...
   spinbutton_pa->set_name("spinbutton_pa");
   ...
   spinbutton_sb->set_name("spinbutton_sb");
   ...
   spinbutton_wk->set_name("spinbutton_wk");
   ...
   vseparator14->set_name("vseparator14");
   table27->set_name("table27");
   ...
   spinbutton_st->set_name("spinbutton_st");
   ...
   spinbutton_gs->set_name("spinbutton_gs");
   ...
   spinbutton_gw->set_name("spinbutton_gw");
   ...
   spinbutton_ko->set_name("spinbutton_ko");
   ...
   spinbutton_in->set_name("spinbutton_in");
   ...
   spinbutton_zt->set_name("spinbutton_zt");
   ...
   label_schmecken->set_name("label_schmecken");
   ...
   label_tasten->set_name("label_tasten");
   ...
   label_sehen->set_name("label_sehen");
   ...
   label_riechen->set_name("label_riechen");
   ...
   label_sechster_sinn->set_name("label_sechster_sinn");
   ...
   frame_wuerfelvariante->set_name("frame_wuerfelvariante");
   ...
   table_grundwerte->set_name("table_grundwerte");
   table_grundwerte->set_row_spacings(0);
   table_grundwerte->set_col_spacings(0);
   table_grundwerte->attach(*hseparator1, 0, 4, 2, 3, Gtk::FILL, Gtk::AttachOptions(), 0, 5);
   table_grundwerte->attach(*table67, 0, 4, 3, 4, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK, 10, 0);
   table_grundwerte->attach(*toolbar2, 0, 1, 1, 2, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK, 0, 0);
   table_grundwerte->attach(*hseparator20, 0, 4, 4, 5, Gtk::SHRINK|Gtk::FILL, Gtk::AttachOptions(), 0, 5);
   table_grundwerte->attach(*table68, 0, 4, 5, 6, Gtk::SHRINK|Gtk::FILL, Gtk::AttachOptions(), 0, 0);
   table_grundwerte->attach(*table65, 0, 4, 0, 1, Gtk::SHRINK|Gtk::FILL, Gtk::FILL, 0, 0);
   table_grundwerte->attach(*pixmap_dfr4, 4, 5, 0, 7, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK, 0, 0);
   table_grundwerte->attach(*frame_wuerfelvariante, 0, 1, 6, 7, Gtk::SHRINK|Gtk::FILL, Gtk::SHRINK|Gtk::FILL, 0, 0);
   hseparator1->show();
   entry_nameC->show();
   label613->show();
   frame30->show();
   ...
   entry_nameC->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_nameC_focus_out_event));
   entry_nameC->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_nameC_focus_in_event));
   spinbutton_ap->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_ap_activate), true);
   spinbutton_ap->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_ap_focus_out_event));
   spinbutton_ap->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_ap_focus_in_event));
   spinbutton_lp->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_lp_activate), true);
   spinbutton_lp->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_lp_focus_out_event));
   spinbutton_lp->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_lp_focus_in_event));
   spinbutton_grad->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_grad_activate), true);
   spinbutton_grad->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_grad_focus_out_event));
   spinbutton_grad->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_grad_focus_in_event));
   spinbutton_alter->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_alter_activate), true);
   spinbutton_alter->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_alter_focus_out_event));
   spinbutton_alter->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_alter_focus_in_event));
   spinbutton_Cgewicht->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_Cgewicht_activate), true);
   spinbutton_Cgewicht->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_Cgewicht_focus_out_event));
   spinbutton_Cgewicht->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_Cgewicht_focus_in_event));
   spinbutton_groesse->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_groesse_activate), true);
   spinbutton_groesse->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_groesse_focus_out_event));
   spinbutton_groesse->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_groesse_focus_in_event));
   entry_nameS->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_nameS_activate));
   entry_nameS->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_nameS_focus_out_event), true);
   entry_nameS->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_nameS_focus_in_event));
   entry_version->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_version_activate));
   entry_version->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_version_focus_out_event));
   entry_version->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_version_focus_in_event));
   entry_herkunft->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_herkunft_activate), true);
   entry_herkunft->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_herkunft_focus_out_event));
   entry_herkunft->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_herkunft_focus_in_event));
   combo_stand->get_entry()->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_combo_stand_activate));
   combo_stand->get_entry()->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_combo_stand_focus_out_event));
   entry_glaube->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_glaube_activate), true);
   entry_glaube->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_glaube_focus_out_event));
   entry_glaube->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_glaube_focus_in_event));
   ...
   entry_spezialisierung->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_spezialisierung_focus_out_event));
   entry_spezialisierung->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_spezialisierung_focus_in_event));
   spinbutton_tage->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_tage_activate), true);
   spinbutton_tage->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_tage_focus_out_event));
   spinbutton_tage->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_tage_focus_in_event));
   spinbutton_gg->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gg_activate));
   spinbutton_gg->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gg_focus_out_event));
   spinbutton_gg->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gg_focus_in_event));
   spinbutton_sg->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_sg_activate), true);
   spinbutton_sg->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_sg_focus_out_event));
   spinbutton_sg->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_sg_focus_in_event));
   spinbutton_gfp->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gfp_activate), true);
   spinbutton_gfp->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gfp_focus_out_event));
   spinbutton_gfp->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gfp_focus_in_event));
   combo_hand->get_entry()->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_combo_hand_activate));
   combo_hand->get_entry()->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_combo_hand_focus_out_event));
   entry_bezeichnung->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_bezeichnung_activate));
   entry_bezeichnung->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_bezeichnung_focus_out_event));
   entry_bezeichnung->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_bezeichnung_focus_in_event));
   entry_merkmale->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_merkmale_activate));
   entry_merkmale->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_merkmale_focus_out_event));
   entry_merkmale->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_entry_merkmale_focus_in_event));
   ...
   combo_typ->get_entry()->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_combo_typ__focus_out_event));
   combo_typ->get_entry()->signal_changed().connect(SigC::slot(*this, &table_grundwerte_glade::on_combo_typ__changed));
   combo_typ2->get_entry()->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_combo_typ2_activate));
   combo_typ2->get_entry()->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_combo_typ2_focus_out_event));
   combo_typ2->get_entry()->signal_changed().connect(SigC::slot(*this, &table_grundwerte_glade::on_combo_typ2__changed));
   radiobutton_stadt->signal_toggled().connect(SigC::slot(*this, &table_grundwerte_glade::on_radiobutton_stadt_land_toggled));
   radiobutton_land->signal_toggled().connect(SigC::slot(*this, &table_grundwerte_glade::on_radiobutton_stadt_land_toggled));
   button_abg_werte->signal_clicked().connect(SigC::slot(*this, &table_grundwerte_glade::on_abge_werte_setzen_clicked));
   button_grda1setzen->signal_clicked().connect(SigC::slot(*this, &table_grundwerte_glade::on_button_grda1setzen_clicked));
   spinbutton_b->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_b_activate), true);
   spinbutton_b->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_b_focus_out_event));
   spinbutton_b->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_b_focus_in_event));
   spinbutton_au->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_au_activate), true);
   spinbutton_au->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_au_focus_out_event));
   spinbutton_au->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_au_focus_in_event));
   spinbutton_pa->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_pa_activate), true);
   spinbutton_pa->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_pa_focus_out_event));
   spinbutton_pa->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_pa_focus_in_event));
   spinbutton_sb->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_sb_activate), true);
   spinbutton_sb->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_sb_focus_out_event));
   spinbutton_sb->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_sb_focus_in_event));
   spinbutton_wk->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_wk_activate), true);
   spinbutton_wk->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_wk_focus_out_event));
   spinbutton_wk->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_wk_focus_in_event));
   spinbutton_st->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_st_activate), true);
   spinbutton_st->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_st_focus_out_event));
   spinbutton_st->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_st_focus_in_event));
   spinbutton_gs->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gs_activate), true);
   spinbutton_gs->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gs_focus_out_event));
   spinbutton_gs->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gs_focus_in_event));
   spinbutton_gw->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gw_activate), true);
   spinbutton_gw->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gw_focus_out_event));
   spinbutton_gw->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_gw_focus_in_event));
   spinbutton_ko->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_ko_activate), true);
   spinbutton_ko->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_ko_focus_out_event));
   spinbutton_ko->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_ko_focus_in_event));
   spinbutton_in->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_in_activate), true);
   spinbutton_in->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_in_focus_out_event));
   spinbutton_in->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_in_focus_in_event));
   spinbutton_zt->signal_activate().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_zt_activate));
   spinbutton_zt->signal_focus_out_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_zt_focus_out_event));
   spinbutton_zt->signal_focus_in_event().connect(SigC::slot(*this, &table_grundwerte_glade::on_spinbutton_zt_focus_in_event));
}
