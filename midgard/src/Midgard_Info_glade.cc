...
{   
   ...
   label_laden = manage(new class Gtk::Label("label_laden"));
   
   Gtk::Table *table49 = manage(new class Gtk::Table(19, 4, false));
   ...
   label_laden->set_alignment(0, 0.5);
   label_laden->set_padding(0, 0);
   ...
   table49->attach(*pixmap61, 3, 4, 4, 15, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*label_laden, 3, 4, 2, 3, GTK_FILL, 0, 0, 0);
   ...
   glademm_set_Widget("label_laden", label_laden);
}
