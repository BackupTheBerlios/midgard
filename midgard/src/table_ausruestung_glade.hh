// generated 2005/9/23 15:53:09 CEST by christof@vesta.petig-baender.de
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
        class Gtk::ToggleToolButton * togglebutton_gruppe_neu;
#else //
        class Gtk::ToggleButton * togglebutton_gruppe_neu;
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
        class Gtk::ToggleToolButton * togglebutton_artikel_neu;
#else //
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
        class Gtk::ToolButton * button_ausruestung_loeschen;
#else //
...
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
        class Gtk::ToggleToolButton * checkbutton_ausruestung_geld;
#else //
        class Gtk::ToggleButton * checkbutton_ausruestung_geld;
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
        class Gtk::ToggleToolButton * togglebutton_unverkauflich;
#else //
