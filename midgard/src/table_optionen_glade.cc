...
{  table_optionen = this;
   frame_globale_optionen = Gtk::manage(new class frame_globale_optionen(_data));
   frame_ansicht = Gtk::manage(new class frame_ansicht(_data));
   ...
   frame_drucken = Gtk::manage(new class frame_drucken(_data));
   frame_icons = Gtk::manage(new class frame_icons(_data));
   
   Gtk::Table *table146 = Gtk::manage(new class Gtk::Table(2, 2, false));
   label578->set_name("label578");
   ...
   entry_speicher_verz->set_name("entry_speicher_verz");
   ...
   spinbutton_datei_history->set_name("spinbutton_datei_history");
   ...
   table_optionen->set_name("table_optionen");
