// $Id: table_grundwerte_gw_wuerfeln.cc,v 1.28 2002/12/12 11:20:14 christof Exp $
...
bool table_grundwerte::on_button_grundwerte_button_release_event(GdkEventButton *ev)
{
