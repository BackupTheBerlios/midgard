// generated 2001/8/17 22:57:23 CEST by thoma@Tiger.
...
{   Window_werte_editieren = this;
   ...
   Gtk::Adjustment *bo_gi_ein_adj = manage(new class Gtk::Adjustment(1, -20, 200, 1, 10, 10));
   ...
   Gtk::Table *table3 = manage(new class Gtk::Table(17, 12, false));
   ...
   label85->set_alignment(0, 0);
   label85->set_padding(0, 0);
   label84->set_alignment(0, 0);
   ...
   label173->set_alignment(0, 0);
   label173->set_padding(0, 0);
   label172->set_alignment(0, 0);
   label172->set_padding(0, 0);
   label171->set_alignment(0, 0);
   label171->set_padding(0, 0);
   label170->set_alignment(0, 0);
   ...
   table3->attach(*resistenz_ein, 7, 8, 10, 11, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   ...
   table3->attach(*label84, 0, 1, 11, 12, GTK_FILL, 0, 0, 0);
   table3->attach(*label83, 0, 1, 10, 11, GTK_FILL, 0, 0, 0);
   table3->attach(*label82, 0, 1, 9, 10, GTK_FILL, 0, 0, 0);
   table3->attach(*label81, 0, 1, 8, 9, GTK_FILL, 0, 0, 0);
   table3->attach(*label80, 0, 1, 6, 7, GTK_FILL, 0, 0, 0);
   table3->attach(*label79, 0, 1, 5, 6, GTK_FILL, 0, 0, 0);
   table3->attach(*label78, 0, 1, 4, 5, GTK_FILL, 0, 0, 0);
   ...
   table3->attach(*label86, 0, 1, 14, 15, GTK_FILL, 0, 0, 0);
   table3->attach(*label87, 0, 1, 15, 16, GTK_FILL, 0, 0, 0);
   table3->attach(*label90, 0, 1, 16, 17, GTK_FILL, 0, 0, 0);
   table3->attach(*label173, 3, 4, 16, 17, GTK_FILL, 0, 0, 0);
   table3->attach(*label172, 3, 4, 15, 16, GTK_FILL, 0, 0, 0);
   table3->attach(*label171, 3, 4, 14, 15, GTK_FILL, 0, 0, 0);
   table3->attach(*label170, 3, 4, 11, 12, GTK_FILL, 0, 0, 0);
   table3->attach(*label169, 3, 4, 10, 11, GTK_FILL, 0, 0, 0);
   table3->attach(*label168, 3, 4, 9, 10, GTK_FILL, 0, 0, 0);
   table3->attach(*label167, 3, 4, 8, 9, GTK_FILL, 0, 0, 0);
   table3->attach(*label166, 3, 4, 6, 7, GTK_FILL, 0, 0, 0);
   table3->attach(*label165, 3, 4, 5, 6, GTK_FILL, 0, 0, 0);
   table3->attach(*label164, 3, 4, 4, 5, GTK_FILL, 0, 0, 0);
   ...
   table3->attach(*label179, 6, 7, 10, 11, GTK_FILL, 0, 0, 0);
   table3->attach(*label180, 6, 7, 11, 12, GTK_FILL, 0, 0, 0);
   table3->attach(*label115, 9, 10, 15, 16, GTK_FILL, 0, 0, 0);
   table3->attach(*label114, 9, 10, 14, 15, GTK_FILL, 0, 0, 0);
   table3->attach(*label102, 9, 10, 11, 12, GTK_FILL, 0, 0, 0);
   table3->attach(*label101, 9, 10, 10, 11, GTK_FILL, 0, 0, 0);
   table3->attach(*label100, 9, 10, 9, 10, GTK_FILL, 0, 0, 0);
   table3->attach(*label99, 9, 10, 8, 9, GTK_FILL, 0, 0, 0);
   table3->attach(*label92, 9, 10, 4, 5, GTK_FILL, 0, 0, 0);
   ...
   table3->attach(*pixmap55, 11, 12, 0, 11, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table3->attach(*toolbar18, 11, 12, 16, 17, 0, 0, 0, 0);
   ...
   st_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::st_activate));
   ge_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::ge_activate));
   ko_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::ko_activate));
   in_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::in_activate));
   zt_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::zt_activate));
   au_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::au_activate));
   pa_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::pa_activate));
   sb_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::sb_activate));
   rw_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::rw_activate));
   hgw_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::hgw_activate));
   b_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::b_activate));
   lp_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::lp_activate));
   ap_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::ap_activate));
   grad_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::grad_activate));
   alter_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::alter_activate));
   gewicht_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::gewicht_activate));
   groesse_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::groesse_activate));
   gestalt_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::gestalt_activate));
   spezialisierung_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::spezial_activate));
   herkunft_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::her_activate));
   glaube_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::glau_activate));
   name_spieler_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::ns_activate));
   name_charakter_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::nc_activate));
   bo_au_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::bau_activate));
   bo_sc_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::sc_activate));
   bo_an_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::an_activate));
   bo_ab_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::ab_activate));
   bo_za_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::bzt_activate));
   bo_psy_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::psy_activate));
   bo_phs_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::phs_activate));
   bo_phk_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::phk_activate));
   bo_gi_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::gift_activate));
   lpbasis_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::lpb_activate));
   kaw_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::kaw_activate));
   gift_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::wgift_activate));
   resistenz_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::re_activate));
   zaubern_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::wza_activate));
   abwehr_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::wab_activate));
   ...
   wlw_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::wlw_activate));
