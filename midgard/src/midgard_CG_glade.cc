// generated 2002/4/12 13:23:54 CEST by thoma@Tiger.(none)
...
{  
   ...
   bearbeiten1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Rückgängig", "<Control>U"));
   ...
   laden1->activate.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_laden_release_event));
   speichern1->activate.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_speichern_release_event));
   drucken1->activate.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_speichern_release_event));
   beenden1->activate.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_schliessen_CG_clicked));
   bilder1->activate.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_bilder1_activate));
