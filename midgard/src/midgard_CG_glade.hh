...
protected:
        ...
        struct typauswahl
        {   enum enum_t 
	   {   Assassine, Barbar__Nordland, Barbar__Steppe, Barbar__Waldland, Barde, Gl_cksritter, H_ndler, Krieger, Ordenskrieger, Seefahrer, S_ldner, Spitzbube, Waldl_ufer, Beschw_rer__D_monen, Beschw_rer__Elementare, Druide, Heiler, Hexer__wei_, Hexer__grau, Hexer__schwarz, Magier, Priester__Herrschaft, Priester__Fruchtbarkeit, Priester__Weisheit, Priester__Meer, Priester__Krieg, Priester__Tod, Schamane, Thaumaturge, 
	   };
        };
