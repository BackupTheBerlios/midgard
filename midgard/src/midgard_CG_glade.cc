// generated 2001/12/20 10:53:38 CET by thoma@Tiger.
...
{   
   ...
   table_werte_wuerfeln = manage(new class Gtk::Table(2, 9, false));
   ...
   Gtk::Button *WidgetQHxGKHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table26->attach(*gw, 1, 2, 2, 3, 0, 0, 0, 0);
   ...
   _tooltips.set_tip(*button_grundwerte, "Linke Maustaste: 2x für jede Basiseigenschaft würfeln, höheres Ergebnis zählt. Rechte Maustaste: 9x würfeln und die besten sechs Ergebnisse frei verteilen", "");
   ...
   table_werte_wuerfeln->attach(*label_werte, 0, 9, 0, 1, GTK_FILL, 0, 0, 0);
   table_werte_wuerfeln->attach(*button_wert_1, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table_werte_wuerfeln->attach(*button_wert_2, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table_werte_wuerfeln->attach(*button_wert_3, 2, 3, 1, 2, GTK_FILL, 0, 0, 0);
   table_werte_wuerfeln->attach(*button_wert_4, 3, 4, 1, 2, GTK_FILL, 0, 0, 0);
   table_werte_wuerfeln->attach(*button_wert_5, 4, 5, 1, 2, GTK_FILL, 0, 0, 0);
   table_werte_wuerfeln->attach(*button_wert_6, 5, 6, 1, 2, GTK_FILL, 0, 0, 0);
   table_werte_wuerfeln->attach(*button_wert_7, 6, 7, 1, 2, GTK_FILL, 0, 0, 0);
   table_werte_wuerfeln->attach(*button_wert_8, 7, 8, 1, 2, GTK_FILL, 0, 0, 0);
   table_werte_wuerfeln->attach(*button_wert_9, 8, 9, 1, 2, GTK_FILL, 0, 0, 0);
   ...
   WidgetQHxGKHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
