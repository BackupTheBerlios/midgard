// generated 2002/2/13 19:18:56 CET by thoma@Tiger.
...
{   
   ...
   Gtk::VBox *vbox44 = manage(new class Gtk::VBox(true, 0));
   Gtk::Toolbar *toolbar2 = manage(new class Gtk::Toolbar(GTK_ORIENTATION_HORIZONTAL, GTK_TOOLBAR_BOTH));
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::WidgetElem(*vbox44));
   ...
   Gtk::Table *table_berufswahl = manage(new class Gtk::Table(1, 2, false));
   ...
   Gtk::Table *table123 = manage(new class Gtk::Table(2, 1, false));
   ...
   _tooltips.set_tip(*radiobutton_eigenschaften_69, "9x würfeln, die besten sech Ergebnisse frei verteilen.", "");
   radiobutton_eigenschaften_69->set_mode(false);
   vbox44->pack_start(*radiobutton_eigenschaften_standard, false, false, 0);
   vbox44->pack_start(*radiobutton_eigenschaften_zuweisen, false, false, 0);
   vbox44->pack_start(*radiobutton_eigenschaften_69, false, false, 0);
   ...
   table_berufswahl->attach(*vbox_berufsname, 1, 2, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table123->attach(*label_lernschma_titel, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   notebook_main->pages().push_back(Gtk::Notebook_Helpers::TabElem(*Midgard_Info, *pixmap_logo));
   ...
   table_9999->attach(*table_wizard, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   button_wiz_weiter->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_button_wizard_weiter_clicked));
   button_wiz_wiederholen->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_button_wizard_wiederholen_clicked));
   button_close_wizard->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_button_close_wizard_clicked));
