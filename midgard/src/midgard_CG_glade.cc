// generated 2001/11/27 11:53:57 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Button *WidgetqHmxGHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   optionmenu_eigenschaft = manage(new class Gtk::OptionMenu());
   ...
   table15->attach(*vpaned1, 0, 4, 1, 2, GTK_FILL, GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   {   
      ...
      Gtk::Menu *_m(manage(new Gtk::Menu()));
      Gtk::MenuItem *_mi;
      _mi = manage(new Gtk::MenuItem("Eigenschaft"));
      _m->append(*_mi);
      _mi->show();
      _mi->set_user_data((gpointer)0);
      optionmenu_eigenschaft->set_menu(*_m);
      optionmenu_eigenschaft->set_history(0);
   }
   table81->attach(*toolbar39, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table81->attach(*optionmenu_art, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table81->attach(*optionmenu_typ, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   table81->attach(*optionmenu_eigenschaft, 3, 4, 0, 1, GTK_FILL, 0, 0, 0);
   table78->attach(*scrolledwindow58, 0, 3, 1, 2, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   WidgetqHmxGHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
