// generated 2001/5/15 17:03:03 CEST by thoma@Tiger.
...
{   
   ...
   Gtk::Button *WidgetJMzKKHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table1->attach(*fixed3, 3, 4, 5, 6, GTK_FILL, GTK_FILL, 0, 0);
   table1->attach(*frame57, 3, 4, 6, 7, 0, GTK_FILL, 5, 0);
   ...
   table1->attach(*hseparator1, 0, 5, 4, 5, GTK_FILL, GTK_FILL, 0, 6);
   ...
   WidgetJMzKKHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
