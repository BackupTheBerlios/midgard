// generated 2002/2/13 15:37:11 CET by thoma@Tiger.
...
{   
   ...
   toolbar3->tools().push_back(Gtk::Toolbar_Helpers::WidgetElem(*button42));
   ...
   table_wizard = manage(new class Gtk::Table(1, 3, false));
   ...
   table_wizard->attach(*table129, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table_wizard->attach(*LogWinWizard, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
