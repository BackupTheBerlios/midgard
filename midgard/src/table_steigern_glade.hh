...
private:
        ...
        virtual void on_button_geld_s_toggled() = 0;
        virtual void on_spinbutton_aep_activate() = 0;
        virtual gint on_spinbutton_aep_focus_out_event(GdkEventFocus *ev) = 0;
        virtual gint on_spinbutton_aep_focus_in_event(GdkEventFocus *ev) = 0;
        virtual void on_spinbutton_kep_activate() = 0;
        virtual gint on_spinbutton_kep_focus_out_event(GdkEventFocus *ev) = 0;
        virtual gint on_spinbutton_kep_focus_in_event(GdkEventFocus *ev) = 0;
        virtual void on_spinbutton_zep_activate() = 0;
        virtual gint on_spinbutton_zep_focus_out_event(GdkEventFocus *ev) = 0;
        virtual gint on_spinbutton_zep_focus_in_event(GdkEventFocus *ev) = 0;
        virtual void on_spinbutton_gold_activate() = 0;
        virtual gint on_spinbutton_gold_focus_out_event(GdkEventFocus *ev) = 0;
        virtual gint on_spinbutton_gold_focus_in_event(GdkEventFocus *ev) = 0;
        virtual void on_spinbutton_silber_activate() = 0;
        virtual gint on_spinbutton_silber_focus_out_event(GdkEventFocus *ev) = 0;
        virtual gint on_spinbutton_silber_focus_in_event(GdkEventFocus *ev) = 0;
        virtual void on_spinbutton_kupfer_activate() = 0;
        virtual gint on_spinbutton_kupfer_focus_out_event(GdkEventFocus *ev) = 0;
        virtual gint on_spinbutton_kupfer_focus_in_event(GdkEventFocus *ev) = 0;
        ...
        virtual void on_button_gfp_s_toggled() = 0;
        virtual void on_button_EP_toggled() = 0;
        ...
        virtual void on_notebook_lernen_switch_page(Gtk::Notebook_Helpers::Page *p0, guint p1) = 0;
};
#endif
