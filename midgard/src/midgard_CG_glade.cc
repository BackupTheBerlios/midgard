// generated 2004/5/10 13:57:35 CEST by christof@puck.petig-baender.de
...
{  midgard_CG = this;
   ...
   Gtk::Label *toolitem1 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem1"));
   Gtk::Button *button9 = Gtk::manage(new class Gtk::Button("Öffnen"));
   button_speichern = new class ChoiceButton();
   
   Gtk::Label *toolitem2 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem2"));
   button_main_drucken = new class ChoiceButton();
   
   Gtk::Label *toolitem3 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem3"));
   button_undo = new class DoubleButton();
   
   Gtk::Label *toolitem4 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem4"));
   button_redo = new class DoubleButton();
   
   Gtk::Label *toolitem5 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem5"));
   Gtk::Label *separatortoolitem1 = Gtk::manage(new class Gtk::Label("GtkSeparatorToolItem separatortoolitem1"));
   Gtk::Button *button_menu = Gtk::manage(new class Gtk::Button("Menü"));
   Gtk::Button *button_info = Gtk::manage(new class Gtk::Button("Info"));
   Gtk::Button *button_html_hilfe = Gtk::manage(new class Gtk::Button("Anleitung"));
   Gtk::Label *separatortoolitem2 = Gtk::manage(new class Gtk::Label("GtkSeparatorToolItem separatortoolitem2"));
   button_schliessen = Gtk::manage(new class Gtk::Button("Schließen"));
   toolbar_top = Gtk::manage(new class Gtk::Toolbar());
   griff_toolbar_top = Gtk::manage(new class Gtk::HandleBox());
   
   Gtk::Image *image67 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-new"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image68 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-open"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *laden1 = NULL;
   Gtk::Image *image69 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-open"), Gtk::IconSize(1)));
   zuletzt_geladen_mi = NULL;
   Gtk::Image *image70 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-save"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *speichern1 = NULL;
   Gtk::Image *image71 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-save-as"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *speichern_unter_ = NULL;
   Gtk::Image *image72 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-convert"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image73 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-print"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image74 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-close"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *schlie__en1 = NULL;
   Gtk::Image *image75 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-quit"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image76 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-undo"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image77 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gnome-stock-about"), Gtk::IconSize(1)));
   ...
   {  Gtk::ToolItem *item = Gtk::manage(new Gtk::ToolItem);
      item->add(*toolitem1);
      toolbar_top->append(*item);
   }
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem1));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
...
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*button9));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
...
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem2));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
...
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem3));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
...
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem4));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
...
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem5));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
      
      Gtk::ToolItem *item = Gtk::manage(new Gtk::ToolItem);
      item->add(*separatortoolitem1);
      toolbar_top->append(*item);
   }
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*separatortoolitem1));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
      
      Gtk::ToolItem *item = Gtk::manage(new Gtk::ToolItem);
      item->add(*button_menu);
      toolbar_top->append(*item);
   }
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*button_menu));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
      
      Gtk::ToolItem *item = Gtk::manage(new Gtk::ToolItem);
      item->add(*button_info);
      toolbar_top->append(*item);
   }
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*button_info));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
      
      Gtk::ToolItem *item = Gtk::manage(new Gtk::ToolItem);
      item->add(*button_html_hilfe);
      toolbar_top->append(*item);
   }
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*button_html_hilfe));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
      
      Gtk::ToolItem *item = Gtk::manage(new Gtk::ToolItem);
      item->add(*separatortoolitem2);
      toolbar_top->append(*item);
   }
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*separatortoolitem2));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
      
      Gtk::ToolItem *item = Gtk::manage(new Gtk::ToolItem);
      item->add(*button_schliessen);
      toolbar_top->append(*item);
   }
#else //
   toolbar_top->tools().push_back(Gtk::Toolbar_Helpers::Element(*button_schliessen));
#endif //
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Neuer Abenteurer", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_N, Gdk::MOD1_MASK), *image67));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Öffnen", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_O, Gdk::CONTROL_MASK), *image68));
   laden1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("zuletzt geladen ...", *image69));
   zuletzt_geladen_mi = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Speichern", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_S, Gdk::CONTROL_MASK), *image70));
   speichern1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Speichern unter ...", *image71));
   speichern_unter_ = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Exportieren", *image72, *exportieren_main_menu));
   exportieren_main = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie1 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Drucken", *image73, *drucken1_menu));
   drucken1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie2 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Schließen", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_W, Gdk::CONTROL_MASK), *image74));
   schlie__en1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Beenden", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_Q, Gdk::CONTROL_MASK), *image75));
   beenden1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie5 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   bearbeiten1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Rückgängig", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_Z, Gdk::CONTROL_MASK), *image76));
   r__ckg__ngig1 = (Gtk::ImageMenuItem *)&bearbeiten1_menu->items().back();
   
   bearbeiten1_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Erneut/Vorwärts", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_R, Gdk::CONTROL_MASK)));
   ...
   hilfe1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Über MAGuS", *image77));
   ...
   main_menubar->items().push_back(Gtk::Menu_Helpers::MenuElem("Abenteurer"));
   ...
   image67->set_alignment(0.5,0.5);
   image67->set_padding(0,0);
   image68->set_alignment(0.5,0.5);
   image68->set_padding(0,0);
   image69->set_alignment(0.5,0.5);
   image69->set_padding(0,0);
   image70->set_alignment(0.5,0.5);
   image70->set_padding(0,0);
   image71->set_alignment(0.5,0.5);
   image71->set_padding(0,0);
   image72->set_alignment(0.5,0.5);
   image72->set_padding(0,0);
   image73->set_alignment(0.5,0.5);
   image73->set_padding(0,0);
   image74->set_alignment(0.5,0.5);
   image74->set_padding(0,0);
   image75->set_alignment(0.5,0.5);
   image75->set_padding(0,0);
   ...
   button_undo->signal_clicked().connect(SigC::slot(*this, &midgard_CG_glade::on_button_undo_clicked), false);
   button_undo->signal_secondpressed().connect(SigC::slot(*this, &midgard_CG_glade::on_undo_secondpressed), false);
   button_redo->signal_clicked().connect(SigC::slot(*this, &midgard_CG_glade::on_button_redo_clicked), false);
   button_redo->signal_secondpressed().connect(SigC::slot(*this, &midgard_CG_glade::on_redo_secondpressed), false);
   ...
   notebook_main->signal_switch_page().connect(SigC::slot(*this, &midgard_CG_glade::on_notebook_main_switch_page), false);
