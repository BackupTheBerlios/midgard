// generated 2002/6/30 8:54:38 CEST by thoma@Tiger.(none)
...
{  table_lernschema = this;
   ...
   button_ausruestung = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar3->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Ausrüstung", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Dice_Armor_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table163->attach(*checkbutton_einschraenkungen_zusatz, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
