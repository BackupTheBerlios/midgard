// generated 2002/2/13 12:57:32 CET by thoma@Tiger.
...
{   
   ...
   viewport38->set_shadow_type(GTK_SHADOW_NONE);
   viewport38->add(*LogWinWizard);
   ...
   table_wizard->attach(*scrolledwindow76, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
