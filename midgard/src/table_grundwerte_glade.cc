// generated 2004/5/10 10:28:08 CEST by christof@puck.petig-baender.de
...
{  table_grundwerte = this;
   ...
   Gtk::Label *toolitem6 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem6"));
   ...
   Gtk::Label *toolitem7 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem7"));
   button_grundwerte = Gtk::manage(new class Gtk::Button("Eigen-\n"
		"schaften"));
   ...
   Gtk::Label *toolitem8 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem8"));
   ...
   Gtk::Label *toolitem9 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem9"));
   ...
   Gtk::Label *toolitem10 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem10"));
   button_abg_werte = Gtk::manage(new class Gtk::Button("Abgeleitete\n"
		"Werte"));
   eventbox_werte_edit = Gtk::manage(new class Gtk::EventBox());
   
   Gtk::Label *toolitem11 = Gtk::manage(new class Gtk::Label("GtkToolItem toolitem11"));
   ...
   {  
      ...
      item->add(*toolitem6);
      toolbar2->append(*item);
   }
#else //
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem6));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
...
#else //
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem7));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
      
      Gtk::ToolItem *item = Gtk::manage(new Gtk::ToolItem);
      item->add(*button_grundwerte);
      toolbar2->append(*item);
   }
#else //
...
#else //
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem8));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
...
#else //
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem9));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
...
#else //
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem10));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
      
      Gtk::ToolItem *item = Gtk::manage(new Gtk::ToolItem);
      item->add(*button_abg_werte);
      toolbar2->append(*item);
   }
#else //
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::Element(*button_abg_werte));
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>2
   {  
...
#else //
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::Element(*toolitem11));
#endif //
