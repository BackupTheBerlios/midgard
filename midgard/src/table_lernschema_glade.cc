// generated 2003/4/25 11:39:17 CEST by christof@puck.petig-baender.de
// using glademm V2.0.0_cvs
//
...
{  table_lernschema = this;
   ...
   pixmap_dfr3 = Gtk::manage(new class Gtk::Image(MagusImage("Gross_dfr3_pre.xpm")));
   ...
   Gtk::Image *button_lernpunkte_img = Gtk::manage(new class Gtk::Image(MagusImage("Dice-2W6-trans-50.xpm")));
   ...
   Gtk::Image *togglebutton_lernpunkte_edit_img = Gtk::manage(new class Gtk::Image(MagusImage("Edit-trans-50.xpm")));
