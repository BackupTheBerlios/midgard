...
{   
   ...
   close_fertigkeiten = manage(new class Gtk::Button("Schließen"));
   ...
   fertigkeiten_clist_auswahl->set_column_justification(1, GTK_JUSTIFY_RIGHT);
   ...
   table6->attach(*close_fertigkeiten, 2, 3, 2, 3, 0, 0, 0, 0);
   ...
   close_fertigkeiten->clicked.connect(SigC::slot(static_cast<class Fertigkeiten_auswahl*>(this), &Fertigkeiten_auswahl::on_close_fertigkeiten_clicked));
}
