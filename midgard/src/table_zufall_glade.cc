// generated 2003/2/24 21:15:44 CET by christof@puck.petig-baender.de
...
{  table_zufall = this;
   ...
   table176->attach(*frame116, 0, 1, 0, 1, Gtk::EXPAND|Gtk::FILL, Gtk::EXPAND|Gtk::FILL, 0, 0);
   ...
   table175->attach(*table176, 0, 1, 1, 2, Gtk::SHRINK, Gtk::EXPAND|Gtk::SHRINK|Gtk::FILL, 0, 0);
