...
{   
   ...
   Gtk::Button *button36 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar11->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Auswählen", 0, 0, 0, 0, 0));
   toolbar11->tools().push_back(Gtk::Toolbar_Helpers::Space());
   
   Gtk::Button *button37 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar11->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Schließen", 0, 0, 0, 0, 0));
   Gtk::Pixmap *pixmap11 = manage(new class Gtk::Pixmap(Weapon_trans_50_xpm));
   Gtk::Table *table36 = manage(new class Gtk::Table(7, 4, false));
   ...
   table36->attach(*label_waffen_geld, 0, 4, 0, 1, GTK_FILL, 0, 6, 5);
   ...
   table36->attach(*pixmap10, 2, 3, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
   table36->attach(*toolbar11, 2, 4, 1, 3, GTK_FILL, 0, 0, 0);
   table36->attach(*pixmap11, 3, 4, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
