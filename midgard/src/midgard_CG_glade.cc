// generated 2002/1/22 11:38:02 CET by thoma@Tiger.
...
{   
   ...
   _tooltips.set_tip(*button69, "Grad, Ausdauer, Abwehr, Zaubern und Resistenz an die GFP anpassen und für eine Erhöhung der Basiswerte würfeln.", "");
   toolbar_steigern_kurz->set_space_size(5);
   toolbar_steigern_kurz->set_tooltips(true);
   table75->attach(*toolbar38, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
