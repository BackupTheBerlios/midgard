// generated 2002/5/6 21:19:36 CEST by thoma@Tiger.(none)
...
{  
   ...
   notebook_main->pages().push_back(Gtk::Notebook_Helpers::TabElem(*table139, *eventbox17));
