// generated 2002/12/11 16:38:27 CET by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   table72->attach(*eventbox_eppp_steigern, 1, 2, 1, 2, GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   ...
   togglebutton_spruchrolle->toggled.connect_after(SigC::slot(this, &table_steigern_glade::on_spruchrolle_toggled));
