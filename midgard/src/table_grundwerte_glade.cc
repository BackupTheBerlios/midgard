// generated 2006/8/14 13:10:54 CEST by christof@vesta.petig-baender.de
...
{  table_grundwerte = this;
   ...
   Gtk::Adjustment *spinbutton_gfp_adj = Gtk::manage(new class Gtk::Adjustment(0, 0, 1000000, 1, 10, 10));
...
#endif //
   label_last_edited = Gtk::manage(new class Gtk::Label("edited"));
   
   Gtk::Alignment *alignment3 = Gtk::manage(new class Gtk::Alignment(0.5, 0.5, 1, 1));
   Gtk::Label *label702 = Gtk::manage(new class Gtk::Label("Zuletzt gespeichert am"));
   Gtk::Frame *frame121 = Gtk::manage(new class Gtk::Frame());
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   Gtk::ToolItem *toolitem16 = Gtk::manage(new class Gtk::ToolItem());
#endif //
...
#else //
   toolbar2->tools().push_back(Gtk::Toolbar_Helpers::Element(*frame121));
   ...
   label623->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label623->set_width_chars(-1);
   ...
   label624->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label624->set_width_chars(-1);
   ...
   eventbox11->property_visible_window().set_value(false);
   ...
   eventbox12->property_visible_window().set_value(false);
   ...
   label628->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label628->set_width_chars(-1);
   ...
   eventbox13->property_visible_window().set_value(false);
   ...
   eventbox14->property_visible_window().set_value(false);
   ...
   label631->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label631->set_width_chars(-1);
   ...
   resistenz->set_ellipsize(Pango::ELLIPSIZE_NONE);
   resistenz->set_width_chars(-1);
   gift_wert->set_padding(10,0);
   gift_wert->set_justify(Gtk::JUSTIFY_CENTER);
   gift_wert->set_ellipsize(Pango::ELLIPSIZE_NONE);
   gift_wert->set_width_chars(-1);
   label199->set_alignment(0,0.5);
   label199->set_padding(10,0);
   label199->set_justify(Gtk::JUSTIFY_LEFT);
   label199->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label199->set_width_chars(-1);
   abwehr_wert->set_justify(Gtk::JUSTIFY_CENTER);
   abwehr_wert->set_ellipsize(Pango::ELLIPSIZE_NONE);
   abwehr_wert->set_width_chars(-1);
   label200->set_alignment(0,0.5);
   label200->set_padding(10,0);
   label200->set_justify(Gtk::JUSTIFY_LEFT);
   label200->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label200->set_width_chars(-1);
   zaubern_wert->set_justify(Gtk::JUSTIFY_CENTER);
   zaubern_wert->set_ellipsize(Pango::ELLIPSIZE_NONE);
   zaubern_wert->set_width_chars(-1);
   label274->set_alignment(0,0.5);
   label274->set_padding(10,0);
   label274->set_justify(Gtk::JUSTIFY_LEFT);
   label274->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label274->set_width_chars(-1);
   label275->set_alignment(0,0.5);
   label275->set_padding(10,0);
   label275->set_justify(Gtk::JUSTIFY_LEFT);
   label275->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label275->set_width_chars(-1);
   label543->set_justify(Gtk::JUSTIFY_CENTER);
   label543->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label543->set_width_chars(-1);
   ...
   label607->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label607->set_width_chars(-1);
   ...
   label181->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label181->set_width_chars(-1);
   label182->set_alignment(0,0.5);
   label182->set_padding(10,0);
   label182->set_justify(Gtk::JUSTIFY_LEFT);
   label182->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label182->set_width_chars(-1);
   bo_sc->set_justify(Gtk::JUSTIFY_CENTER);
   bo_sc->set_ellipsize(Pango::ELLIPSIZE_NONE);
   bo_sc->set_width_chars(-1);
   bo_an->set_justify(Gtk::JUSTIFY_CENTER);
   bo_an->set_ellipsize(Pango::ELLIPSIZE_NONE);
   bo_an->set_width_chars(-1);
   label184->set_alignment(0,0.5);
   label184->set_padding(10,0);
   label184->set_justify(Gtk::JUSTIFY_CENTER);
   label184->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label184->set_width_chars(-1);
   bo_ab->set_justify(Gtk::JUSTIFY_CENTER);
   bo_ab->set_ellipsize(Pango::ELLIPSIZE_NONE);
   bo_ab->set_width_chars(-1);
   label185->set_alignment(0,0.5);
   label185->set_padding(10,0);
   label185->set_justify(Gtk::JUSTIFY_CENTER);
   label185->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label185->set_width_chars(-1);
   bo_za->set_justify(Gtk::JUSTIFY_CENTER);
   bo_za->set_ellipsize(Pango::ELLIPSIZE_NONE);
   bo_za->set_width_chars(-1);
   bo_au->set_justify(Gtk::JUSTIFY_CENTER);
   bo_au->set_ellipsize(Pango::ELLIPSIZE_NONE);
   bo_au->set_width_chars(-1);
   label183->set_alignment(0,0.5);
   label183->set_padding(10,0);
   label183->set_justify(Gtk::JUSTIFY_LEFT);
   label183->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label183->set_width_chars(-1);
   label186->set_alignment(0,0.5);
   label186->set_justify(Gtk::JUSTIFY_CENTER);
   label186->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label186->set_width_chars(-1);
   label187->set_alignment(0,0.5);
   label187->set_justify(Gtk::JUSTIFY_CENTER);
   label187->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label187->set_width_chars(-1);
   label188->set_alignment(0,0.5);
   label188->set_padding(1,0);
   label188->set_justify(Gtk::JUSTIFY_LEFT);
   label188->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label188->set_width_chars(-1);
   bo_psy->set_justify(Gtk::JUSTIFY_CENTER);
   bo_psy->set_ellipsize(Pango::ELLIPSIZE_NONE);
   bo_psy->set_width_chars(-1);
   bo_phs->set_justify(Gtk::JUSTIFY_CENTER);
   bo_phs->set_ellipsize(Pango::ELLIPSIZE_NONE);
   bo_phs->set_width_chars(-1);
   bo_phk->set_justify(Gtk::JUSTIFY_CENTER);
   bo_phk->set_ellipsize(Pango::ELLIPSIZE_NONE);
   bo_phk->set_width_chars(-1);
   ...
   label608->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label608->set_width_chars(-1);
   ...
   label___->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label___->set_width_chars(-1);
   label_gestalt->set_justify(Gtk::JUSTIFY_CENTER);
   label_gestalt->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_gestalt->set_width_chars(-1);
   ...
   label204->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label204->set_width_chars(-1);
   label205->set_alignment(0,0.5);
   label205->set_justify(Gtk::JUSTIFY_LEFT);
   label205->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label205->set_width_chars(-1);
   label206->set_alignment(0,0.5);
   label206->set_justify(Gtk::JUSTIFY_LEFT);
   label206->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label206->set_width_chars(-1);
   label25->set_alignment(0,0.5);
   label25->set_justify(Gtk::JUSTIFY_LEFT);
   label25->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label25->set_width_chars(-1);
   label26->set_alignment(0,0.5);
   label26->set_justify(Gtk::JUSTIFY_LEFT);
   label26->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label26->set_width_chars(-1);
   label27->set_alignment(0,0.5);
   label27->set_justify(Gtk::JUSTIFY_LEFT);
   label27->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label27->set_width_chars(-1);
   kaw->set_justify(Gtk::JUSTIFY_CENTER);
   kaw->set_ellipsize(Pango::ELLIPSIZE_NONE);
   kaw->set_width_chars(-1);
   wlw->set_justify(Gtk::JUSTIFY_CENTER);
   wlw->set_ellipsize(Pango::ELLIPSIZE_NONE);
   wlw->set_width_chars(-1);
   ...
   label611->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label611->set_width_chars(-1);
   ...
   label_hoeren->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_hoeren->set_width_chars(-1);
   label_schmecken->set_justify(Gtk::JUSTIFY_CENTER);
   label_schmecken->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_schmecken->set_width_chars(-1);
   label_tasten->set_justify(Gtk::JUSTIFY_CENTER);
   label_tasten->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_tasten->set_width_chars(-1);
   label493->set_alignment(0,0.5);
   label493->set_justify(Gtk::JUSTIFY_LEFT);
   label493->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label493->set_width_chars(-1);
   label494->set_alignment(0,0.5);
   label494->set_justify(Gtk::JUSTIFY_LEFT);
   label494->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label494->set_width_chars(-1);
   label495->set_alignment(0,0.5);
   label495->set_justify(Gtk::JUSTIFY_LEFT);
   label495->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label495->set_width_chars(-1);
   label496->set_alignment(0,0.5);
   label496->set_padding(1,0);
   label496->set_justify(Gtk::JUSTIFY_LEFT);
   label496->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label496->set_width_chars(-1);
   label_sehen->set_justify(Gtk::JUSTIFY_CENTER);
   label_sehen->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_sehen->set_width_chars(-1);
   label498->set_alignment(0,0.5);
   label498->set_justify(Gtk::JUSTIFY_CENTER);
   label498->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label498->set_width_chars(-1);
   label_riechen->set_justify(Gtk::JUSTIFY_CENTER);
   label_riechen->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_riechen->set_width_chars(-1);
   label488->set_alignment(0,0.5);
   label488->set_justify(Gtk::JUSTIFY_LEFT);
   label488->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label488->set_width_chars(-1);
   label_sechster_sinn->set_justify(Gtk::JUSTIFY_CENTER);
   label_sechster_sinn->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_sechster_sinn->set_width_chars(-1);
   ...
   label633->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label633->set_width_chars(-1);
   ...
   combo_spezies->get_entry()->set_text("");
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolitem6->set_homogeneous(false);
   toolitem6->set_expand(false);
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   ...
   toolitem15->set_homogeneous(false);
   toolitem15->set_expand(false);
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolitem8->set_homogeneous(false);
   toolitem8->set_expand(false);
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolitem9->set_homogeneous(false);
   toolitem9->set_expand(false);
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
...
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolitem10->set_homogeneous(false);
   toolitem10->set_expand(false);
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   ...
   _tooltips.set_tip(*button_abg_werte, "abgeleitete Werte", "");
   button_abg_werte->set_homogeneous(true);
   button_abg_werte->set_expand(false);
   button_abg_werte->set_tooltip(_tooltips, "abgeleitete Werte");
#endif //
   button_abg_werte_img->show();
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   eventbox_werte_edit_dummy->set_homogeneous(false);
   eventbox_werte_edit_dummy->set_expand(false);
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   eventbox_werte_edit_dummy->add(*eventbox_werte_edit);
#endif //
   label_last_edited->set_justify(Gtk::JUSTIFY_LEFT);
   label_last_edited->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label_last_edited->set_width_chars(-1);
   alignment3->add(*label_last_edited);
   label702->set_justify(Gtk::JUSTIFY_LEFT);
   label702->set_use_markup(true);
   label702->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label702->set_width_chars(-1);
   frame121->set_shadow_type(Gtk::SHADOW_ETCHED_IN);
   frame121->set_label_align(0,0.5);
   frame121->add(*alignment3);
   frame121->set_label_widget(*label702);
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolitem16->set_homogeneous(false);
   toolitem16->set_expand(false);
#endif //
#if GTKMM_MAJOR_VERSION==2 && GTKMM_MINOR_VERSION>=3
   toolitem16->add(*frame121);
#endif //
