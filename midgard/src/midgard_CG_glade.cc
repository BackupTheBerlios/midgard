// generated 2003/10/13 0:04:18 CEST by christof@puck.petig-baender.de
...
{  midgard_CG = this;
   ...
   grundwerte_background->signal_realize().connect(SigC::slot(*this, &midgard_CG_glade::grundwerte_background), true);
