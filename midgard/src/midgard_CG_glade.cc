// generated 2002/2/13 10:34:22 CET by thoma@Tiger.
...
{   
   ...
   table127->attach(*notebook_main, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table127->attach(*table_wizard, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   eventbox_MCG->add(*table127);
