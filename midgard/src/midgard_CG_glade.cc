// generated 2002/5/27 21:59:20 CEST by thoma@Tiger.(none)
...
{  
   ...
   AbenteurerListe = new class SimpleTree(6, 6);
   
   Gtk::Table *table160 = manage(new class Gtk::Table(2, 1, false));
   Gtk::Viewport *viewport46 = manage(new class Gtk::Viewport());
   Gtk::ScrolledWindow *scrolledwindow85 = manage(new class Gtk::ScrolledWindow());
   ...
   table160->attach(*label597, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table160->attach(*AbenteurerListe, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   viewport46->set_shadow_type(GTK_SHADOW_NONE);
   viewport46->add(*table160);
   scrolledwindow85->set_policy(GTK_POLICY_AUTOMATIC, GTK_POLICY_AUTOMATIC);
   scrolledwindow85->add(*viewport46);
   ...
   table139->attach(*scrolledwindow85, 1, 2, 0, 1, GTK_FILL, GTK_FILL, 0, 0);
