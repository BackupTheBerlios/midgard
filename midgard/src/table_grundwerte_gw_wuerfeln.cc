// $Id: table_grundwerte_gw_wuerfeln.cc,v 1.42 2003/09/05 08:29:29 christof Exp $
...
void table_grundwerte::on_button_grundwerte()
{
  ...
  hauptfenster->getChar().getWizard().done(Wizard::GRUNDWERTE,hauptfenster->getChar().getAbenteurer());
