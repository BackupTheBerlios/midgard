// generated 2002/2/12 14:27:39 CET by thoma@Tiger.
...
{   
   ...
   table126->attach(*table116, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table126->attach(*frame101, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
