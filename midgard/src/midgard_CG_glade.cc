...
{   
   ...
   Gtk::Button *WidgetQHPwHHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table46->attach(*fixed4, 0, 1, 2, 3, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table46->attach(*checkbutton_info_fenster, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   frame61->set_label_align(0, 0);
   frame61->set_shadow_type(GTK_SHADOW_ETCHED_IN);
   frame61->add(*table46);
   table65->attach(*toolbar1, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table65->attach(*toolbar2, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table65->attach(*frame61, 1, 2, 0, 2, GTK_EXPAND, GTK_FILL, 0, 0);
   ...
   table30->attach(*vseparator16, 2, 3, 0, 5, GTK_EXPAND, GTK_FILL, 0, 0);
   frame57->set_label_align(0, 0);
   frame57->set_shadow_type(GTK_SHADOW_ETCHED_IN);
   frame57->add(*table30);
   table68->set_col_spacings(5);
   table68->attach(*frame54, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table68->attach(*frame55, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table68->attach(*frame56, 2, 3, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   table66->attach(*radiobutton_mann, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table66->attach(*radiobutton_frau, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table66->attach(*optionmenu_spezies, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   table1->attach(*table65, 0, 6, 0, 1, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table1->attach(*pixmap52, 4, 6, 1, 7, GTK_FILL, GTK_FILL, 0, 0);
   table1->attach(*hseparator1, 0, 4, 3, 4, GTK_FILL, GTK_FILL, 0, 0);
   table1->attach(*table67, 0, 4, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
   table1->attach(*hseparator20, 0, 4, 5, 6, GTK_FILL, GTK_FILL, 0, 0);
   table1->attach(*table68, 0, 4, 6, 7, GTK_FILL, GTK_FILL, 0, 0);
   table1->attach(*table66, 0, 4, 1, 3, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   WidgetQHPwHHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
