// generated 2003/7/9 10:47:43 CEST by thoma@Tiger.(none)
...
static const unsigned char gnome_stock_about_data[] = 
{       
};
...
{  midgard_CG = this;
   ...
   Gtk::Image *image9 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-new"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image10 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-open"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *laden1 = NULL;
   Gtk::Image *image11 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-save"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *speichern1 = NULL;
   Gtk::Image *image12 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-save-as"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *speichern_unter_ = NULL;
   Gtk::Image *image13 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-convert"), Gtk::IconSize(1)));
   Gtk::MenuItem *exportieren = NULL;
   Gtk::MenuItem *kompletter_export = NULL;
   ...
   Gtk::Image *image14 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-print"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image15 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-quit"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image16 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-undo"), Gtk::IconSize(1)));
   ...
   Glib::RefPtr<Gdk::PixbufLoader> _image17_loader=Gdk::PixbufLoader::create();
   _image17_loader->write(gnome_stock_about_data, sizeof gnome_stock_about_data);
   _image17_loader->close();
   
   Gtk::Image *image17 = Gtk::manage(new class Gtk::Image(_image17_loader->get_pixbuf()));
   ...
   exportieren_main_menu->items().push_back(Gtk::Menu_Helpers::MenuElem("Kompletter Export"));
   kompletter_export = (Gtk::MenuItem *)&exportieren_main_menu->items().back();
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Neuer Abenteurer", Gtk::Menu_Helpers::AccelKey(GDK_N, Gdk::MOD1_MASK), *image9));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Öffnen", Gtk::Menu_Helpers::AccelKey(GDK_O, Gdk::CONTROL_MASK), *image10));
   laden1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Speichern", Gtk::Menu_Helpers::AccelKey(GDK_S, Gdk::CONTROL_MASK), *image11));
   speichern1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Speichern unter ...", *image12));
   speichern_unter_ = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Exportieren", *image13, *exportieren_main_menu));
   exportieren_main = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie1 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Drucken", *image14, *drucken1_menu));
   drucken1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie2 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Beenden", Gtk::Menu_Helpers::AccelKey(GDK_Q, Gdk::CONTROL_MASK), *image15));
   beenden1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie5 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   bearbeiten1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Rückgängig", Gtk::Menu_Helpers::AccelKey(GDK_Z, Gdk::CONTROL_MASK), *image16));
   ...
   hilfe1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Info & Credits", *image17));
   ...
   kompletter_export->signal_activate().connect(SigC::slot(*this, &midgard_CG_glade::on_kompletter_export_activate));
