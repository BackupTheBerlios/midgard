// generated 2002/4/15 8:40:12 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::Table *table142 = manage(new class Gtk::Table(2, 1, false));
   ...
   table142->attach(*table145, 0, 1, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table142->attach(*frame_globale_optionen, 0, 1, 0, 1, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
