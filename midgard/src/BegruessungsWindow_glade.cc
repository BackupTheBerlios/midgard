...
{  
   ...
   Gtk::Image *pixmap178 = manage(new class Gtk::Image(_pixmap178_pixmap, _pixmap178_mask));
   ...
   Gtk::Image *pixmap179 = manage(new class Gtk::Image(_pixmap179_pixmap, _pixmap179_mask));
   ...
   Gtk::Image *pixmap180 = manage(new class Gtk::Image(_pixmap180_pixmap, _pixmap180_mask));
   ...
   Gtk::Image *pixmap182 = manage(new class Gtk::Image(_pixmap182_pixmap, _pixmap182_mask));
   ...
   Gtk::Image *pixmap181 = manage(new class Gtk::Image(_pixmap181_pixmap, _pixmap181_mask));
   ...
   Gtk::Image *pixmap186 = manage(new class Gtk::Image(_pixmap186_pixmap, _pixmap186_mask));
   ...
   BegruessungsWindow->set_position(Gtk::WIN_POS_CENTER);
   BegruessungsWindow->property_allow_shrink().set_value(true);
   BegruessungsWindow->property_allow_grow().set_value(true);
