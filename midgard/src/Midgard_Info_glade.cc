...
{  Midgard_Info = this;
   ...
   label340->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label340->set_width_chars(-1);
   versionsnummer->set_alignment(0,0.5);
   versionsnummer->set_justify(Gtk::JUSTIFY_CENTER);
   versionsnummer->set_ellipsize(Pango::ELLIPSIZE_NONE);
   versionsnummer->set_width_chars(-1);
   label341->set_justify(Gtk::JUSTIFY_LEFT);
   label341->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label341->set_width_chars(-1);
   ...
   label329->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label329->set_width_chars(-1);
   label327->set_alignment(0,0.5);
   label327->set_justify(Gtk::JUSTIFY_LEFT);
   label327->set_line_wrap(true);
   label327->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label327->set_width_chars(-1);
   label330->set_alignment(0,0.5);
   label330->set_justify(Gtk::JUSTIFY_LEFT);
   label330->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label330->set_width_chars(-1);
   label531->set_alignment(0,0.5);
   label531->set_justify(Gtk::JUSTIFY_LEFT);
   label531->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label531->set_width_chars(-1);
   label335->set_alignment(0,0.5);
   label335->set_justify(Gtk::JUSTIFY_CENTER);
   label335->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label335->set_width_chars(-1);
   label336->set_alignment(0,0.5);
   label336->set_justify(Gtk::JUSTIFY_CENTER);
   label336->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label336->set_width_chars(-1);
   label337->set_alignment(0,0.5);
   label337->set_justify(Gtk::JUSTIFY_CENTER);
   label337->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label337->set_width_chars(-1);
   label338->set_alignment(0,0.5);
   label338->set_justify(Gtk::JUSTIFY_CENTER);
   label338->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label338->set_width_chars(-1);
   ...
   label328->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label328->set_width_chars(-1);
   label401->set_alignment(0,0.5);
   label401->set_justify(Gtk::JUSTIFY_CENTER);
   label401->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label401->set_width_chars(-1);
   ...
   label342->set_ellipsize(Pango::ELLIPSIZE_NONE);
   label342->set_width_chars(-1);
