...
{  table_zufall = this;
   ...
   Gtk::Label *label609 = manage(new class Gtk::Label("Spezialist"));
   Gtk::Label *label610 = manage(new class Gtk::Label("Gebildeter"));
   Gtk::Label *label611 = manage(new class Gtk::Label(""));
   label_allgemein = manage(new class Gtk::Label("50%"));
   label_spezialist = manage(new class Gtk::Label("50%"));
   
   Gtk::Adjustment *hscale_spezial_allgemein_adj = manage(new class Gtk::Adjustment(50, 10, 90, 1, 1, 0));
   hscale_spezial_allgemein = manage(new class Gtk::HScale(*hscale_spezial_allgemein_adj));
   
   Gtk::Table *table171 = manage(new class Gtk::Table(2, 5, false));
   Gtk::EventBox *eventbox20 = manage(new class Gtk::EventBox());
   ...
   Gtk::Table *table172 = manage(new class Gtk::Table(3, 7, false));
   Gtk::EventBox *eventbox21 = manage(new class Gtk::EventBox());
   combo_prototyp = manage(new class Gtk::Combo());
   
   Gtk::Table *table165 = manage(new class Gtk::Table(5, 3, false));
   ...
   label609->set_alignment(0,0.5);
   label609->set_padding(0,0);
   label609->set_justify(GTK_JUSTIFY_CENTER);
   label609->set_line_wrap(false);
   label610->set_alignment(0,0.5);
   label610->set_padding(0,0);
   label610->set_justify(GTK_JUSTIFY_CENTER);
   label610->set_line_wrap(false);
   label611->set_alignment(0,0.5);
   label611->set_padding(0,0);
   label611->set_justify(GTK_JUSTIFY_CENTER);
   label611->set_line_wrap(false);
   label_allgemein->set_alignment(0,0.5);
   label_allgemein->set_padding(0,0);
   label_allgemein->set_justify(GTK_JUSTIFY_CENTER);
   label_allgemein->set_line_wrap(false);
   label_spezialist->set_alignment(0,0.5);
   label_spezialist->set_padding(0,0);
   label_spezialist->set_justify(GTK_JUSTIFY_CENTER);
   label_spezialist->set_line_wrap(false);
   hscale_spezial_allgemein->set_flags(GTK_CAN_FOCUS);
   hscale_spezial_allgemein->set_digits(0);
   hscale_spezial_allgemein->set_draw_value(false);
   hscale_spezial_allgemein->set_value_pos(GTK_POS_RIGHT);
   table171->set_row_spacings(0);
   table171->set_col_spacings(0);
   table171->attach(*label609, 0, 2, 1, 2, 0, 0, 0, 0);
   table171->attach(*label610, 3, 5, 1, 2, 0, 0, 0, 0);
   table171->attach(*label611, 2, 3, 1, 2, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table171->attach(*label_allgemein, 4, 5, 0, 1, 0, 0, 0, 0);
   table171->attach(*label_spezialist, 0, 1, 0, 1, 0, 0, 0, 0);
   table171->attach(*hscale_spezial_allgemein, 1, 4, 0, 1, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   _tooltips.set_tip(*eventbox20, "Ein 'Spezialist' steigert seine bereits gelernten Fertigkeiten, ein 'Gebildeter' lernt bevorzugt neue Fertigkeiten.", "");
   eventbox20->add(*table171);
   ...
   table172->attach(*spinbutton_fertigkeit, 0, 1, 2, 3, GTK_SHRINK, GTK_SHRINK, 0, 0);
   table172->attach(*spinbutton_waffen, 1, 2, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*spinbutton_waffen_grund, 2, 3, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*spinbutton_zauber, 3, 4, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*spinbutton_zauberwerk, 4, 5, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*spinbutton_sprachen, 5, 6, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*spinbutton_schriften, 6, 7, 2, 3, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table172->attach(*label612, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label613, 1, 2, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label614, 2, 3, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label615, 3, 4, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label616, 4, 5, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label617, 5, 6, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*label618, 6, 7, 1, 2, GTK_FILL, 0, 0, 0);
   table172->attach(*button_check100, 6, 7, 0, 1, GTK_FILL, 0, 0, 0);
   _tooltips.set_tip(*eventbox21, "Verteilung der GFP auf unterschiedliche Bereiche.", "");
   ...
   combo_prototyp->set_sensitive(false);
   ...
   table165->attach(*eventbox20, 0, 1, 2, 3, GTK_FILL, GTK_FILL, 0, 0);
   table165->attach(*eventbox21, 0, 3, 3, 4, GTK_SHRINK, GTK_SHRINK, 0, 0);
   table165->attach(*combo_prototyp, 0, 1, 1, 2, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   ...
   label610->show();
   label611->show();
   label_allgemein->show();
   label_spezialist->show();
   hscale_spezial_allgemein->show();
   table171->show();
   eventbox20->show();
   ...
   hscale_spezial_allgemein->button_release_event.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_hscale_spezial_allgemein_button_release_event));
   button_check100->clicked.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_button_check100_clicked));
   combo_prototyp->get_entry()->activate.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_combo_spezies_activate));
   combo_prototyp->get_entry()->focus_out_event.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_combo_spezies_focus_out_event));
   combo_prototyp->get_entry()->changed.connect(SigC::slot(static_cast<class table_zufall*>(this), &table_zufall::on_combo_spezies_changed));
}
