// generated 2001/11/8 10:30:43 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table77 = manage(new class Gtk::Table(17, 3, false));
   ...
   table77->attach(*label416, 0, 1, 6, 7, GTK_FILL, 0, 0, 0);
   table77->attach(*label417, 0, 1, 7, 8, GTK_FILL, 0, 0, 0);
   table77->attach(*label419, 0, 1, 10, 11, GTK_FILL, 0, 0, 0);
   table77->attach(*label418, 0, 1, 9, 10, GTK_FILL, 0, 0, 0);
   table77->attach(*label420, 0, 1, 8, 9, GTK_FILL, 0, 0, 0);
   ...
   table77->attach(*progressbar_zauber, 1, 2, 6, 7, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_sprache, 1, 2, 9, 10, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_zauberwerk, 1, 2, 7, 8, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_kido, 1, 2, 8, 9, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_schrift, 1, 2, 10, 11, GTK_FILL, 0, 0, 0);
   ...
   table77->attach(*label423, 0, 1, 11, 12, GTK_FILL, 0, 0, 0);
   table77->attach(*label424, 0, 1, 12, 13, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_pflicht, 1, 2, 11, 12, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_ausnahmen, 1, 2, 12, 13, GTK_FILL, 0, 0, 0);
   table77->attach(*label425, 0, 1, 13, 14, GTK_FILL, 0, 0, 0);
   table77->attach(*label426, 0, 1, 14, 15, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_spezies, 1, 2, 13, 14, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_typen, 1, 2, 14, 15, GTK_FILL, 0, 0, 0);
   table77->attach(*label427, 0, 1, 15, 16, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_grad, 1, 2, 15, 16, GTK_FILL, 0, 0, 0);
   table77->attach(*label428, 0, 1, 16, 17, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_spezial, 1, 2, 16, 17, GTK_FILL, 0, 0, 0);
   ...
   table49->attach(*label339, 1, 3, 16, 17, GTK_FILL, 0, 5, 5);
   table49->attach(*pixmap7, 0, 1, 16, 17, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table49->attach(*label401, 1, 3, 17, 18, GTK_FILL, 0, 5, 0);
   table49->attach(*pixmap57, 0, 1, 17, 18, GTK_FILL, GTK_FILL, 0, 0);
