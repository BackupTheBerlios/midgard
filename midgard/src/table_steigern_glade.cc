// generated 2002/12/19 19:05:32 CET by christof@puck.petig-baender.de
...
{  table_steigern = this;
   ...
   Gtk::Image *pixmap129 = Gtk::manage(new class Gtk::Image(_pixmap129_pixmap, _pixmap129_mask));
