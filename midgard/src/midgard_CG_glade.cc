// generated 2002/5/11 9:52:14 CEST by thoma@Tiger.(none)
...
{  
   ...
   spinbutton_zauber->focus_in_event.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_spinbutton_zaubern_focus_in_event));
   ...
   spinbutton_beruf->focus_in_event.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_spinbutton_beruf_focus_in));
