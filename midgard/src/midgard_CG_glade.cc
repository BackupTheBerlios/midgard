// generated 2006/8/14 10:07:50 CEST by christof@vesta.petig-baender.de
...
{  midgard_CG = this;
   ...
   Gtk::Image *image98 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-new"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image99 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-open"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *laden1 = NULL;
   Gtk::Image *image100 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-open"), Gtk::IconSize(1)));
   zuletzt_geladen_mi = NULL;
   Gtk::Image *image101 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-save"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *speichern1 = NULL;
   Gtk::Image *image102 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-save-as"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *speichern_unter_ = NULL;
   Gtk::Image *image103 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-convert"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image104 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-print"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image105 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-close"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *schlie__en1 = NULL;
   Gtk::Image *image106 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-quit"), Gtk::IconSize(1)));
   ...
   Gtk::Image *image107 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-undo"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *r__ckg__ngig1 = NULL;
   Gtk::Image *image108 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-redo"), Gtk::IconSize(1)));
   Gtk::ImageMenuItem *erneut_vorw__rts1 = NULL;
   ...
   Gtk::Image *image109 = Gtk::manage(new class Gtk::Image(Gtk::StockID("gtk-about"), Gtk::IconSize(1)));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("_Neuer Abenteurer", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_N, Gdk::MOD1_MASK), *image98));
   ...
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Ö_ffnen", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_O, Gdk::CONTROL_MASK), *image99));
   laden1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("zuletzt geladen ...", *image100));
   zuletzt_geladen_mi = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("_Speichern", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_S, Gdk::CONTROL_MASK), *image101));
   speichern1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Speichern _unter ...", *image102));
   speichern_unter_ = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Exportieren", *image103, *exportieren_main_menu));
   exportieren_main = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie1 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("_Drucken", *image104, *drucken1_menu));
   drucken1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie2 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("S_chließen", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_W, Gdk::CONTROL_MASK), *image105));
   schlie__en1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("_Beenden", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_Q, Gdk::CONTROL_MASK), *image106));
   beenden1 = (Gtk::ImageMenuItem *)&magus1_menu->items().back();
   
   magus1_menu->items().push_back(Gtk::Menu_Helpers::SeparatorElem());
   trennlinie5 = (Gtk::MenuItem *)&magus1_menu->items().back();
   
   bearbeiten1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("_Rückgängig", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_Z, Gdk::CONTROL_MASK), *image107));
   r__ckg__ngig1 = (Gtk::ImageMenuItem *)&bearbeiten1_menu->items().back();
   
   bearbeiten1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("_Erneut/Vorwärts", Gtk::GMM_GTKMM_22_24(Menu_Helpers::,)AccelKey(GDK_R, Gdk::CONTROL_MASK), *image108));
   erneut_vorw__rts1 = (Gtk::ImageMenuItem *)&bearbeiten1_menu->items().back();
   ...
   hilfe1_menu->items().push_back(Gtk::Menu_Helpers::ImageMenuElem("Über MAGuS", *image109));
   ...
   image98->set_alignment(0.5,0.5);
   image98->set_padding(0,0);
   image99->set_alignment(0.5,0.5);
   image99->set_padding(0,0);
   image100->set_alignment(0.5,0.5);
   image100->set_padding(0,0);
   image101->set_alignment(0.5,0.5);
   image101->set_padding(0,0);
   image102->set_alignment(0.5,0.5);
   image102->set_padding(0,0);
   image103->set_alignment(0.5,0.5);
   image103->set_padding(0,0);
   image104->set_alignment(0.5,0.5);
   image104->set_padding(0,0);
   image105->set_alignment(0.5,0.5);
   image105->set_padding(0,0);
   image106->set_alignment(0.5,0.5);
   image106->set_padding(0,0);
   image107->set_alignment(0.5,0.5);
   image107->set_padding(0,0);
   image108->set_alignment(0.5,0.5);
   image108->set_padding(0,0);
   image109->set_alignment(0.5,0.5);
   image109->set_padding(0,0);
   ...
   label_notebook_grundwerte->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   eventbox_grundwerte->property_visible_window().set_value(false);
   ...
   label_notebook_lernen->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   eventbox_lernen->property_visible_window().set_value(false);
   ...
   label_notebook_steigern->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   eventbox_steigern->property_visible_window().set_value(false);
   ...
   label_notebook_beschreibung->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   eventbox_beschreibung->property_visible_window().set_value(false);
   ...
   label_notebook_ausruestung->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   eventbox_ausruestung->property_visible_window().set_value(false);
   ...
   label_notebook_optionen->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   eventbox_optionen->property_visible_window().set_value(false);
   ...
   label_notebook_info->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   eventbox_credits->property_visible_window().set_value(false);
   ...
   label_notebook_news->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   eventbox_geschichte->property_visible_window().set_value(false);
   ...
   label603->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   eventbox_zufall->property_visible_window().set_value(false);
   ...
   label_status->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label_wizard->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   midgard_CG->set_icon(MagusImage("MAGUS_Logo_Small.xpm"));
