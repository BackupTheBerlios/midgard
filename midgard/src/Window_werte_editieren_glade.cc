// generated 2001/12/14 19:44:27 CET by thoma@Tiger.
...
{   Window_werte_editieren = this;
   ...
   Gtk::Table *table3 = manage(new class Gtk::Table(18, 12, false));
   ...
   table3->attach(*resistenz_ein, 7, 8, 11, 12, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   ...
   table3->attach(*label179, 6, 7, 11, 12, GTK_FILL, 0, 0, 0);
   ...
   table3->attach(*toolbar18, 11, 12, 17, 18, 0, 0, 0, 0);
   ...
   gw_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::gw_activate));
   ...
   wk_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::wk_activate));
   gs_ein->activate.connect(SigC::slot(static_cast<class Window_werte_editieren*>(this), &Window_werte_editieren::gs_activate));
}
