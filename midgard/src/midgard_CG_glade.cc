...
{   
   ...
   Gtk::Label *WidgetQWWJGHQ = manage(new class Gtk::Label("Fertigkeiten"));
   ...
   fixed4->put(*checkbutton_Eschar, 0, 0);
   fixed4->put(*checkbutton_Rawindra, 0, 16);
   ...
   table1->attach(*frame61, 3, 4, 0, 1, GTK_FILL, GTK_FILL, 10, 0);
   ...
   table34->attach(*scrolledwindow40, 0, 3, 1, 2, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   ...
   frame40->add(*table15);
   WidgetQWWJGHQ->set_alignment(0.5, 0.5);
   WidgetQWWJGHQ->set_padding(0, 0);
   ...
   vbox17->pack_start(*spruchrolle, false, false, 0);
   vbox17->pack_start(*radio_spruchrolle_wuerfeln, false, false, 0);
   vbox17->pack_start(*radio_spruchrolle_auto, false, false, 0);
   frame60->set_label_align(0, 0);
   frame60->set_shadow_type(GTK_SHADOW_ETCHED_IN);
   frame60->add(*vbox17);
   table44->attach(*frame60, 1, 2, 0, 3, 0, GTK_FILL, 23, 0);
   table21->attach(*table44, 0, 1, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table21->attach(*zauber_laden, 1, 2, 0, 1, GTK_FILL, 0, 10, 0);
   ...
   notebook2->pages().push_back(Gtk::Notebook_Helpers::TabElem(*frame40, *WidgetQWWJGHQ));
