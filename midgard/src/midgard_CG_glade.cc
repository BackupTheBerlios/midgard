// generated 2002/2/5 16:44:55 CET by thoma@Tiger.
...
{   
   ...
   notebook3 = manage(new class Gtk::Notebook());
   ...
   Gtk::Label *label544 = manage(new class Gtk::Label("Ausgewählte Fertigkeiten\n"
		"und Zauber"));
   ...
   Gtk::Label *label536 = manage(new class Gtk::Label("Untypische Fertigkeiten\n"
		"auswählen"));
   Gtk::Pixmap *pixmap114 = manage(new class Gtk::Pixmap(Fert_Laufen_32_xpm));
   Gtk::HBox *hbox50 = manage(new class Gtk::HBox(false, 0));
   button_untyp_fertigkeiten = manage(new class Gtk::Button());
   ...
   table_kido_lernschema = manage(new class Gtk::Table(1, 2, false));
   ...
   Gtk::Table *table112 = manage(new class Gtk::Table(2, 4, false));
   ...
   table_kido_lernen->attach(*scrolledwindow46, 0, 2, 1, 2, GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table_beruf->attach(*scrolledwindow43, 0, 4, 1, 2, GTK_SHRINK|GTK_FILL, GTK_EXPAND|GTK_SHRINK|GTK_FILL, 0, 0);
   ...
   table_kido_lernschema->attach(*button_kido_auswahl, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table_kido_lernschema->attach(*optionmenu_KiDo_Stile, 1, 2, 0, 1, GTK_SHRINK, GTK_SHRINK, 0, 0);
   ...
   hbox53->pack_start(*label539, true, false, 0);
   button27->add(*hbox53);
   ...
   table_zauber_lernschema->attach(*button27, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table_zauber_lernschema->attach(*option_magier_spezialgebiet, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   ...
   hbox59->pack_start(*label545, false, false, 0);
   ...
   hbox60->pack_start(*label546, false, false, 0);
   hbox60->pack_start(*pixmap119);
   button72->add(*hbox60);
   label_spezialwaffe->set_alignment(0, 0.5);
   label_spezialwaffe->set_padding(21, 0);
   table_lernschema_buttons->attach(*button28, 0, 1, 4, 5, GTK_FILL, 0, 0, 0);
   table_lernschema_buttons->attach(*button_untyp_fertigkeiten, 0, 1, 3, 4, GTK_FILL, 0, 0, 0);
   table_lernschema_buttons->attach(*button42, 0, 1, 0, 1, GTK_FILL, 0, 0, 0);
   table_lernschema_buttons->attach(*button29, 0, 1, 8, 9, GTK_FILL, 0, 0, 0);
   table_lernschema_buttons->attach(*vbox_berufsname, 0, 1, 9, 10, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table_lernschema_buttons->attach(*table_kido_lernschema, 0, 1, 5, 6, GTK_EXPAND|GTK_FILL, 0, 0, 0);
   table_lernschema_buttons->attach(*table_zauber_lernschema, 0, 1, 6, 7, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table_lernschema_buttons->attach(*button71, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   table_lernschema_buttons->attach(*button72, 0, 1, 1, 2, GTK_FILL, 0, 0, 0);
   table_lernschema_buttons->attach(*label_spezialwaffe, 0, 1, 7, 8, GTK_FILL, 0, 0, 0);
   ...
   table112->attach(*label544, 1, 2, 0, 1, GTK_FILL, 0, 0, 0);
   table112->attach(*table_lernschema_buttons, 2, 3, 1, 2, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table112->attach(*label_lernschma_titel, 3, 4, 0, 1, GTK_FILL, 0, 0, 0);
   table112->attach(*scrolledwindow72, 3, 4, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   table112->attach(*scrolledwindow73, 1, 2, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   table112->attach(*scrolledwindow59, 0, 1, 1, 2, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   table4->attach(*hseparator13, 0, 4, 3, 4, GTK_FILL, 0, 0, 5);
   table4->attach(*notebook3, 1, 4, 4, 5, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table4->attach(*frame24, 0, 4, 2, 3, 0, 0, 0, 0);
   table4->attach(*hseparator14, 0, 4, 1, 2, GTK_FILL, 0, 0, 3);
   table4->attach(*vbox26, 3, 4, 0, 1, 0, 0, 0, 0);
   table4->attach(*toolbar3, 0, 3, 0, 1, 0, 0, 6, 5);
   table4->attach(*table112, 0, 1, 4, 5, GTK_FILL, GTK_FILL, 0, 0);
   ...
   button_untyp_fertigkeiten->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_untyp_fertigkeiten_wahl_clicked));
   ...
   button71->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_allgemein_fertigkeiten_wahl_clicked));
   button72->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_fach_fertigkeiten_wahl_clicked));
