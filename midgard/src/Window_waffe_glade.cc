// generated 2002/4/30 15:50:37 CEST by thoma@Tiger.(none)
...
{  
   ...
   Gtk::AccelGroup *Window_waffe_accgrp = Gtk::AccelGroup::create();
   _data = new GlademmData(Window_waffe_accgrp);
   ...
   Window_waffe->add_accel_group(*(_data->getAccelGroup()));
   ...
   clist_waffe->unselect_row.connect(SigC::slot(static_cast<class Window_waffe*>(this), &Window_waffe::on_clist_waffe_unselect_row));
