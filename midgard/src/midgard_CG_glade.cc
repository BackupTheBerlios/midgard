...
{  midgard_CG = this;
   ...
   pixmap167 = manage(new class Gtk::Pixmap(Regio_Hausregel_50_xpm));
   ...
   Gtk::Button *button12 = static_cast<Gtk::Button *>(toolbar_top->tools().back()->get_widget());
   ...
   _tooltips.set_tip(*eventbox_zufall, "Optionen", "");
