// generated 2002/10/15 23:20:45 CEST by thoma@Tiger.(none)
...
{  table_zufall = this;
   ...
   Gtk::Label *label624 = manage(new class Gtk::Label("Verteilung auf"));
   ...
   label624->set_alignment(0,0.5);
   label624->set_padding(0,0);
   label624->set_justify(GTK_JUSTIFY_CENTER);
   ...
   table172->attach(*label624, 1, 6, 6, 7, GTK_FILL, 0, 0, 0);
   table172->attach(*label625, 1, 3, 7, 8, GTK_FILL, 0, 0, 0);
   table172->attach(*label626, 3, 5, 7, 8, GTK_FILL, 0, 0, 0);
   table172->attach(*label627, 5, 7, 7, 8, GTK_FILL, 0, 0, 0);
   ...
   table172->attach(*spinbutton_grund, 1, 2, 8, 9, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table172->attach(*spinbutton_standard, 3, 4, 8, 9, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
   table172->attach(*spinbutton_ausnahme, 5, 6, 8, 9, GTK_EXPAND|GTK_SHRINK|GTK_FILL, GTK_SHRINK, 0, 0);
