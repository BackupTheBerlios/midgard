...
{  
   ...
   Gtk::AccelGroup *KiDo_auswahl_accgrp = Gtk::AccelGroup::create();
   _data = new GlademmData(KiDo_auswahl_accgrp);
   ...
   KiDo_auswahl->set_modal(true);
   KiDo_auswahl->add_accel_group(*(_data->getAccelGroup()));
