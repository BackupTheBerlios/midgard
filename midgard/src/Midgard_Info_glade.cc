// generated 2001/5/24 12:13:29 CEST by thoma@Tiger.
...
{   
   ...
   Gtk::Label *label401 = manage(new class Gtk::Label("Der MCG ist Copyleft 2001 by Malte Thoma, Greven"));
   Gtk::Pixmap *pixmap57 = manage(new class Gtk::Pixmap(pinguin_xpm));
   Gtk::Label *label342 = manage(new class Gtk::Label("Hier würde ich gerne das offizielle Midgard Logo \n"
		"einfügen, habe aber noch(?) keine Erlaubnis von Elsa :-("));
   Gtk::Table *table49 = manage(new class Gtk::Table(18, 3, false));
   ...
   table49->attach(*label338, 2, 3, 13, 14, GTK_FILL, 0, 0, 0);
   table49->attach(*pixmap5, 0, 1, 11, 12, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*pixmap6, 0, 1, 13, 14, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table49->attach(*label337, 1, 2, 13, 14, GTK_FILL, 0, 5, 0);
   table49->attach(*hseparator18, 0, 3, 14, 15, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
   table49->attach(*label339, 1, 3, 15, 16, GTK_FILL, 0, 5, 5);
   ...
   table49->attach(*toolbar32, 2, 3, 17, 18, 0, 0, 0, 0);
   ...
   table49->attach(*label400, 2, 3, 12, 13, GTK_FILL, 0, 0, 0);
   table49->attach(*pixmap56, 0, 1, 12, 13, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*label391, 1, 2, 9, 10, GTK_FILL, 0, 5, 0);
   table49->attach(*label399, 1, 2, 12, 13, GTK_FILL, 0, 5, 0);
   table49->attach(*label401, 1, 3, 16, 17, GTK_FILL, 0, 5, 0);
   table49->attach(*pixmap57, 0, 1, 16, 17, GTK_FILL, GTK_FILL, 0, 0);
   table49->attach(*label342, 0, 3, 0, 1, 0, 0, 5, 0);
