// generated 2001/12/31 9:20:05 CET by thoma@Tiger.
...
protected:
	   ...
	   {   STAND, Unfrei, Volk, Mittelschicht, Adel, 
        ...
        class Gtk::SpinButton *wk_ein;
        class Gtk::SpinButton *gs_ein;
        class Gtk::OptionMenu *optionmenu_hand;
        struct optionmenu_hand
        {   enum enum_t 
	   {   Rechtsh_nder, Linksh_nder, Beidh_ndig, 
	   };
        };
        class Gtk::SpinButton *gg_ein;
        class Gtk::SpinButton *sg_ein;
        class Gtk::SpinButton *resistenz_ein;
        class Gtk::SpinButton *spinbutton_steigertage;
