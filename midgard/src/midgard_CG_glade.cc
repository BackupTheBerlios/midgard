// generated 2001/8/4 19:43:03 CEST by thoma@Tiger.
...
{   
   ...
   Gtk::Button *button_fertigkeiten_sort = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar14->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Fertigkeiten\n"
		"sortieren", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Skills_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *button_waffen_sort = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar4->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Waffen sortieren", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Weapon_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *button_zauber_sort = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar10->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Zauber\n"
		"sortieren", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Zauber_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *WidgetqnJwGHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   toolbar34->tools().push_back(Gtk::Toolbar_Helpers::Space());
   
   Gtk::Button *button_kido_sort = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken sortieren", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(KiDo_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *button33 = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar9->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Sprachen & Schriften \n"
		"laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(LoadLang_u_Font_trans_50_xpm))->gtkobj()), 0, 0));
   toolbar9->tools().push_back(Gtk::Toolbar_Helpers::Space());
   
   Gtk::Button *button_sprache_sort = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar9->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Sprachen \n"
		"sortieren", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Lang_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   WidgetqnJwGHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
