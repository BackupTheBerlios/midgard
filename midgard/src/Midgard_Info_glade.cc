// generated 2001/11/11 15:20:42 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Table *table77 = manage(new class Gtk::Table(21, 3, false));
   ...
   table77->attach(*label431, 0, 1, 2, 3, GTK_FILL, 0, 0, 0);
   table77->attach(*progressbar_beruf, 1, 2, 2, 3, GTK_FILL, 0, 0, 0);
