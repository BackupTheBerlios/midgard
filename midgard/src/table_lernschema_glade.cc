...
{  table_lernschema = this;
   ...
   button_ausruestung = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar3->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Ausrüstung", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Dice_Ausruest_50_xpm))->gtkobj()), 0, 0));
