...
{  table_optionen = this;
   ...
   label578->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label576->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label577->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label599->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label703->set_ellipsize(Pango::ELLIPSIZE_NONE);
   ...
   label575->set_ellipsize(Pango::ELLIPSIZE_NONE);
