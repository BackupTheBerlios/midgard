// generated 2002/1/22 15:38:42 CET by thoma@Tiger.
...
#include "../pixmaps/EP-Eingabe-50.xpm"
...
{   
   ...
   Gtk::Button *button_grad_abwehr = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar_steigern_lang2->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Abwehr", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Armor_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   Gtk::Button *button_EP = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar37->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Erfahrungspunkte\n"
		"eingeben", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(EP_Eingabe_50_xpm))->gtkobj()), 0, 0));
   ...
   table67->attach(*frame15, 2, 3, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   ...
   table67->attach(*frame98, 2, 3, 3, 4, GTK_FILL, GTK_EXPAND|GTK_FILL, 0, 0);
