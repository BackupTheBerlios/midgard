...
{  table_grundwerte = this;
   ...
   eventbox11->property_above_child().set_value(false);
   ...
   eventbox12->property_above_child().set_value(false);
   ...
   eventbox13->property_above_child().set_value(false);
   ...
   eventbox14->property_above_child().set_value(false);
   ...
   label_last_edited->set_line_wrap(false);
   label_last_edited->set_use_markup(false);
   label_last_edited->set_selectable(false);
   ...
   label702->set_line_wrap(false);
   label702->set_use_markup(true);
   label702->set_selectable(false);
