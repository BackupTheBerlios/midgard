// generated 2001/12/21 22:29:14 CET by thoma@Tiger.
...
{   
   ...
   Gtk::Button *WidgetjwWyHHQ = Gtk::wrap((GtkButton*)gtk_toolbar_append_element(GTK_TOOLBAR(toolbar34->gtkobj()), GTK_TOOLBAR_CHILD_BUTTON, 0, "Techniken laden", 0, 0, GTK_WIDGET(manage(new Gtk::Pixmap(Load_Kido_trans_50_xpm))->gtkobj()), 0, 0));
   ...
   table68->attach(*frame56, 3, 4, 0, 1, GTK_FILL, 0, 0, 0);
   table68->attach(*frame55, 2, 3, 0, 1, GTK_FILL, 0, 0, 0);
   table68->attach(*frame84, 1, 2, 0, 1, GTK_EXPAND|GTK_FILL, GTK_FILL, 0, 0);
   ...
   frame78->add(*table42);
   radio_fert_reduzieren->set_flags(GTK_CAN_FOCUS);
   radio_fert_verlernen->set_flags(GTK_CAN_FOCUS);
   pixmap35->set_alignment(0.5, 0.5);
   pixmap35->set_padding(0, 0);
   pixmap36->set_alignment(0.5, 0.5);
   pixmap36->set_padding(0, 0);
   radio_fert_steigern->set_flags(GTK_CAN_FOCUS);
   ...
   frame43->add(*table53);
   radiobutton_praxis_wuerfeln_fertigkeiten->set_flags(GTK_CAN_FOCUS);
   radiobutton_praxis_wuerfeln_fertigkeiten->set_active(true);
   pixmap44->set_alignment(0.5, 0.5);
   pixmap44->set_padding(0, 0);
   togglebutton_praxispunkte_fertigkeiten->set_flags(GTK_CAN_FOCUS);
   radiobutton_praxis_auto_fertigkeiten->set_flags(GTK_CAN_FOCUS);
   ...
   notebook2->set_flags(GTK_CAN_FOCUS);
   ...
   notebook1->set_flags(GTK_CAN_FOCUS);
   ...
   WidgetjwWyHHQ->clicked.connect(SigC::slot(static_cast<class midgard_CG*>(this), &midgard_CG::on_kido_laden_clicked));
