// generated 2002/7/2 11:11:37 CEST by thoma@Tiger.(none)
...
{  table_steigern = this;
   ...
   Gtk::Label *label552 = manage(new class Gtk::Label(" Grad, Ausdauer, Abwehr, Zaubern,\n"
		" Resistenz an GFP anpassen"));
   ...
   hbox62->pack_start(*pixmap130, false, true, 0);
   ...
   table_gradsteigern_lang->attach(*button_grad_resistenz, 0, 1, 3, 4, GTK_FILL, 0, 0, 0);
   ...
   table_handlebox1->attach(*handlebox5, 2, 3, 0, 2, 0, 0, 0, 0);
   table_handlebox1->attach(*handlebox_steigern, 0, 2, 1, 2, GTK_FILL, GTK_FILL, 0, 0);
   table_handlebox1->attach(*handlebox8, 1, 2, 0, 1, GTK_EXPAND, GTK_FILL, 0, 0);
